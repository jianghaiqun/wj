 ...
 *  
 *
 * KEY:SINOSOFT2D71BE456F7F0EC9ACE75DCA35586C62
 * ============================================================================
 */
...
public class BaseAdminAction extends ActionSupport {
	...
	public static final Logger logger = LoggerFactory.getLogger(BaseAdminAction.class);
	...
	public PresentConfig getPresentConfig() {
		return PresentConfigUtil.getPresentConfig();
	}
