 ...
 *
 */
public class Points4 extends PointExchangeInterface {
	...
	public boolean sendMobileCard(String mobile, GiftClassifySchema mGiftClassifySchema, String cardno, String password) {
		try {
			...
			+ ";" + mGiftClassifySchema.getgiftTitle() + ";" + password;
			boolean sendResult = ActionUtil.sendSms("wj00204", mobile, sendData);
			return sendResult;
		} catch(Exception e) {
			logger.error("积分兑换现货发送短信异常！Points4--sendMobileCard" + e.getMessage(), e);
		}
		return false;
	}
}