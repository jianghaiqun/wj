 ...
 *  
 *
 * KEY:SINOSOFT15DCB050DD5AB50F38C0D0A615634E58
 * ============================================================================
 */
...
public class ArithUtil {
	 ...
	 * @return 两个参数的和
	 */
	public static String add(String number, String number1) {
		...
		BigDecimal b2 = new BigDecimal(number1);
		
		double result = b1.add(b2).doubleValue();
		
		bResult = new BigDecimal(result).setScale(2,BigDecimal.ROUND_HALF_DOWN);
	 ...
	 * @return 两个参数的和
	 */
	public static String sub(String number, String number1) {
