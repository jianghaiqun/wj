...
public class OrderCheckIDUtil {

	/**                                                                                               
	 * 身份证号码验证                                                                                 
	 * 1、号码的结构                                                                                  
	 * 公民身份号码是特征组合码，由十七位数字本体码和一位校验码组成。排列顺序从左至右依次为：六位数字?
	...
	public static String IDCardValidate(String IDStr) throws ParseException {                         
	    ...
	    if (IDStr.length() == 18) {                                                                   
	        ...
	        if(Ai.toLowerCase().endsWith("x")){
	        	 Ai = IDStr.substring(0, 16); 	
	        }
	...
	public static void main(String[] args) throws ParseException {                                    
	    ...
	    //String IDCardNum = "11010119800101005Y";   
		String IDCardNum="11010119830713047x";
	    OrderCheckIDUtil cc = new OrderCheckIDUtil();                                                             
