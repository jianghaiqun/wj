 ...
 * @version  : 1.00
 * @date     : 2012-08-08
 * @direction: 短信接口非车险保单到期提醒
 ******************************************************************************/

public class MsgContOverNoticeBusiness extends MessageBusinessBL
{
...
//        }
    ...
    protected boolean dealData()
    {
    	...
    	String senddata =appntName+";"+insuranceCompany+";"+productName+";"+ordersn+";"+CInValiDate;
