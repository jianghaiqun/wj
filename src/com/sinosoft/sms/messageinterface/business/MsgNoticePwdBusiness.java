 ...
 * @version  : 1.00
 * @date     : 2012-08-08
 * @direction: 会员密码通知（后台注册）
 ******************************************************************************/

public class MsgNoticePwdBusiness extends MessageBusinessBL
{
    ...
    protected boolean checkData()
    {
        ...
        username=super.getInput("UserName");
        password=super.getInput("PassWord");
//
...
//        }
    ...
    {
    	String senddata =membername+";"+username+";"+password;
