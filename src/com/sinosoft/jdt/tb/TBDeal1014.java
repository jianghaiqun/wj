 ...
 * 处理新华报文发送和返回报文解析等
 * @author heyang 11180
 * @createDate 2013-09-23
 */
public class TBDeal1014 implements TBDealInterfaceNew {
	private static final Logger logger = LoggerFactory.getLogger(TBDealInterfaceNew.class);
	@Override
