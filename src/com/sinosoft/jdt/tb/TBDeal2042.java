 ...
 */
public class TBDeal2042 implements TBDealInterfaceNew {
	private static final Logger logger = LoggerFactory.getLogger(TBDeal2042.class);
	@Override
	...
	public boolean dealCancelData(HashMap<String, Object> resultMap,
		...
		try {
			ParseXMLToMapNew parse = new ParseXMLToMapNew();
			HashMap<String, Object> resMap = parse.dealData("02", comCode,
					ordersn, insuredSn);
