 ...
 * 处理瑞泰报文发送和返回报文解析等
 */
public class TBDeal1036 implements TBDealInterfaceNew {
	private static final Logger logger = LoggerFactory.getLogger(TBDeal1036.class);
	...
	public boolean dealData(HashMap<String, Object> resultMap, String strManageCom, String strOrderSn, String insuredSn) {
		try {
			...
			if ("pass".equals(passFlag)) {
				...
				resultMap.put("orderSn", resMap.get("orderSn"));
				resultMap.put("TRAN_CODE", resMap.get("TpySysSn"));
			} else {
