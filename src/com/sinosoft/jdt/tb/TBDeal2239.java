...
/**
 * 处理安心新平台承保报文发送和返回报文解析等
 * @author wangcaiyun 
 *
 */
public class TBDeal2239 implements TBDealInterfaceNew {
	@Override
	public boolean dealData(HashMap<String, Object> resultMap, String strManageCom, String strOrderSn,String insuredSn)
	{
		try 
		{
			...
			if ("pass".equals(passFlag))
			{
				...
				resultMap.put("startDate", resMap.get("startDate"));
				resultMap.put("endDate", resMap.get("endDate"));
			}
			else  
			{
				resultMap.put("PA_RSLT_MESG",  resMap.get("rtnMessage"));
