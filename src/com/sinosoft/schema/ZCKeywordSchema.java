...
public class ZCKeywordSchema extends Schema {
	...
	protected static final String _UpdateAllSQL = "update ZCKeyword set ID=?,Keyword=?,SiteId=?,KeywordType=?,LinkUrl=?,LinkTarget=?,LinkAlt=?,HintCount=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=?,SearchCode=?,PriorityLevel=?,EmployFlag=?,BelongCategory=? where ID=?";
