 ...
 * 表主键：ID, BackupNo<br>
 */
public class BZDButtonSchema extends Schema {
	private Long ID;
	...
	public static final String _TableCode = "BZDButton";

	public static final String _NameSpace = "com.sinosoft.schema";

	protected static final String _InsertAllSQL = "insert into BZDButton values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update BZDButton set ID=?,ParentID=?,URL=?,Code=?,ButtonID=?,OnClick=?,Priv=?,Icon=?,Name=?,Type=?,Disabled=?,OrderFlag=?,Memo=?,AddTime=?,AddUser=?,ModifyTime=?,ModifyUser=?,Prop1=?,Prop2=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";

	protected static final String _DeleteSQL = "delete from BZDButton  where ID=? and BackupNo=?";

	protected static final String _FillAllSQL = "select * from BZDButton  where ID=? and BackupNo=?";

	public BZDButtonSchema(){
	...
	public BZDButtonSet query() {
		return query(null, -1, -1);
	}

	public BZDButtonSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public BZDButtonSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public BZDButtonSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (BZDButtonSet)querySet(qb , pageSize , pageIndex);
	}
