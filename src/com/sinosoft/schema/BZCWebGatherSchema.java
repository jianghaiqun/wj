 ...
 * 表主键：ID, BackupNo<br>
 */
public class BZCWebGatherSchema extends Schema {
	private Long ID;
	...
	public static final String _TableCode = "BZCWebGather";

	public static final String _NameSpace = "com.sinosoft.schema";

	protected static final String _InsertAllSQL = "insert into BZCWebGather values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update BZCWebGather set ID=?,SiteID=?,Name=?,Intro=?,Type=?,ConfigXML=?,ProxyFlag=?,ProxyHost=?,ProxyPort=?,ProxyUserName=?,ProxyPassword=?,Status=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";

	protected static final String _DeleteSQL = "delete from BZCWebGather  where ID=? and BackupNo=?";

	protected static final String _FillAllSQL = "select * from BZCWebGather  where ID=? and BackupNo=?";

	public BZCWebGatherSchema(){
	...
	public BZCWebGatherSet query() {
		return query(null, -1, -1);
	}

	public BZCWebGatherSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public BZCWebGatherSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public BZCWebGatherSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (BZCWebGatherSet)querySet(qb , pageSize , pageIndex);
	}
