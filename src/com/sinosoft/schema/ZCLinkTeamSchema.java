 ...
 * 表主键：ID<br>
 */
public class ZCLinkTeamSchema extends Schema {
	private Long ID;
	...
	public static final String _TableCode = "ZCLinkTeam";

	public static final String _NameSpace = "com.sinosoft.schema";

	protected static final String _InsertAllSQL = "insert into ZCLinkTeam values(?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update ZCLinkTeam set ID=?,Name=?,SiteID=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";

	protected static final String _DeleteSQL = "delete from ZCLinkTeam  where ID=?";

	protected static final String _FillAllSQL = "select * from ZCLinkTeam  where ID=?";

	public ZCLinkTeamSchema(){
	...
	public ZCLinkTeamSet query() {
		return query(null, -1, -1);
	}

	public ZCLinkTeamSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public ZCLinkTeamSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public ZCLinkTeamSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (ZCLinkTeamSet)querySet(qb , pageSize , pageIndex);
	}

	public void setV(int i, Object v) {
		if (i == 0){ID = (Long)v;return;}
		if (i == 1){Name = (String)v;return;}
		if (i == 2){SiteID = (Long)v;return;}
