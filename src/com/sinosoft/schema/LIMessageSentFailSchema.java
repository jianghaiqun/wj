...
/**
 * 表名称：短信3<br>
 * 表代码：LIMessageSentFail<br>
 * 表主键：MessageId<br>
 */
public class LIMessageSentFailSchema extends Schema {
	...
	public static final SchemaColumn[] _Columns = new SchemaColumn[] {
		...
		new SchemaColumn("SucessFlag", DataColumn.STRING, 12, 2 , 0 , false , false)
	};

	public static final String _TableCode = "LIMessageSentFail";

	public static final String _NameSpace = "com.sinosoft.schema";

	protected static final String _InsertAllSQL = "insert into LIMessageSentFail values(?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update LIMessageSentFail set MessageId=?,ServiceCode=?,ComCode=?,SendData=?,MobileNum=?,CustomerName=?,Operator=?,ServiceBussNo=?,MakeDate=?,MakeTime=?,ModifyDate=?,ModifyTime=?,SucessFlag=? where MessageId=?";

	protected static final String _DeleteSQL = "delete from LIMessageSentFail  where MessageId=?";

	protected static final String _FillAllSQL = "select * from LIMessageSentFail  where MessageId=?";

	public LIMessageSentFailSchema(){
	...
	protected Schema newInstance(){
		return new LIMessageSentFailSchema();
	}
	...
	public LIMessageSentFailSet query() {
		return query(null, -1, -1);
	}

	public LIMessageSentFailSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public LIMessageSentFailSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public LIMessageSentFailSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (LIMessageSentFailSet)querySet(qb , pageSize , pageIndex);
	}
	...
	public void setV(int i, Object v) {
		...
		if (i == 12){SucessFlag = (String)v;return;}
	}
