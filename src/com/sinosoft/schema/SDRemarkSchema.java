 ...
 * 表主键：id<br>
 */
public class SDRemarkSchema extends Schema {
	private String id;
	...
	public static final String _TableCode = "sdremark";

	public static final String _NameSpace = "com.sinosoft.schema";

	protected static final String _InsertAllSQL = "insert into sdremark values(?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update sdremark set id=?,upperId=?,OperateTime=?,orderSn=?,prop1=?,prop2=?,OperateType=?,remark=?,OperateName=? where id=?";

	protected static final String _DeleteSQL = "delete from sdremark  where id=?";

	protected static final String _FillAllSQL = "select * from sdremark  where id=?";

	public SDRemarkSchema(){
	...
	public SDRemarkSet query() {
		return query(null, -1, -1);
	}

	public SDRemarkSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public SDRemarkSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public SDRemarkSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (SDRemarkSet)querySet(qb , pageSize , pageIndex);
	}
