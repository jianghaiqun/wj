...
public class PubSubmit {
    private static final Logger logger = LoggerFactory.getLogger(PubSubmit.class);
    // 传输数据类
                ...
                for (int j = 0; j < set.size(); j++) {
                    ...
                    if (action.equals("INSERT")) {
                        ...
                        if (b.booleanValue()) {
                            ...
                            logger.info("{} {} Failed", DBObject.getClass().getName(), action);
                            return false;
                        }
...
//                        }
            ...
            if (commitFlag) {
                ...
                logger.info("---End Datebase Operation, but not Commit in AutoBLS---");
            }
        } catch (Exception e) {
            // @@错误处理
...
//        XmlImport xmlexport = new XmlImport();
