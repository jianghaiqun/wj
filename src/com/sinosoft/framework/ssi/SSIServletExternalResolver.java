 ...
 * @author Dan Sandberg
 * @author David Becker
 * @version $Revision: 782757 $, $Date: 2009-06-08 14:04:29 -0600 (Mon, 08 Jun
 *          2009) $
 */
public class SSIServletExternalResolver implements SSIExternalResolver {
	...
	private static Mapx timeMap = new Mapx(5000);// 最多缓存5000个文件，超出时按最近最少使用算法剔出缓存
	private static Mapx fileMap = new Mapx(5000);
