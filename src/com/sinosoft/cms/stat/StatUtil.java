...
public class StatUtil {
		...
		if (DistrictCodes == null) {
			synchronized (mutex) {
				if (DistrictCodes == null) {
					...
					//	System.out.println(arr.length+"=========arr.length0000==========");
	...
	public static long convertIP(String ip) {
		...
		try {
			...
			logger.error("错误的IP地址:" + ip + e.getMessage(), e);
		}
		return 0;
	}
		...
		if (langCodeArr == null) {
			synchronized (mutex) {
				if (langCodeArr == null) {
					...
					map.put("ca-es-euro", "加泰罗尼亚文(西班牙,Euro)");
	...
	public static String getBrowser(String useragent) {
		if (useragent.indexOf("MSIE 9") > 0 && useragent.indexOf("Windows nt") > 0) {
			return "IE9";
		} else if (useragent.indexOf("MSIE 8") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "IE8";
		} else if (useragent.indexOf("MSIE 7") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "IE7";
		} else if (useragent.indexOf("MSIE 6") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "IE6";
		} else if (useragent.indexOf("Firefox/3.") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Firefox 3.x";
		} else if (useragent.indexOf("Firefox/2.") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Firefox 2.x";
		} else if (useragent.indexOf("Firefox/1.") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Firefox 1.x";
		} else if (useragent.indexOf("Safari") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Safari";
		} else if (useragent.indexOf("Opera") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Opera";
		} else if (useragent.indexOf("Chrome") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Chrome";
		} else if (useragent.indexOf("Camino") > 0  && useragent.indexOf("Windows NT") > 0) {
			return "Camino";
		} else if (useragent.indexOf("Gecko") > 0  && useragent.indexOf("Windows NT") > 0) {
			return "Gecko";
		} else if (useragent.indexOf("MSIE 5") > 0  && useragent.indexOf("Windows NT") > 0) {
			return "IE5";
		} else if (useragent.indexOf("MSIE 4") > 0  && useragent.indexOf("Windows NT") > 0) {
			return "IE4";
		} else if (useragent.indexOf("MSIE 3") > 0  && useragent.indexOf("Windows NT") > 0) {
			return "IE3";
		} else if (useragent.indexOf("Netscape") > 0 && useragent.indexOf("Windows NT") > 0) {
			return "Netscape";
			...
			return "iPad-Safari";
		} else if (useragent.indexOf("iPad") > 0 && useragent.indexOf("Opera") > 0) {
			return "iPad-Opera";
		} else if (useragent.indexOf("Android") > 0 && useragent.indexOf("Mozilla") > 0) {
			return "Android-Mozilla";
		} else if (useragent.indexOf("Android") > 0 && useragent.indexOf("Opera") > 0) {
			return "Android-Opera";
		} else if (useragent.indexOf("Android") > 0 && useragent.indexOf("Firefox") > 0) {
			return "Android-Firefox";
		} else if (useragent.indexOf("Android") > 0 && useragent.indexOf("UC") > 0) {
			return "Android-UC";
		} else {
			return "其他";
		}
