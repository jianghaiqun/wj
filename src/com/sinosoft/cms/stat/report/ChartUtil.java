...
public class ChartUtil {
	...
	public static String getLine2DChart(DataTable dt, int labelCount) {
		StringBuffer xml = new StringBuffer();
		String[] Colors =
				{ "1D8BD1", "F1683C", "2AD62A", "FF0000", "006F00", "CCCC00", "0D8ECF", "04D215", "B0DE09", "F8FF01", "FF9E01",
						"FF6600", "814EE6", "F234B0", "FF9966", "0099FF", "993300", "333300", "003300", "003366", "000080",
						"333399", "333333", "800000", "FF6600", "808000", "808080", "008080", "0000FF", "666699", "808080",
		...
		int space = new Double(Math.ceil(dt.getRowCount() * 0.95 / labelCount)).intValue();
		int count = 0;
		...
		for (int i = 1; i < dt.getColCount(); i++) {
			...
			xml.append("<dataset seriesName='" + dt.getDataColumn(i).getColumnName() + "' color='" + color
					+ "' anchorBorderColor='" + color + "' anchorBgColor='" + color + "'>");
			for (int j = 0; j < dt.getRowCount(); j++) {
	...
	public static String getMixed2DChart(DataTable dt, String yColumn, int labelCount) {
		StringBuffer xml = new StringBuffer();
		String[] Colors =
				{ "F6BD0F", "8BBA00", "FF0000", "2AD62A", "006F00", "CCCC00", "0D8ECF", "04D215", "B0DE09", "F8FF01", "FF9E01",
						"FF6600", "814EE6", "F234B0", "FF9966", "0099FF", "993300", "333300", "003300", "003366", "000080",
						"333399", "333333", "800000", "FF6600", "808000", "808080", "008080", "0000FF", "666699", "808080",
						"FF9900", "99CC00", "339966", "33CCCC", "3366FF", "800080", "999999", "FF00FF", "FFCC00", "FFFF00",
						"00FF00", "00FFFF", "00CCFF", "993366", "C0C0C0", "FF99CC", "FFCC99", "FFFF99", "CCFFCC", "CCFFFF",
