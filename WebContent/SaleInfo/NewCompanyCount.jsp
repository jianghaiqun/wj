...
function query(type,countflag,cancelFlag){
	...
	var sessionId = "CompanyCount";
	
	var sendUrl="../ReportServlet.jspx?year="+year+"&contant="+contant+"&defaultFilename=CompanyCount&type="+type
			    +"&countflag="+countflag+"&method=com.wangjin.infoseeker.NewGlobalCount.dg3DataBind&sessionId="+sessionId+"&cancelFlag="+cancelFlag;
	if(type=="excel"){
