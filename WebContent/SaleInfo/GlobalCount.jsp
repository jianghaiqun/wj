...
function exportExel(){
	var years=$V("year");
	var titles=['项目',years+'-1',years+'-2',years+'-3',years+'-4',years+'-5',years+'-6',years+'-7',years+'-8',years+'-9',years+'-10',years+'-11',years+'-12','总计'];
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					<td style="padding:4px 8px;" class="blockTd">
						<span style="float: left;width:1080px">
						统计年份：
