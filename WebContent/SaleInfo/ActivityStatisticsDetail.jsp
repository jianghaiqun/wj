...
<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable" style="table-layout: fixed;" >
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.wangjin.coupon.ActivityStatistics.dg2DataBind" size="10">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr ztype="head" class="dataTableHead">
								...
								<td width="120"><b>购买时间</b></td>
								<td width="200"><b>商家订单号</b></td>
								<td width="100"><b>总金额</b></td>
								<td width="100"><b>交易金额</b></td>
								<td width="100"><b>优惠金额</b></td>
							</tr>
							<tr >
								<td width="3%">&nbsp;</td>
								<td >&nbsp;</td>
								<td title="${BuyTime}">${BuyTime}</td>
								<td title="${PaySn}">${PaySn}</td>
								<td title="${TotalAmount}">${TotalAmount}</td>
								<td title="${TradeAmount}">${TradeAmount}</td>
								<td title="${ActivitySumAmount}">${ActivitySumAmount}</td>
							</tr>
							<tr ztype="pagebar">
