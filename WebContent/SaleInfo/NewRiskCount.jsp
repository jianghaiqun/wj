...
function query(type,countflag,cancelFlag){
	...
	var sessionId = "RiskCount";
	
	var sendUrl="../ReportServlet.jspx?year="+year+"&contant="+contant+"&defaultFilename=RiskCount&type="+type
			    +"&countflag="+countflag+"&method=com.wangjin.infoseeker.NewGlobalCount.dg2DataBind&sessionId="+sessionId+"&cancelFlag="+cancelFlag;
	if(type=="excel"){
