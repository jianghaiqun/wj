...
<z:init method="com.sinosoft.platform.Code.initCompanyManageList">
...
function update(){
	...
	diag.Height = 150;
	diag.Title = "保险公司维护修改";
	diag.URL = "LineTeam/CompanyManageDialog.jsp";
...
function updateThis(){
	...
	Server.sendRequest("com.sinosoft.platform.Code.dgCompanyUpdate",dc,function(response){
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.platform.Code.companyAdd",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				$D.close();
				DataGrid.loadData('dg1');
...
function del(){
	...
	dc.add("DT",dt);
	Dialog.confirm("删除保险公司，保险公司对应的结算费率也会删除，您确认要删除吗？",function(){
		Server.sendRequest("com.sinosoft.platform.Code.companyDel",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg1');
				}		
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg1"
						method="com.sinosoft.platform.Code.dg1CompanyManage">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr ztype="head" class="dataTableHead">
								...
								<td width="15%"><b>保险公司名称</b></td>
								<td width="15%"><strong>保险公司编码</strong></td>
							</tr>
