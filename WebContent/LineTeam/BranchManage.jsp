...
function addBranch(){
	...
	diag.Height = 200;
	diag.Title = "新建组织机构";
	diag.URL = "Platform/BranchDialog.jsp?ParentInnerCode="+ParentInnerCode+"&source=lineTeam";
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.platform.Branch.add",dc,function(response){
...
function editSave() {
	...
	Server.sendRequest("com.sinosoft.platform.Branch.save",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				$D.close();
				DataGrid.loadData('dg1');
...
function del(){
	...
	dc.add("ID",arr.join());
	Dialog.confirm("注意：请从最小级别删除机构，您确认要删除吗？",function(){
		Server.sendRequest("com.sinosoft.platform.Branch.delLineTeamBranch",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg1');
				}				
...
<table width="100%" border="0" cellspacing="6" cellpadding="0"
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td colspan="12" nowrap><z:tButtonPurview>${_LineTeam_BranchManage_Button}</z:tButtonPurview></td>
			</tr>
			
			<tr>
				<td
					style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
				<z:datagrid id="dg1" method="com.sinosoft.platform.Branch.dg2DataBind"
					page="false">
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr ztype="head" class="dataTableHead">
							...
							<td width="14%"><b>编码</b></td>
							<td width="14%"><strong>机构主管</strong></td>
							<td width="18%"><strong>电话</strong></td>
							<td width="17%"><strong>传真</strong></td>
						</tr>
						<tr onDblClick="edit();">
							<td>&nbsp;</td>
							<td>&nbsp;</td>
