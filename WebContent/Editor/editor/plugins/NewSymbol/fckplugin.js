...
FCKCommands.RegisterCommand( 'NewSymbol', new FCKDialogCommand( 'NewSymbol', "特殊符号", FCKPlugins.Items['NewSymbol'].Path + 'symbol.html', 480, 360 ) ) ;

var symbolObj = new FCKToolbarButton( 'NewSymbol', "特殊符号", "特殊符号", null, null, false, true) ;
symbolObj.IconPath = FCKPlugins.Items['NewSymbol'].Path + 'symbol.gif' ;

FCKToolbarItems.RegisterItem( 'NewSymbol', symbolObj ) ;
