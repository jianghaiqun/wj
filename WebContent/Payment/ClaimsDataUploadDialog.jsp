...
<z:init method="com.sinosoft.cms.payment.PaymentManage.initClaimsData" >
<html>
<head>
...
<input type="hidden" id="claimsNo" name="claimsNo" value="${claimsNo}">
<input type="hidden" id="claimsItemsId" name="claimsItemsId" value="${claimsItemsId}">
<input type="hidden" id="productId" name="productId" value="${productId}">
<table width="100%" align="center" cellpadding="2" cellspacing="0">
	<tr>
			<td  valign="top">
			<fieldset><legend> <strong>理赔资料:</strong></legend>
			<table id="Videotable0" style="display:" width="100%" cellpadding="2"
				...
				<tr>
					<td align="right">理赔资料：</td>
					<td><z:select name="claimsData" id="claimsData" style="width:150px;" value="">${ClaimsData}</z:select></td>
				</tr>
			</table>
			</fieldset>
			</td>
