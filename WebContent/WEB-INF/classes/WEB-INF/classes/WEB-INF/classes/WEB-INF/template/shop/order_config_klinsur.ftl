...
function changeInformation(objForm,aa){
   ...
   if(s=="本人"){
	    ...
	    cancelVerification();
	        ...
	        if(document.getElementById("x2")!=null){
	 	    document.getElementById("s2").value =document.getElementById("x2").value;
	        }
	        if(document.getElementById("x3")!=null){
           ...
           <font color="#808080">提醒您！我们仅向该邮箱发送电子保单。并且在办理保单业务时，开心保网也只接收您通过该邮箱提交的材料。</font>
		           ...
		           <p>
			        ...
			        <p>
			         ...
			         <p>
			    		<span>职业:</span>
			            <select id="x1" name="informationAppnt.applicantOccupation1"  onchange="getChildrenOPT(this.value,'x2','-1',this);" style="width:125px;">
			             ...
			             <select id="x2" name="informationAppnt.applicantOccupation2"  onchange="getChildrenOPT(this.value,'x3');" style="width:125px;_width:200px;" >
				     		<option value="-1">--请选择--</option>
					     </select>
			            <select id="x3" name="informationAppnt.applicantOccupation3"  style="width:125px;_width:200px;" class="selectTest {selectTest:false, messages: {selectTest: '请选择职业'}}">
		             		<option value="-1">--请选择--</option>
			             </select>
			         </p>
        ...
        <div id="insurancedOne"  style="display:none;">
            ...
            <p>
            	...
            	<label class="requireField">*</label>
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds.recognizeeBirthday"  type="text"   value="${informationInsureds.recognizeeBirthday}" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"/>
	            	 <label class="requireField">*</label>
	            	 <font id="recognizeeBirthdayID" color="red"></font> 
	             </p>
	             <p>
	                 <span>手机号码:</span> 
	                 <input type="text" id="recognizeeMobile1" name="informationInsureds.recognizeeMobile" onclick="checkage("${order.productId}");" value="${(informationInsureds.recognizeeMobile)!}" />
	                 <label class="requireField">*</label>
	             </p>
	             <p>
	                 <span>电子邮箱:</span> 
		        ...
		        <#list productConfigs as list>
	     		  <#if (list.type=="Occupation" && list.flag=="Y")>
			         <p>
			    		<span>职业:</span>
			            <select id="s1" name="informationInsureds.occupation1"  onchange="getChildrenOPT(this.value,'s2','-1',this);" style="width:125px;">
			             	<option value="-1">--请选择--</option>
			             	<#list occupationList as list>
			             		<option value="${list.id}" <#if (informationInsureds.occupation1==list.id)>selected="selected"</#if>>${list.name}</option>	
			        		</#list>
			             </select> 
			             <select id="s2" name="informationInsureds.occupation2"  onchange="getChildrenOPT(this.value,'s3');" style="width:125px;_width:200px;" >
				     		<option value="-1">--请选择--</option>
					     </select>
			            <select id="s3" name="informationInsureds.occupation3" >
		             		<option value="-1">--请选择--</option>
			             </select>
			             <font id="occupID1" color="red"></font>
			         </p>
			        </#if>
		         </#list>
        	</div>
				...
				<p>
					 <span>体重:</span> 
					 <input type="text" id="weight1" name="informationInsureds.weight" value="${(informationInsureds.weight)!}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength=3  class='required'/>(公斤 )
					 <label class="requireField">*</label>
				</p>
				 <#list productConfigs as list>
	              <#if (list.type=="flightNo" && list.flag=="Y")>
					<p>
				         <span>航班号:</span> 
				         <input type="text" id="flightNo" maxlength=200 name="informationInsureds.flightNo" value="${(informationInsureds.flightNo)!}" class='required'/>
				         <label class="requireField">*</label>
		            </p>
	              </#if>
		         </#list>
...
function idcheck(idtype,idCode,birthdayId,sexId){
 ...
 <script type="text/javascript">
	...
	pubGetChildrenOccupation("${informationAppnt.applicantOccupation1}","${informationAppnt.applicantOccupation2}","${informationAppnt.applicantOccupation3}","${informationInsureds.occupation1}","${informationInsureds.occupation2}","${informationInsureds.occupation3}");
	initPrem();
	</script>
</body>
</html>