...
<#if (test_list?size != 0)>
	<#list test_list as map>
		<div class="test_des_box">
		<#if ('${map.childflag}'!='')!>
			<p class="test_des_tit"><span>子女</span><span>${map.age}</span><span>${map.yanglaobaoxian}</span><span>${map.yiliaobaoxian}</span></p>
		<#else>
			<p class="test_des_tit"><span>${map.sex}</span><span>${map.age}</span><span>${map.work}</span><span>${map.yanglaobaoxian}</span><span>${map.yiliaobaoxian}</span></p>
		</#if>
		<ul class="test_des_g">
			<li>
				<span class="test_des_gt">健康状况：</span><span>
					<#if ('${map.healthstatus}'!='')!>
						${map.healthstatus}
					<#else>
						无
			...
			<li>
				<span class="test_des_gt">家庭收入：</span><span>
					<#if ('${map.salary}'!='')!>
						${map.salary}
					<#else>
						无
			...
			<div class="clear"></div>
			<li>
				<span class="test_des_gt">旅游次数/年：</span><span>
					<#if ('${map.travelnum}'!='')!>
						${map.travelnum}
					<#else>
						无
			...
			<li>
				<span class="test_des_gt">有无贷款：</span><span>
					<#if ('${map.loan}'!='')!>
						${map.loan}
					<#else>
						无
...
<dl class="need_box cf">
	...
	<div class="clear"></div>
	<a href="" class="in_s_list_more">查看更多</a></dd>
</dl>
<#if (list_six?size != 0)>
	<dl class="need_box cf">
