...
$(function(){
	$(".member_endDateCheck").each(function(){
		var content=$(this).text();
		if(content.indexOf("9999-")>0){
			$(this).empty();
			$(this).text("终身");
		}
	})
		...
		<s:iterator id="list" value="#request.listOrders" status="status" >
			...
			<tr class="m_order_num2">
				...
				<td>
					...
					至
						<span class="member_endDateCheck"> <s:date name="#list.endDate" format="yyyy-MM-dd" /></span>
				</td>
				<!--状态-->
				<td>
...
<s:if test="listOrders.isEmpty()">
	<div class="no-shop"><div class="no-shop-tip"><a href="<%=Config.getFrontServerContextPath() %>">您还没有购买保险产品哦~快去选购吧！</a></div></div>
</s:if>
</div>
