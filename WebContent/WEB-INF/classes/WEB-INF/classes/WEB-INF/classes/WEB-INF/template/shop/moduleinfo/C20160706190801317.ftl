<div class="line_a ">
    ...
    <input type="checkbox" id="sel_zys" />确认被保人属于可投保职业 </label><a href="javascript:;" onclick="showOccupations();">职业类别表（必看）</a> </div>
...
<div class="bbr_des" id="from_tab"><div class="br_box clearfix"><p>
<span class="span_t">*出发地：</span> 
					    <select id="recognizeeArea1" name="sdinformationinsured.recognizeeArea1" 
					    onchange="getChildrenArea(this.value,'recognizeeArea2','-1',this,2)" style="width:125px;">
					     ...
					     <select id="recognizeeArea2" name="sdinformationinsured.recognizeeArea2"  style="width:125px;"
					      verify="所在地区|AreaFormat"  onchange="getChildrenArea(this.value,'recognizeeArea3','-1',this,2)"  >
					           <option value="-1">--请选择--</option>
					     </select>
					     
					       <select id="recognizeeArea3" name="sdinformationinsured.recognizeeArea3"  style="width:125px;"
							verify="机场信息|OccuFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
						 <option value="-1">--请选择--</option>
						  </select>
 	<label class="requireField"></label>
		            </p><p>
<span class="span_t">*目的地：</span> 
					    <select id="recognizeeRemark" name="sdinformationinsured.remark" onchange="getChildrenArea(this.value,'recognizeeDestinationCountry','-1',this);" style="width:125px;">
					            <option value="-1">--请选择--</option>
					            <#list areaList as list>
					            	<option value="${list.id}" <#if (sdinformationinsured.remark==list.id)!>selected="selected"</#if>>${list.name}</option>
					            </#list>
					     </select>
						 <select id="recognizeeDestinationCountry" name="sdinformationinsured.destinationCountry"  style="width:125px;"
					      verify="所在地区|AreaFormat"  onchange="getChildrenArea(this.value,'recognizeeDestinationCountryText','-1',this,2)"  >
					           <option value="-1">--请选择--</option>
					     </select>
					     
					       <select id="recognizeeDestinationCountryText" name="sdinformationinsured.destinationCountryText"  style="width:125px;"
							verify="机场信息|NOTNULL" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
						 <option value="-1">--请选择--</option>
						  </select>
...
<span class="span_t">*出发地：</span> 
					    <select id="recognizeeArea1_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea1" 
					    onchange="getChildrenArea(this.value,'recognizeeArea2_${x-1}','-1',this,${x-1})" style="width:125px;">
					            <option value="-1">--请选择--</option>
					            <#list areaList as list>
					            	<option value="${list.id}" <#if (sdinformationinsuredList[x-1].recognizeeArea1==list.id)!>selected="selected"</#if>>${list.name}</option>
					            </#list>
					     </select>
					     <select id="recognizeeArea2_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea2"  style="width:125px;"
					      verify="所在地区|AreaFormat"  onchange="getChildrenArea(this.value,'recognizeeArea3_${x-1}','-1',this,${x-1})"  >
					           <option value="-1">--请选择--</option>
					     </select>
					     
					       <select id="recognizeeArea3_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea3"  style="width:125px;"
							verify="机场信息|NOTNULL" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
						 <option value="-1">--请选择--</option>
						  </select>
 	<label class="requireField"></label>
...
<span class="span_t">*目的地：</span> 
					    <select id="recognizeeRemark_${x-1}" name="sdinformationinsuredList[${x-1}].remark" onchange="getChildrenArea(this.value,'recognizeeDestinationCountry_${x-1}','-1',this);" style="width:125px;">
					            <option value="-1">--请选择--</option>
					            <#list areaList as list>
					            	<option value="${list.id}" <#if (sdinformationinsuredList[x-1].remark==list.id)!>selected="selected"</#if>>${list.name}</option>
					            </#list>
					     </select>
						 <select id="recognizeeDestinationCountry_${x-1}" name="sdinformationinsuredList[${x-1}].destinationCountry"  style="width:125px;"
					      verify="所在地区|AreaFormat"  onchange="getChildrenArea(this.value,'recognizeeDestinationCountryText_${x-1}','-1',this,${x-1})"  >
					           <option value="-1">--请选择--</option>
					     </select>
					     
					       <select id="recognizeeDestinationCountryText_${x-1}" name="sdinformationinsuredList[${x-1}].destinationCountryText"  style="width:125px;"
							verify="机场信息|NOTNULL" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
						 <option value="-1">--请选择--</option>
						  </select>
...
<label class="requireField"></label>
	        ...
	        <span class="span_t">*航班号：</span> 
	        <input type="text" id="recognizeeflightNo_${x-1}" maxlength=200 name="sdinformationinsuredList[${x-1}].flightNo" value="${(sdinformationinsuredList[x-1].flightNo)!}" 
onblur="verifyElement('航班号|NOTNULL',this.value,this.id)"
verify="航班号|NOTNULL" />
	        <label class="requireField"></label>
	    </p><p>
	        <span class="span_t">*起飞时间：</span> 
	        <input type="text" id="recognizeeflightTime_${x-1}" maxlength=200 name="sdinformationinsuredList[${x-1}].flightTime" class="shop_day" value="${(sdinformationinsuredList[x-1].flightTime)!}" 
onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-{%d+${startPeriod}} 00:00:00',maxDate:'%y-%M-{%d+${startPeriod}+${endPeriod}} 23:59:59'});"
onblur="verifyElement('起飞时间|NOTNULL&FIGHTTIME',this.value,this.id)"
verify="起飞时间|NOTNULL&FIGHTTIME"/>
	        <label class="requireField"></label>
	    </p><span class="bbr-mes-btn">确认</span>
              ...
              <div id="addIns" class="add_ortherholder"> <a href="###" type="button" id="addIns1" class="more_holder">+ 添加被保险人</a></div> 
                           ...
                           <div class="team_boxs clearfix"  style="display:none;">
					<div class="xztd-ptip">
