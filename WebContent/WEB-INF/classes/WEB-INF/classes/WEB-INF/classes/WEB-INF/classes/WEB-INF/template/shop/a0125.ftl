	...
	<table id="__01" width="600"  border="0"  align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="10" bgcolor="#ffffff" >
				<table border="0"  cellpadding="0" cellspacing="0">
					<tr><td colspan="3"><img src="http://resource.kaixinbao.com/active_file/images/email/sr_03.jpg" width="600" style="display:block;" height="294" alt=""></td></tr>
					<tr>
						<td>
							<img src="http://resource.kaixinbao.com/active_file/images/email/sr_05.jpg" width="311" height="27"  style="display:block;" alt=""></td>
						<td bgcolor="#F52E73" style="width:201px; height:27px;">
							<p style="font-size:16px; color:#FED602;  font-family: 'Microsoft YaHei';text-align: center; ">投保享受<span style="color:#fff;">${PointMultiple}</span>倍积分返还</p></td>
						<td>
							<img src="http://resource.kaixinbao.com/active_file/images/email/sr_07.jpg" width="88" height="27"  style="display:block;" alt=""></td>
					</tr>
					<tr>
						<td colspan="3"><img src="http://resource.kaixinbao.com/active_file/images/email/sr_08.jpg" width="600" height="72" alt=""></td>
					</tr>
				</table>
			</td>
			...
			<tr>
			<td colspan="10" bgcolor="#ffffff" >
				<img src="http://resource.kaixinbao.com/active_file/images/email/sr_05.gif" alt="" style="display:block;">
			</td>
		...
		<tr>
			<td colspan="10" bgcolor="#ffffff">
				<table border="0"   cellpadding="0" cellspacing="0">
					<tr>
						<td style="width:51px; height:71px;" bgcolor="#C72425">
							
						</td>
						<td bgcolor="#C72425" style="width:549px; height:71px;font-size:14px; color:#FFFFFF">
							若您对生日特权或网上投保过程有任何疑问，请登陆&nbsp;<a href="http://www.kaixinbao.com" style="font-size:14px; color:#FED602; text-decoration: underline; ">www.kaixinbao.com</a> <br>联系在线客服，或致电&nbsp;<span style="font-size:14px; color:#FED602; ">4009-789-789</span>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td colspan="10" bgcolor="#ffffff" >
				<img src="http://resource.kaixinbao.com/active_file/images/email/sr_08.gif" alt="" style="display:block;">
			</td>
