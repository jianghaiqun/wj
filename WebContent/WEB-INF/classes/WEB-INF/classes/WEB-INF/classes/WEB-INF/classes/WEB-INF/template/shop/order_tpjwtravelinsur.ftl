...
<div class="sdong"></div>
 ...
 <center>
         ...
         <p> 
          ...
          <label class="requireField">*</label>
            ...
            <font color="#808080">证件类型和号码请您仔细选择或填写并核对无误，以免影响日后理赔。</font>
                ...
                <p>
                   <span>出生日期:</span> 
                   <input id="applicantBirthday" name="informationAppnt.applicantBirthday" onchange="validateBirthday();dateTrigger();" type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"  value="${(informationAppnt.applicantBirthday)!}"  class="required applicantBirthday" onchange="validateBirthday();dateTrigger()"/>
                	<label class="requireField">*</label>
  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <div id="insurancedOne"  style="display:none;">
             ...
             <p>
             <span>英文名:</span> 
             <input type="text" id="recognizeeEnName1" name="informationInsureds1.recognizeeEnName" value="${(informationInsureds1.recognizeeEnName)!}" class="required English" maxlength=50 />
             <label class="requireField">*</label>
          </p>
           <p>
             <span>姓名拼音:</span> 
		                     姓<input type="text" id="recognizeeFirstEnName1" maxlength=25 name="informationInsureds1.recognizeeFirstEnName" value="${(informationInsureds1.recognizeeFirstEnName)!}" style="width:90px;" class="required English"/>
		                    名<input type="text" id="recognizeeLastEnName1" maxlength=25 name="informationInsureds1.recognizeeLastEnName" value="${(informationInsureds1.recognizeeLastEnName)!}" style="width:120px;" class="required English"/>
             <label class="requireField">*</label>
          </p>
            <p>
               <span>证件类型:</span> 
   ...
   <div class="line_a">
      <div  class="line_at">被保人信息<img width="18" height="16"  src="${base}/template/shop/images/wen_a.png"/></div>
      <p>
	      <span  class="selectOutPice">目的地: 选择目的地
		        <div id="showOutGoingParpose" style="width:500px;height:40px;"><#list detisnateList as list>
							${list.get('codeName')}   
						</#list></div>
		   </span>
      </p>
	        ...
	        <#if (index%5==0)>
	            <tr height="20px">
	             ...
	             <td style="padding-left: 10px">
	             	<input type="checkbox" name="informationInsureds1.destinationCountry" value="${list.get('codeValue')}" <#if (informationInsureds1.destinationCountry==list.get("codeValue"))>checked</#if>> <label for="${list.get('codeValue')}"> ${list.get("codeName")}</label>
	             </td>
	     	<#if (index%5==4)>
	            </tr>
	        </#if>
