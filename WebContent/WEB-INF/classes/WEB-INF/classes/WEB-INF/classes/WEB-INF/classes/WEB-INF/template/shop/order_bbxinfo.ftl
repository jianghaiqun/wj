...
<!---=========增加填写保单信息的功能======------>
	...
	<div class="body">
		...
		<div class="orderInfoDetail">
			<form id="orderInfoForm" action="order!bbxinfosave.action?orderItemId=${orderItem.id}&productId=${product.id}&orderId=${orderId}" method="post">
			<input type="hidden" id="orderstatus" name="orderstatus" value="other" />
				<@s.token />
								...
								<li>
									...
									<table>
										...
										<tr>
											...
											<td>
												<input type="text" name="applicantArea" value="${(information.applicantArea)!}" class="areaSelect hidden {required: true, messages: {required: '请选择地区！'}, messagePosition: '#areaMessagePosition'}" />
										...
										<tr>
											...
											<td>
												<select id="applicantTypeId" name="applicantIdentityType" class="formText {required: true, messages: {required: '请选择投保人证件类型！'}}" >
									              ...
									              <option value="身份证" <#if ("身份证" == information.applicantIdentityType)!> selected</#if>>身份证</option>
									              <option value="军官证" <#if ("军官证" == information.applicantIdentityType)!> selected</#if> >军官证</option>
									              <option value="护照" <#if ("护照" == information.applicantIdentityType)!> selected</#if>>护照</option>
									            </select>
										...
										<tr>
											...
											<td>
												<input id="applicantId" type="text" value="${(information.applicantIdentityId)!}" name="applicantIdentityId" class="formText {required: true, messages: {required: '请填写投保人证件号码！'}}" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
											      <input type="radio" name="applicantSex" value="男"  <#if (information ==null)||(information.applicantSex == "男")!> checked</#if>>男
										...
										<tr>
											...
											<td>
												...
												<input type="text" readonly="readonly" value="${(information.applicantBirthday)!}" name="applicantBirthday" onfocus="setday(this)"  class="formText {required: true, messages: {required: '请填写投保人出生日期！'}} />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="applicantTel" value="${(information.applicantTel)!}"  value="" class="formText {mobile: true, messages: {mobile: '手机号码格式错误！'}}" />
												<label class="requireField">* 请务必真实填写，以便在保单出现任何问题时与您及时联络。</label>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												...
												<label class="requireField">* 请您务必填写常用邮箱，以便您及时接收到电子保单等内容。</label>
											</td>
										</tr>
									</table>
								</li>
								...
								<li>
									...
									<table>
										...
										<tr>
											...
											<td>
												<input type="text" name="recognizeeArea" value="${(information.recognizeeArea)!}" class="areaSelect hidden {required: true, messages: {required: '请选择地区！'}, messagePosition: '#areaMessagePosition'}" />
												<span id="areaMessagePosition"></span>
												<label class="requireField">*</label>
											</td>
										</tr>										
										<tr>
											...
											<td>
												<select id="recognizeeTypeId" name="recognizeeIdentityType" class="formText {required: true, messages: {required: '请填写被保人证件类型！'}}" >
									              <option value="身份证" <#if ("身份证" == information.recognizeeIdentityType)!> selected</#if>>身份证</option>
									              <option value="军官证" <#if ("军官证" == information.recognizeeIdentityType)!> selected</#if>>军官证</option>
									              <option value="护照" <#if ("护照" == information.recognizeeIdentityType)!> selected</#if>>护照</option>
									            </select>	
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input id="recognizeeId" type="text" name="recognizeeIdentityId" value="${(information.recognizeeIdentityId)!}" class="formText {required: true, messages: {required: '请填写被保人证件号码！'}}" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
											      <input type="radio" name="recognizeeSex" value="男"  <#if (information ==null)||(information.recognizeeSex == "男")!> checked</#if>>男
            									  <input type="radio" name="recognizeeSex" value="女" <#if (information.recognizeeSex == "女")!> checked</#if>>女		
            									<!--								
												<input type="text" name="recognizeeSex" value="1" class="formText {required: true, messages: {required: '请填写被保人性别！'}}" />
												-->
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" readonly="readonly" name="recognizeeBirthday" value="${(information.recognizeeBirthday)!}" onfocus="setday(this)"  class="formText {required: true, messages: {required: '请填写被保人出生日期！'}} readonly/>
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
								...
								<li>
									...
									<table>
										<tr>
											...
											<td>
												2012-08-01 00时 至 2013-07-31 24 时
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<label class="requireField">${product.price}</label>
											</td>
										</tr>
										<tr>
											<th>
	...
	<!--被保人信息 结束-->			
           ...
           <tbody id="TableData" class="dataContainer">
        	<s:iterator value="allProductAttr">
				...
				<div class="blank"></div>
				<!--
				<a class="backCartItem" href="${base}/shop/order!info.action"><span class="icon"> </span>返回购物车</a>
				-->
				<input type="submit" class="formButton" value="下一步" />
				<input type="button" onclick="sure();" value="暂存" class="red" hidefocus="true" />
