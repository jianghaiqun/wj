       ...
       <p>
         ...
         <p>
          ...
          <label class="requireField">*</label>
           ...
           <p>
	           <span>联系地址:</span> 
	           <input type="text" id="applicantAddress" name="informationAppnt.applicantAddress" maxlength=200 value="${(informationAppnt.applicantAddress)!}"  class="formText {required: true, messages: {required: '请填写投保人联系地址！'}}"/>
	           <label class="requireField">*</label>
	        </p>
	        <p>
	        <span>邮编:</span> 
  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <p>
        <span>目的地:</span>
        <select id="outGoingParpose1" name="informationInsureds1.outGoingParpose" class = "selectTest {selectTest:false, messages: {selectTest: '请选择目的地'}}">
             <option value="-1">--请选择--</option>
       		 <#list listCountryCode  as list>
             	<option value="${list.get('codeValue')}" <#if (informationInsureds1.outGoingParpose==list.get('codeValue'))>selected="selected"</#if>>${list.get("codeName")}-${list.get("codeEnName")}</option>
        	 </#list>
        </select>
        <label class="requireField">*</label>
     </p>
           ...
           <p>
            ...
            <p>
            	...
            	<label class="requireField">*</label>
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds1.recognizeeBirthday" onchange="validateBirthday();dateTrigger();"  type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"  value="${informationInsureds1.recognizeeBirthday}" onchange="validateBirthday();dateTrigger();"/>
	            	 <label class="requireField">*</label>
