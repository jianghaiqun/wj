       ...
       <p>
           ...
           <font color="#808080">填写的姓名一定要与有效身份证件保持一致，以保证日后理赔顺利。</font>
            ...
            <font color="#808080">证件类型和号码请您仔细选择或填写并核对无误，以免影响日后理赔。</font>
                ...
                <p>
                   <span>出生日期:</span> 
                   <input id="applicantBirthday" name="informationAppnt.applicantBirthday" type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"  value="${(informationAppnt.applicantBirthday)!}"  class="required" onchange="validateBirthday();dateTrigger();"/>
                	<label class="requireField">*</label>
  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <p>
            <span>驾校名称</span>
            <input type="text" id = "driverSchoolName1" name="informationInsureds1.driverSchoolName" value="${(informationInsureds1.driverSchoolName)!}" maxlength=50 class="required">
        </p>
        <p>
	        <span>学员编号</span>
	        <input type="text" id = "driverNo1" name="informationInsureds1.driverNo" value="${(informationInsureds1.driverNo)!}" maxlength=50 class="required">
        </p>
        <div id="insurancedOne"  style="display:none;">
            ...
            <p>
            	...
            	<label class="requireField">*</label>
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds1.recognizeeBirthday"  type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"  onchange="dateTrigger();validateBirthday();" value="${informationInsureds1.recognizeeBirthday}" />
	            	 <label class="requireField">*</label>
