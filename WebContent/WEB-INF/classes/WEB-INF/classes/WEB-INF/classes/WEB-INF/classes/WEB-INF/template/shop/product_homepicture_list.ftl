			...
			<form id="productListForm" action="${base}/shop/product!listhome.action" method="get">
				...
				<div class="productPictureList">
							...
							<li<#if (list_index + 1) % 4 == 0> class="end"</#if>>
								...
								<div class="productBottom">
									...
									<div class="productButton">
										<input type="button" name="addCartItemButton" class="addCartItemButton addCartItem {id: '${list.id}'}" <#if list.isOutOfStock>value="缺货" disabled<#else>value="投保"</#if> hidefocus="true" />
					...
					<div class="blank"></div>
         			...
         			<@p.pager pager = pager baseUrl = "/shop/product!listhome.action" parameterMap = parameterMap />
				</div>
			</form>
		</div>
		<div class="blank"></div>
