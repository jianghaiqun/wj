...
<div class="bbr_des" id="from_tab"><div class="br_box clearfix"><#if (listCountryCode!=null && listCountryCode.size()>0)>
<#list listCountryCode as list>
<p>
           <span>*旅游目的地：</span>
           <span>${list.codeName}</span>
          <input type="hidden" id="recognizeedestinationCountry" name="sdinformationinsured.destinationCountry" value="${list.codeValue}" />
 </p>
 </#list> </#if><#if (limitCount>1)>
                 <p>
...
<font color="#E7AC59" style="display:none"> <i class="yz_mes_des">请填写正确的手机号</i></font>
            </p><#if (listCountryCode!=null && listCountryCode.size()>0)>
<#list listCountryCode as list>
<p>
           <span>*旅游目的地：</span>
           <span>${list.codeName}</span>
          <input type="hidden" id="destinationCountry_${x-1}" name="sdinformationinsuredList[${x-1}].destinationCountry" value="${list.codeValue}" />
 </p>
 </#list> </#if><#if (limitCount>1)>
                 <p>
	             	<span class="span_t">*购买份数：</span> 
