		...
		<tr>
			<td colspan="10" >
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<td bgcolor="#fafafa" style="height:160px; width:600px;border:1px solid #e8e8e8; padding-left:20px;"><p style="line-height:1.6em; font-size:12px;">
						<span style="color:#222222; font-size:12px">您的会员等级已升级为 K2会员
						<#if (K2BirPoints)??>
						，生日当月您将获得<b style="color:#FF7500; font-size:12px">${K2BirPoints}</b>倍积分
							<#if (K2BuyPoints)??>
							，
							<#else>
							。
						...
						<#if (K2BuyPoints)??>
						购买保险额外享受<b style="font-size:12px; color:#289DD5;">${K2BuyPoints}</b>积分返还。
						</#if>
						</span><p style="line-height:1.8em; font-size:12px;">优惠享不够？<br>登陆开心保会员中心可申请VIP会员，积分返还比例加倍，每年还可获赠健康风险评估等豪华礼包，<br>赶紧去看看吧。</p>
