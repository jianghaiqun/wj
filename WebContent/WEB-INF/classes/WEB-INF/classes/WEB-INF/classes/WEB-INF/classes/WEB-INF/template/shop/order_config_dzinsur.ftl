   ...
   &nbsp;&nbsp;&nbsp;
    ...
    <div class="line_a">
	            ...
	            <p>
					...
					<#else>    
						<#list planList as list>
							...
							<span id="plan-one">${list.factorDisplayValue}</span>
						</#list>   
					</#if>
	            </p>
	         </#if>    
       ...
       <div class="form">
	    ...
	    <input type ="hidden"  id ="brkRiskName" name="order.brkRiskName" value="${order.brkRiskName}" />
       ...
       <p>
        ...
        <#list productConfigs as list>	
	      	<#if (list.type=="EnName" && list.flag=="Y")>	 
	          	<p>
	          		 <span>英文名或拼音:</span> 
	             	 <input type="text" id="recognizeeEnName1" name="informationInsureds.recognizeeEnName" value="${(informationInsureds.recognizeeEnName)!}"  class="required English"/>
	         		 <label class="requireField">*</label>
	          	</p>
	      	</#if>
	    </#list>
	     		...
	     		<#if (list.type=="Occupation" && list.flag=="Y")>
			         <p>
			            ...
			            <select name="informationInsureds.occupation1" id="s1" onchange="getChildrenOPT(this.value,'s3','-1',this);" style="width:125px;">
			             ...
			             <select name="informationInsureds.occupation3" id="s3" style="width:125px;">
			             		<option value="-1">--请选择--</option>
			             </select>
			             <label class="requireField">*</label>
			             <font id="occupID" color="red"></font>
        ...
        <#list productConfigs as list>
     		<#if (list.type=="Country" && list.flag=="Y")>
	     		<p>
		     		<span>旅游目的地:</span> 
		     		<input type="text" id="destinationCountryText1" name="informationInsureds.destinationCountryText" value="${(informationInsureds.destinationCountryText)!}" class="required" />
		     		<label class="requireField">*</label>
	     		</p>
	     		<font color="#808080">请将签证国写在第一位，如法国（签证国）、德国、瑞典等。 </font>
     		</#if>
 		</#list>
        <#list productConfigs as list>
