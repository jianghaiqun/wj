...
function changeInformation(objForm,aa){
   ...
   if(s=="本人"){
	    ...
	    cancelVerification();
		    ...
		    document.getElementById("recognizeeAddress1").value = document.getElementById("applicantAddress1").value;
...
function checkage(productid){
	if(productid == 104801004){
	 birth=document.getElementById("recognizeeBirthday1").value;
	 var now=new Date();
   				...
   				<#list productConfigs as list>
		     		<#if (list.type=="Occupation" && list.flag=="Y")>
				         <p>
				            ...
				            <select id="s3" name="informationInsureds.occupation3"  style="width:125px;_width:200px;" class="selectTest {selectTest:false, messages: {selectTest: '请选择职业'}}">
			             		<option value="-1">--请选择--</option>
				             </select>
				             <font id="occupID1" color="red"></font>
				             <font id="occupID2" color="red"></font>
				         </p>
			         </#if>
		         </#list>
         </div>
