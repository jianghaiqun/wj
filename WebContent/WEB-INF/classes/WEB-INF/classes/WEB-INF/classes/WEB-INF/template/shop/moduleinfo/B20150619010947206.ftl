...
<em class="other_tip" style="display:none"> <i class="yz_mes_des">理财险投保人必须与付款银行卡持卡人姓名一致</i></em>
			           ...
			           <input type="text" id="applicantEnName" name="sdinformationAppnt.applicantEnName" value="${(sdinformationAppnt.applicantEnName)!}" 
class="required English" maxlength=50 
onfocus="verifyShowInf(this.value,this.id);" 
onblur="verifyElement('英文名或拼音|NOTNULL&UFO&ENG&LEN>2',this.value,this.id)"
verify="英文名或拼音|NOTNULL&UFO&ENG&LEN>2'" />
<label class="requireField"></label>
...
</div><p><span class="span_t">*地区：</span><select name="sdinformationAppnt.applicantArea1" id="applicantArea1" onchange="getChildrenArea(this.value,'applicantArea2',-1,this);" style="width:125px;" verify="地区|OccuFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)"><option value="-1">--请选择--</option><#list areaList as list><option value="${list.id}" <#if (sdinformationAppnt.applicantArea1==list.id)>selected="selected"</#if>>${list.name}</option></#list></select> 
<select name="sdinformationAppnt.applicantArea2" id="applicantArea2" onchange="getChildrenArea(this.value,'applicantArea3',-1,this);"  style="width:125px;" verify="地区|AreaFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)" >
<option value="-1">--请选择--</option></select>
<select name="sdinformationAppnt.applicantArea3" id="applicantArea3" style="width:125px;"  verify="地区|AreaFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)"><option value="-1">--请选择--</option></select>
<input type="text" id="applicantAddress"  class="adddress_long"  name="sdinformationAppnt.applicantAddress" maxlength=200
onblur="verifyElement('联系地址|NOTNULL&ADDRESS',this.value,this.id)"
 verify="联系地址|NOTNULL&ADDRESS" value="${(sdinformationAppnt.applicantAddress)!}"/><label class="requireField"></label>
		         </p><p>
		    		<span class="span_t">*职业：</span>
		            <select name="sdinformationAppnt.applicantOccupation1" id="applicantOccupation1" onchange="getChildrenOPT(this.value,'applicantOccupation3',-1,this,'3');" style="width:125px;" verify="职业|OccuFormat" onblur="verifyElement('职业|OccuFormat',this.value,this.id)">
		             ...
		             <select name="sdinformationAppnt.applicantOccupation3" id="applicantOccupation3" style="width:125px;"  verify="职业|OccuFormat" onblur="verifyElement('职业|OccuFormat',this.value,this.id)">
<option value="-1">--请选择--</option>
</select>
<label class="requireField"></label>
</p></div>