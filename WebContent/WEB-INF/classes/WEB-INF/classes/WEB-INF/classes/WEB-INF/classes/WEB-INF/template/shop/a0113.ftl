...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
					...
					<td style="width:320px;height:150px;bgcolor:#fafafa;" bgcolor="#fafafa">
								<table border="0"  style="width:320px;"  cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td style="width:78px;height:85px;"><img src="http://resource.kaixinbao.com/active_file/images/email/yhjsf_09.gif" alt=""></td>
									</tr>
								</table>
								<table border="0" style="width:320px;"  cellpadding="0" cellspacing="0">
									<tr>
										<td style="width:19px;"><img src="http://resource.kaixinbao.com/active_file/images/email/yhjsf_10.gif" width="19px;" alt=""> </td>
										...
										<td style="width:13px;height:30px;"><img src="http://resource.kaixinbao.com/active_file/images/email/yhjsf_13.gif" width="33px;" height="33px" alt=""></td>
									</tr>
								</table>
					</td>
					<td style="width:130px;height:150px;bgcolor:#fafafa;" bgcolor="#fafafa"></td>
					</tr>
					<tr>
						<td colspan="3" style="height:20px;bgcolor:#fafafa;" bgcolor="#fafafa"></td>
					</tr>
					<tr>
						<td colspan="3" bgcolor="#fafafa" style="text-align: center; font-size:12px;"><b style="font-size:14px; color:#fe5555; padding-bottom:8px;">亲爱的用户，您好！</b><p>恭喜您获得<span style="color:#fe5555;">${parValueShow}优惠劵</span>一张		 <br>
	...
	<#if (MailProductList?size > 0)>	
		<tr>
			<td colspan="10" style="height:22px; width:600px;bgcolor:#ffffff;" bgcolor="#ffffff"></td>
		</tr>
		<tr>
			<td colspan="10">
