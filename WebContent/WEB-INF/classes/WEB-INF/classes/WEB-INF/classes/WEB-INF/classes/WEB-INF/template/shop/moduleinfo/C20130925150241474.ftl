...
verify="电子邮箱|NOTNULL&EMAIL"/>
            ...
            <span class="span_t">*驾校名称：</span>
            <input type="text" id = "recognizeedriverSchoolName_${x-1}" name="sdinformationinsuredList[${x-1}].driverSchoolName" value="${(sdinformationinsuredList[x-1].driverSchoolName)!}" 
onblur="verifyElement('驾校名称|NOTNULL',this.value,this.id)"
maxlength=50 verify="驾校名称|NOTNULL"/>
 <label class="requireField"></label>
        </p><p>
	        <span class="span_t">*学员编号：</span>
	        <input type="text" id = "recognizeedriverNo_${x-1}" name="sdinformationinsuredList[${x-1}].driverNo" value="${(sdinformationinsuredList[x-1].driverNo)!}" maxlength=50 
onblur="verifyElement('学员编号|NOTNULL',this.value,this.id)"
verify="学员编号|NOTNULL"/>
 <label class="requireField"></label>
        </p><p>
