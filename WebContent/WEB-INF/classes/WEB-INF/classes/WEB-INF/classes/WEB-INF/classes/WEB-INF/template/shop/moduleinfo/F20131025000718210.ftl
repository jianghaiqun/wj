          ...
          <select id="propertyToRecognizee_${x-1}" name="sdinformationpropertyList[${x-1}].propertyToRecognizee">
           ...
           <label class="requireField"></label>
                ...
                <select id="hourseAge_${x-1}" name="sdinformationpropertyList[${x-1}].hourseAge" verify="房龄|HOURSEAGE" onblur="verifyElement('房龄|HOURSEAGE',this.value,this.id)">
		         ...
		         <select id="propertyArea1_${x-1}" name="sdinformationpropertyList[${x-1}].propertyArea1" onchange="getChildrenArea(this.value,'propertyArea2_${x-1}','-1',this);" style="width:125px;" >
		            <option value="-1">--请选择--</option>
			     ...
			     <select id="propertyArea2_${x-1}" name="sdinformationpropertyList[${x-1}].propertyArea2"  style="width:125px;" verify="所在地区|AreaFormat" onblur="verifyElement('所在地区|AreaFormat',this.value,this.id)">
			           <option value="-1">--请选择--</option>
			     </select>
