...
<table id="__01" width="600"  border="0"  align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td  colspan="10" style="padding-top:10px;height:80px;"><b style="font-size:14px;">尊敬的会员，您好：</b> <br>
			<p style="color:#222222; font-size:12px;">请点击以下链接续保，如有疑问，请与我们联系，开心保客服电话4009789789</p></td>
	</tr>
	<tr>
		<td colspan="10" style="padding-left:8px;padding-top:8px;padding-right:8px;padding-bottom:8px; color:#888888; border-top:1px solid #e8e8e8; border-left:1px solid #e8e8e8; border-right:1px solid #e8e8e8; border-bottom:1px solid #e8e8e8; font-size:12px;" bgcolor="#fafafa">
			<a target="_blank;" href="${renewalUrl}">${renewalUrl}</a>
