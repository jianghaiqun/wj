				...
				<td>
					<div class="member_yhq_bg">
						<div class="member_yhq_j">
							<p class="member-yhq-tit"><s:if test="#list.unit==\"折\""><span><s:property value="#list.parValue" /></span><em><s:property value="#list.unit" /></em></s:if><s:else><em><s:property value="#list.unit" /></em><span><s:property value="#list.parValue" /></span></s:else></p>
