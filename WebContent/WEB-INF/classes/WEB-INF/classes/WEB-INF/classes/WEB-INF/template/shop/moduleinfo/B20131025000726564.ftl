...
<label class="requireField"></label>
				        ...
				        <span class="span_t">*是否有医保:</span> 
				        <select id="socialSecurity" name="sdinformationAppnt.socialSecurity" style="width:125px;">
							<#list securityList as list>
		             		  <option value="${list.codeValue}" <#if (sdinformationAppnt.socialSecurity==list.codeValue)!>selected="selected"</#if>>${list.codeName}</option>
							</#list>
						</select>
				        <label class="requireField"></label>
			        </p></div>