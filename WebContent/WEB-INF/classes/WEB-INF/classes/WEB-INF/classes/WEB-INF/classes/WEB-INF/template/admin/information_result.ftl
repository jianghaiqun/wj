				...
				<div class="messageContent">
					...
					<span class="messageText">
						...
						<#else>
							...
							产品:<strong class="red">${product.name}</strong>投保信息修改成功
						</#if>
					</span>
				</div>
				<input type="button" class="formButton messageButton" onclick="window.location.href='${base}/admin/order!edit.action?order.id=${order.id}'" value="确  定" hidefocus="true" />
			</div>
