...
onblur="verifyElement('联系地址|NOTNULL&ADDRESS',this.value,this.id)"
 verify="联系地址|NOTNULL&ADDRESS" value="${(sdinformationAppnt.applicantAddress)!}"/><label class="requireField"></label>
		        	 ...
		        	 <input type="text" id="height" name="sdinformationAppnt.height" value="${(sdinformationAppnt.height)!}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength=3 
...
<p>
		        	 ...
		        	 <input type="text" id="weight" name="sdinformationAppnt.weight" value="${(sdinformationAppnt.weight)!}" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" maxlength=7 
