...
function checkInsurePay(){
        var checkOrderSn = document.getElementById("checkOrderSn").value;
		jQuery.ajax({
					url: sinosoft.base+"/shop/member_shopcart!checkInsure.action?callback=?&checkOrderSn="+checkOrderSn,
					dataType: "json",
					async: false,
...
<div class="wrapper">
	...
	<div class="w900">
		...
		<form id ="resultForm" action="${base}/shop/member_shopcart!shopCartPay.action" method="get"> 
		<input type="hidden" name="passFlag" id="passFlag" value="${passFlag}" /> 
		<input type="hidden" value="${KID}" name="KID" id="KID" />
		<input type="hidden" name="checkOrderSn" value="${checkOrderSn}" id="checkOrderSn" />
		...
		<div class="lay-ins-con pro-tab">
			...
			<table border=0 cellspacing=0 cellpadding=0>
					...
					<#assign href=base + "/shop/member_shopcart!getShopCartINF.action"/>
