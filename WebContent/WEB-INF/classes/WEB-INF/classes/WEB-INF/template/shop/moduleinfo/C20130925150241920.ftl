...
verify="起飞时间|NOTNULL&FIGHTTIME"/>
	        ...
	        <span class="span_t">*起飞地点：</span> 
	        <input type="text" id="recognizeeflightLocation_${x-1}" maxlength=20 name="sdinformationinsuredList[${x-1}].flightLocation" value="${(sdinformationinsuredList[x-1].flightLocation)!}" 
onblur="verifyElement('起飞地点|NOTNULL&LEN<=60',this.value,this.id)"
verify="起飞地点|NOTNULL"/>
	        <label class="requireField"></label>
	    </p><#if (limitCount>1)>
