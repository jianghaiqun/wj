...
var apt=jQuery("#apt").val();
location.href="order_query!list.action?ldate="+sd+"&hdate="+ed+"&orderStatus="+kw+"&applicant="+apt+"&page=1";
}
function jumpbefore() {
var sd= jQuery("#sd").val();
var ed=jQuery("#ed").val();
...
location.href="order_query!list.action?ldate="+sd+"&hdate="+ed+"&orderStatus="+kw+"&applicant="+apt+"&page="+bg;  
}
}
function jumpnext() {
var sd=jQuery("#sd").val();
...
location.href="order_query!list.action?ldate="+sd+"&hdate="+ed+"&orderStatus="+kw+"&applicant="+apt+"&page="+ng;  
}
}
function jumplast() {
var sd= jQuery("#sd").val();
...
var pg=jQuery("#pg").val();
var lg=jQuery("#lg").val();
location.href="order_query!list.action?ldate="+sd+"&hdate="+ed+"&orderStatus="+kw+"&applicant="+apt+"&page="+lg;  
}
...
<div class="MemberCenterMiddArea">
      ...
      <div class="MemberMenuArea mr10">
       <div class="ActiveArea" style="top:52px;">
        	<a href="order_query!list.action" class="IcoUser_2">我的订单</a>
       </div>
    	<ul class="mcmenulist">
    ...
    <div class="MemberCenterOrderArea">
    	  <h3 class="titmc02">我的订单</h3>
			<div class="mcsearch">
			<form  id="myOrder" action="order_query!list.action" method="post"  onsubmit="return validateOrder();">
				<ul>
					<li>
						...
						<label>订单状态：</label><select id="orderStatus" name="orderStatus">
							...
							<option value="9" <#if (orderStatus=="9")!>selected</#if>>已退保</option>
						</select>
					</li>
					<li>
