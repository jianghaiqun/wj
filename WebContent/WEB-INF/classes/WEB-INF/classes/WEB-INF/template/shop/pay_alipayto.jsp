...
<%
	...
	//请与贵网站订单系统中的唯一订单号匹配
	String out_trade_no = (String) request.getAttribute("paySn");
	//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
	String subject = (String) request.getAttribute("subject");
	//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
	String body = (String) request.getAttribute("alibody");
	...
	if (request.getAttribute("payType").equals("zfb")) {
		paymethod = "directPay";

	} else {
		paymethod = "bankPay";
		defaultbank = (String) request.getAttribute("GateId");
	}
	...
	String show_url = (String) request.getAttribute("show_url");
