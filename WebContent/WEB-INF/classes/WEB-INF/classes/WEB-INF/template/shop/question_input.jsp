...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="member_nearorderTable">
	<tbody>
		<tr>
			<th width="371px;">我的提问</th>
			<th width="186px;">问题补充说明</th>
			<th width="163px;">提问时间</th>
		</tr>
		<s:iterator id="list" value="#request.sclist">
			<tr>
				<td>
				<span class="member_qatextCase">
				...
				<s:else>
   					<a href="<%=Config.getFrontServerContextPath() %>/<s:property value="#list.url"/>" target="_blank"><s:property value="#list.title" /></a>
				</s:else>
				</span>
				</td>
	...
	<div  class="page_area">
		<div id="pagination">
			<ul>
				...
				<s:else>
					<li class="page_prev"><a href="javascript:jumpPage('ask','<s:property value="#request.page-1"/>')"><span class="">上一页</span></a></li>
				</s:else>
				<s:iterator id="pageFootMap" status="st" value="#request.pageFootList">
					<li class="<s:property value="#pageFootMap.class" />">
						...
						<s:else>
							<a href="javascript:jumpPage('ask','<s:property value="#pageFootMap.index"/>')">
			        			<span><s:property value="#pageFootMap.index"/></span>
			        		</a>
						</s:else>
	        		</li>
				...
				<s:else>
					<li class="page_next"><a href="javascript:jumpPage('ask','<s:property value="#request.page+1"/>')"><span class="">下一页</span></a></li>
				</s:else>
			</ul>
		</div>
	</div>
