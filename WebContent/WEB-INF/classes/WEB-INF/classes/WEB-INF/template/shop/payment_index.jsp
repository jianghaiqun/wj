...
<form name=alipayment onSubmit="return CheckForm();" action=payment!alipayto.action
	method=post target="_blank">
<div id="body" style="clear: left">
<dl class="content">
	<dt>[订单编号]：</dt>
	<dd><span class="red-star">*</span> <input size=30 name=subject value="${order.orderSn}" readonly/>
	</dd>
	<dt>付款金额：</dt>
	<dd><span class="red-star">*</span> <input maxLength=10 size=30
		name=total_fee onfocus="if(Number(this.value)==0){this.value='';}"
		value="${order.productTotalPrice }" readonly/> <span>如：112.21</span></dd>
	<dt>备注：</dt>
	<dd><span class="null-star">*</span> <textarea
		style="margin-left: 3px;" name=alibody rows=2 cols=40 wrap="physical" readonly>${order.memo}</textarea><br />
