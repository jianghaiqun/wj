...
<p>
	 ...
	 <p class="from_update xg_width">
					...
					<font color="#808080">本产品起保日期为次日零时</font>
	...
	<p class="from_update xg_width">
					...
					<input id="fail_" name="fail_" readonly="readonly"   class="shop_day_cfs"  style="border:0;background:transparent;" value="${(sdinformation.endDate)!}" /> <em class="from-up-time" id="ensureDate_em">(从 ${sdinformation.startDate} 00时起到 ${sdinformation.endDate} 24时为止)</em>
