	...
	<table id="__01" width="600"  border="0"  align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td  colspan="10" style="padding-top:20px;height:80px;"><b style="font-size:14px;">${MemberRealName}</b> <br>
				<p style="color:#222222; font-size:12px;">您可以点击 <a href="${pwdURL}" target="_blank" style="color:#8abb5c; font-size:12px;">密码重置</a> 及时完成密码修改。</p></td>
		</tr>
		<tr>
			<td colspan="10" >
				<table border="0"  cellpadding="0" cellspacing="0" style="margin-bottom:20px; margin-top:10px;">
					...
					<tr>
						<td colspan="3" style="height:40px;font-size:12px;">若点击“密码重置”无效，您可复制下面网页地址到浏览器地址栏中打开：</td>
					</tr>
					<tr>
						<td colspan="3" style="padding-left:8px;padding-top:8px;padding-right:8px;padding-bottom:8px; color:#888888; border-top:1px solid #e8e8e8; border-left:1px solid #e8e8e8; border-right:1px solid #e8e8e8; border-bottom:1px solid #e8e8e8; font-size:12px;" bgcolor="#fafafa">
							${pwdURL}
						</td>
					</tr>
				</table>
