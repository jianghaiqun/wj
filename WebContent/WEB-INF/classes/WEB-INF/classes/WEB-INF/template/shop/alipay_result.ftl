...
<#else>
	...
	<!-- 百分点产品推荐 -->
	<!--  <div class="bfd_cp_box" style="display:none;"> 百分点合作结束，百分点核心代码暂存-->
...
<#if (channelsn  == "jfsc" || channelsn  == "wj_jfsc" || channelsn  == "wap_jfsc")>
	<div class="bore-des-h clear h20"></div>
    <div class="order-orter">
        <a href="${base}/shop/order_query!list.action" class="order-aooa order-aooa2 f_mi">查看订单</a>
        <a href="/" class="order-aooa f_mi">浏览其他商品</a>
    </div>
...
<script type="text/javascript" src ="http://t.agrantsem.com/js/AG_Tracking.js"></script>
<script type="text/javascript">
//请将js代码嵌入到html中body标签结束之前。（整个body部分最后边）
var _agq = _agq || [];
_agq.push(['_cid', '336']); //生成value
_agq.push(['_eid', '102']); //生成value
//以下参数需要客户配合填写。**为需要替代内容
_agq.push(['_orderNo','${tradeInformation.ordID}']);//订单号，客户在页面填写
ag_send(_agq);
</script>
