         ...
         <p>
          ...
          <label class="requireField">*</label>
            ...
            <p>
           	...
           	<label class="requireField">*</label><font color="#808080">请填写自己真实的号码，方便开心保为您提供优质服务。</font>
			</p>
			<p>
            <span></span>
        ...
        <div id="insurancedOne"  style="display:none;">
           ...
           <p>
            ...
            <div id="changerecognizeeInF1" style="display:none;">
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds1.recognizeeBirthday"  type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"  onchange="validateBirthday();dateTrigger();" value="${informationInsureds1.recognizeeBirthday}" onchange="validateBirthday();dateTrigger();"/>
	            	 <label class="requireField">*</label>
