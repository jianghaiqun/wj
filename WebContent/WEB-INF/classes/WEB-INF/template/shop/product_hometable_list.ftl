...
===================================================================暂时隐藏==========================================-->	
		...
		<div class="bodyRight">
			<form id="productListForm" action="${base}/shop/product!listhome.action" method="get">
				...
				<div class="listBar">
					...
					<div class="middle">
						...
						<div class="total">共计: ${pager.totalCount} 款产品</div>
					</div>
					<div class="right"></div>
				</div>
				<div class="blank"></div>
				<div class="operateBar">
					...
					<div class="middle">
						...
						<select id="orderType" name="orderType">
							...
							<option value="priceAsc"<#if orderType == "priceAsc"> selected="selected"</#if>>保费从低到高</option>
							<option value="priceDesc"<#if orderType == "priceDesc"> selected="selected"</#if>>保费从高到低</option>
				...
				<div class="productTableList">
					<ul class="productListDetail">
							...
							<li>
								...
								<div class="productTitle">
									<#if (list.name?length < 28)>
										<span class="namelink"><a href="${base}${list.htmlFilePath}" alt="${list.name}" target="_blank">${list.name}</a></span
									<#else>
										<a href="${base}${list.htmlFilePath}" alt="${list.name}" target="_blank">${list.name[0..25]}...</a>
									</#if>
									<br/>
									<div class="producont01"><br/><div>产品介绍：</div>${list.description}</div>
								</div>
								<div class="productRight">
									<div class="productPrice">
									<span><a href="${base}${list.professionalPath}"><img src="${staticPath}/upload/image/btnzjdp.gif" alt="专家点评" /></a></span>
									<span><a href="${base}${list.videoPath}"><img src="${staticPath}/upload/image/btnspjs.gif" alt="视频介绍" /></a></span>
										<!--
										<span><a href="${base}${list.professionalPath}"><strong>专家点评</strong></a></span>
										<span><a href="${base}${list.videoPath}"><strong>视频介绍</strong></a></span>
										-->
						...
						<#if (pager.list?size == 0)!>
                			<li class="noRecord">非常抱歉，没有找到相关产品！</li>
                		</#if>
					</ul>
					<div class="blank"></div>
         			<link href="${shopStaticPath}/template/shop/css/pager.css" rel="stylesheet" type="text/css" />
