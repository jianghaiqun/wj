...
</#if><#if (sdinformation.planCode)??>
<p>
	        	<span class="span_t">计划保额：</span> 
	            <span style="width:500px;">
	                
	                	${sdinformation.planName}
		                <input type="hidden" name="sdinformation.planName1" id = "planName" value="${sdinformation.planName1}" />
		                <input type="hidden" name="sdinformation.planCode1" id = "planCode" value="${sdinformation.planCode1}" />
