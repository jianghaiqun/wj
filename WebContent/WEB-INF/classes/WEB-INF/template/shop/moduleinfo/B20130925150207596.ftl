...
/>
	            ...
	            <input id="applicantStartID" name="sdinformationAppnt.applicantStartID" type="text" onclick="WdatePicker({skin:'whyGreen',minDate:'%y-%M-{%d-18000}',maxDate:'%y-%M-{%d+0}'})"  onFocus = "effchange()"  value="${(sdinformationAppnt.applicantStartID)!}"  onblur="verifyElement('证件有效日期|NOTNULL',this.value,this.id)" verify="证件有效日期|NOTNULL" class="shop_day"/> 
	           至
