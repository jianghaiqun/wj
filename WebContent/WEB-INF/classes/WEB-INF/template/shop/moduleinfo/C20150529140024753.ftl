...
onblur="idcheck('recognizeeTypeId_${x-1}','recognizeeId_${x-1}','recognizeeBirthday_${x-1}','recognizeeSex_${x-1}','sdinformation.InsuranceCompany');" />
	...
	<input id="recognizeeStartID_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeStartID" type="text" onclick="WdatePicker({skin:'whyGreen',minDate:'%y-%M-{%d-18000}',maxDate:'%y-%M-{%d-1}'})"  onFocus = "effchange()"  value="${(sdinformationinsuredList[x-1].recognizeeStartID)!}" onblur="verifyElement('证件有效日期|NOTNULL',this.value,this.id)" verify="证件有效日期|NOTNULL" class="shop_day"/> 
	至 
	<#if ("${(sdinformationinsuredList[x-1].recognizeeEndID)!}"=="9999-12-31")!>
		<input id="recognizeeEndID_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeEndID" type="text" onclick="WdatePicker({skin:'whyGreen',minDate:'%y-%M-{%d+0}',maxDate:'%y-%M-{%d+18000}'})"  onFocus = "effchange()"  value=""  disabled onblur="verifyElement('证件有效日期|NOTNULL',this.value,this.id)" class="shop_day" disabled="disabled"/>
		<input type="checkbox" id="Checkzjnum_long_${x-1}" checked="checked" style="width: 20px; border: 0px; padding-right: 0px; vertical-align: middle;" value="0" onclick=CheckapplicantEndID('#recognizeeEndID_${x-1}','#Checkzjnum_long_${x-1}'>长期
	<#else>
		...
		<input type="checkbox" id="Checkzjnum_long_${x-1}" style="width: 20px; border: 0px; padding-right: 0px; vertical-align: middle;" onclick=CheckapplicantEndID('#recognizeeEndID_${x-1}','#Checkzjnum_long_${x-1}') >长期
  </#if>
  <label class="requireField"></label> 
...
<span class="span_t">*所在地区：</span> 
					    <select id="recognizeeArea1_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea1" onchange="getChildrenArea(this.value,'recognizeeArea2_${x-1}','-1',this);" style="width:125px;">
					     ...
					     <select id="recognizeeArea2_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea2" onchange="getChildrenArea(this.value,'recognizeeArea3_${x-1}',-1,this);" style="width:125px;" verify="所在地区|AreaFormat" onblur="verifyElement('所在地区|AreaFormat',this.value,this.id)">
					           <option value="-1">--请选择--</option>
					     </select>
						 <select id="recognizeeArea3_${x-1}" name="sdinformationinsuredList[${x-1}].recognizeeArea3"  style="width:125px;" verify="所在地区|AreaFormat" onblur="verifyElement('所在地区|AreaFormat',this.value,this.id)">
					           <option value="-1">--请选择--</option>
					     </select>
