				      ...
				      <p>
				          ...
				          <#if appTypeList?size = 1>
				          	<#list appTypeList as list>
				          		<input type="hidden" name="appType" id="appType" value="${list.factorValue}">
  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <p>
	        <span>航班号:</span> 
	        <input type="text" id="flightNo1" maxlength=200 name="informationInsureds1.flightNo" value="${(informationInsureds1.flightNo)!}" class="required"/>
	        <label class="requireField">*</label>
	    </p>
	    <p>
	        <span>起飞时间:</span> 
        ...
        <div id="insurancedOne"  style="display:none;">
            ...
            <p>
            	...
            	<label class="requireField">*</label>
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds1.recognizeeBirthday" onchange="validateBirthday();dateTrigger();"  type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})"   value="${informationInsureds1.recognizeeBirthday}" />
	            	 <label class="requireField">*</label>
