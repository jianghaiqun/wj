...
<div class="sdong"></div>
 ...
 <center>
	 ...
	 ￥	<span id = "priceTotle_"><#if (information.protectionPeriod)??>${order.productTotalPrice}<#else>${price}</#if></span>
       ...
       <p>
               <span>姓名:</span> 
               <input type="text" id="applicantName" name="informationAppnt.applicantName" value="${(informationAppnt.applicantName)!}"  class="required"  onkeyup="value=value.replace(/[^\a-\z\A-\Z\u4E00-\u9FA5]/g,'')" maxlength=50/>
