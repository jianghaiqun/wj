...
<head>
	...
	<link href="http://resource.kaixinbao.com/style/redesign/re_header.css" rel="stylesheet" type="text/css" />
	<link href="http://resource.kaixinbao.com/style/redesign/re_member.css" rel="stylesheet" type="text/css" />
			...
			<div class="member_right ">
				...
				<!-- 未支付订单列表 start -->
				 	   <div class="member-htit">
                            ...
                            <a href="order_query!financingManager.action" class="lc_gotolist">查看持有中理财险产品</a>
				        </div>
         				<div class="clear h20"></div>
	                 	<div id="member_ordertable">
		                 	<div id="member_ordertable" class="lc_min_height">
								<jsp:include page="order_query_newSurrenderEffect.jsp"></jsp:include>							
							</div>
						</div>
				</div>
			</div>
