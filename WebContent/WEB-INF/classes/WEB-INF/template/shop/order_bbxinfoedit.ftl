...
var s=["s1","s2","s3"]; 
var opt0 = ["${information.occupation1}","${information.occupation2}","${information.occupation3}"]; 
function setup() 
{ 
...
<!---=========增加填写保单信息的功能======------>
	...
	<div class="body">
		...
		<div class="orderInfoDetail">
			<form id="orderInfoForm" action="order!bbxinfoupdate.action?orderItemId=${orderItem.id}&productId=${product.id}&orderId=${orderId}" method="post">
				<input type="hidden" name="orderstatus" value="other" />
				<@s.token />
								...
								<li>
									...
									<table>
										...
										<tr>
											...
											<td>
												<select name="applicantIdentityType" class="formText {required: true, messages: {required: '请选择投保人证件类型！'}}" >
									              <!--
									              <option value="0" >请选择...</option>
									              -->
									              <option value="${information.applicantIdentityType}" >${information.applicantIdentityType}</option>
												...
												<!--
												<input type="text" name="applicantIdentityType" value="1" class="formText {required: true, messages: {required: '请填写投保人证件类型！'}}" />
												-->
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="applicantIdentityId" value="${information.applicantIdentityId}" class="formText {required: true, messages: {required: '请填写投保人证件号码！'}}" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
            									...
            									<#else>
            									  ...
            									  <input type="radio" name="applicantSex" value="女" checked>女
            									</#if> 
												<label class="requireField">*</label>
											</td>
										</tr>
								...
								<li>
									...
									<table>
										...
										<tr>
											...
											<td>
												<select name="recognizeeIdentityType" class="formText {required: true, messages: {required: '请填写被保人证件类型！'}}" >
									             <!--
									              <option value="0" selected>请选择...</option>
									              -->
									              <option value="${information.recognizeeIdentityType}" >${information.recognizeeIdentityType}</option>
									              <option value="身份证" >身份证</option>
									              <option value="军官证" >军官证</option>
									              <option value="护照" >护照</option>
									              <option value="其他" >其他</option>
									            ...
									            <!--										
												<input type="text" name="recognizeeIdentityType" value="1" class="formText {required: true, messages: {required: '请填写被保人类型！'}}" readonly/>
												-->
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="recognizeeIdentityId" value="${information.recognizeeIdentityId}" class="formText {required: true, messages: {required: '请填写被保人证件号码！'}}" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" name="recognizeeBirthday" value="${information.recognizeeBirthday}" onfocus="setday(this)"  class="formText {required: true, messages: {required: '请填写被保人出生日期！'}} readonly/>
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
					...
					<tr>
						<th>产品附加投保信息填写</th>
							...
							<#list cartItemSet as list>
									<div class="blank"></div>
									产品名称${indexsky}：<font color="red">${list.product.name}</font>
									<#assign index = 1 />
									<#list (list.product.productInsType.enabledProductInsAttributeList)! as list>
				                    		<li>
				                    			<strong>${list.name}:</strong><input type="text" name="${list.id}" class="formText" />
...
<!-----------====================product与数据库测试============================---------------------->
           ...
           <tbody id="TableData" class="dataContainer">
        	<s:iterator value="allProductAttr">
				...
				<input type="button" class="formButton messageButton" <#if redirectionUrl??>onclick="window.location.href='${redirectionUrl}'"<#else>onclick="window.history.back(); return false;"</#if> value="返 回" hidefocus="true" />
				-->
				<input type="submit" class="formButton" value="确定" />
				<input type="button" onclick="sure();" value="保单暂存" class="red" hidefocus="true" />
