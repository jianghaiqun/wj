	...
	<table id="__01" width="600"  border="0"  align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td  colspan="10" style="padding-top:20px;height:80px;"><b style="font-size:14px;">${MemberRealName}</b> <br>
				<p style="color:#222222; font-size:12px;">您在开心保（kaixinbao.com）使用了找回密码服务，您可以点击以下链接修改您的密码：</p></td>
		</tr>
		<tr>
			<td colspan="10" >
				<table border="0"  cellpadding="0" cellspacing="0" style="margin-bottom:20px; margin-top:10px;">
					<tr>
						<td colspan="3" bgcolor="#fafafa" style="padding-left:8px;padding-top:8px;padding-right:8px;padding-bottom:8px; color:#888888; border-top:1px solid #e8e8e8; border-left:1px solid #e8e8e8; border-right:1px solid #e8e8e8; border-bottom:1px solid #e8e8e8; color:#299cd5;text-decoration: underline;width:600px;">
							<a href="${retrieveURL}" style="color:#299cd5; font-size:12px;" target="_blank">${retrieveURL}</a>
						</td>
					</tr>
					<tr>
						<td style="color:#222222; line-height:1.8em; font-size:12px;" height="60px;">该链接时效为24小时，请您尽快完成操作! <br>
	欢迎您再次到开心保购买保险！</td>
					</tr>
				</table>
			</td>
