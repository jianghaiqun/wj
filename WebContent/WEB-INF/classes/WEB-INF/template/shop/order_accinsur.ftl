        ...
        <div id="insurancedOne"  style="display:none;">
            ...
            <p>
            	...
            	<label class="requireField">*</label>
	             ...
	             <p>
	                 <span>出生日期:</span> 
	                 <input id="recognizeeBirthday1" name="informationInsureds1.recognizeeBirthday"  type="text" onclick="WdatePicker({skin:'whyGreen',startDate:'1980-01-01'})" onchange="dateTrigger()"  value="${informationInsureds1.recognizeeBirthday}" />
	            	 <label class="requireField">*</label>
	             </p>
            <p>
                <span>手机号码:</span> 
