               ...
               <#else>
                  ...
                  <div class="pay_quan" style="display: none" id="pay_yhj_box">
                    ...
                    <div id="yhj_list" class="pay_jf_tdjn" style="display:none">
                      <img src="http://localhost:8080/images/loading2.gif" alt="" />
                    </div>
                  </div>
...
<section id="clm_text" style="display:none;width:700px; padding: 0 25px;">
  ...
  <ul>
    ...
    <li><span>手机号：</span>${applicantMobile}</li>
    <li><span>开户银行：</span>${directPayBankInfo.bankName}</li>
    <li><span>充值金额：</span>人民币${map_info.ProductInfo[0].Amount}元（含第三方机构需收的手续费（如有））</li>
  </ul>
  <p>三、授权人知晓并确认，本授权书系使用授权人在网金保险网站以网络在线点击确认的方式向网金保险发出。本授权书自授权人在网金保险网站点击确认时生效，由网金保险通过银行或第三方机构从授权人的银行账户中操作执行相当于扣款金额的款项。授权人已经通过本授权书确认扣款项的银行账户信息，在扣款的过程中，网金保险根据本授权书提供的银行账户信息进行相关操作，无需再向授权人确认银行账户信息和密码。授权人确认并承诺，网金保险根据本授权书所采取的全部行动和措施的法律后果均由授权人承担。</p>
