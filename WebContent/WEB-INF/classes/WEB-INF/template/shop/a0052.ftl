...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<p style="line-height:1.2em;">
						本次购买您获得了<b style="color:#ff7600; font-size:12px; ">${Points}</b>个积分，下次购买可抵值<b style="color:#ff0000; font-size:12px; ">${PointsValue}</b>元&nbsp;<a style="color: #ed6d00;text-decoration: underline; font-size:12px; " href="${QueryPointsDesc}" target="_blank">积分使用说明</a><br></p></p></td>
		</tr>
		<tr>
			<td colspan="10">
		...
		<tr>
			<td colspan="10" >
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<td bgcolor="#fafafa" style="height:100px;width:600px;border:1px solid #e8e8e8; padding-left:20px;"><p style="line-height:1.4em; font-size:12px;">
						<span style="color:#222222; font-size:12px">您已经是我们的会员，您可以使用以下帐号登录、查看订单 </span><br>
						<span style="font-size:12px; color:#fb5759;">帐号：<a href="${MemCenterUrl}" style="cursor: auto;font-size:12px; color:#fb5759;">${username}</a></span><br>
					<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<a href="${order}" target="_blank" style="font-size:12px; color:#ed6d00;  border-bottom: 1px solid #ed6d00;">查看订单</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pwRetrieve}" target="_blank" style="font-size:12px; color:#1670d1;  border-bottom: 1px solid #1670d1;">找回密码</a> 
					</p></td>
				</table>
