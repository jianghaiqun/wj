		...
		<form id="listForm" action="log!list.action" method="post">
			...
			<table class="listTable">
				<tr>
					...
					<th>
						<span class="sort" name="channel">渠道</span>
					</th>
				</tr>
				<#list pager.list as list>
					<tr>
						...
						<td>
							...
							-->
							<span title="${list.createDate?string("yyyy-MM-dd HH:mm:ss")}">${list.createDate?string("yyyy-MM-dd HH:mm:ss")}</span>
						</td>
						<td>
							<#if (list.channel == "1")>苏州移动
							<#else>51百宝箱
							</#if>
						</td>
					</tr>
