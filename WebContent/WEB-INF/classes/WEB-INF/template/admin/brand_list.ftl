...
<body class="list">
	<div class="body">
		<div class="listBar">
			<h1><span class="icon">&nbsp;</span>保险公司列表&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></h1>
		</div>
		<form id="listForm" action="brand!list.action" method="post">
			...
			<table class="listTable">
				<tr>
					...
					<th>
						<span class="sort" name="name">保险公司名称</span>
					</th>
					<th>
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<#if (list.logo != null)!><a href="${staticPath}${list.logo}" class="imagePreview" target="_blank">查看</a><#else>暂无</#if>
						</td>
						<td>
							${list.orderList}
						</td>
