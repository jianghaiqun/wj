		...
		<form id="inputForm" class="validate" class="form" action="system_config!update.action" enctype="multipart/form-data" method="post">
			...
			<table class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<input type="text" name="systemConfig.hotSearch" class="formText" value="${(systemConfig.hotSearch)!}" title="页面显示的热门搜索关键字,多个关键字请以(${stack.findValue("@cn.com.sinosoft.bean.SystemConfig@HOT_SEARCH_SEPARATOR")})分隔" />
					</td>
				</tr>
				<tr>
					<th>
			...
			<table class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<input type="text" name="systemConfig.allowedUploadImageExtension" class="formText" value="${(systemConfig.allowedUploadImageExtension)!}" title="为空表示不允许上传图片文件,多个扩展名请以(${stack.findValue("@cn.com.sinosoft.bean.SystemConfig@EXTENSION_SEPARATOR")})分隔" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="systemConfig.allowedUploadMediaExtension" class="formText" value="${(systemConfig.allowedUploadMediaExtension)!}" title="为空表示不允许上传媒体文件,多个扩展名请以(${stack.findValue("@cn.com.sinosoft.bean.SystemConfig@EXTENSION_SEPARATOR")})分隔" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="systemConfig.allowedUploadFileExtension" class="formText" value="${(systemConfig.allowedUploadFileExtension)!}" title="为空表示不允许上传其它文件,多个扩展名请以(${stack.findValue("@cn.com.sinosoft.bean.SystemConfig@EXTENSION_SEPARATOR")})分隔" />
					</td>
				</tr>
				<tr>
					<th>
