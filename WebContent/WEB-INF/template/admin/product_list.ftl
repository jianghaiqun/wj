...
<body class="list">
	<div class="body">
		<div class="listBar">
			<h1><span class="icon">&nbsp;</span>产品列表&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></h1>
		</div>
		<form id="listForm" action="product!list.action" method="post">
			<div class="operateBar">
				<input type="button" class="addButton" onclick="location.href='product!add.action'" value="添加产品" />
				<label>查找:</label>
			...
			<table class="listTable">
				<tr>
					...
					<th>
						<span class="sort" name="productSn">险种号</span>
					</th>
					<th>
