...
<meta http-equiv="refresh" content="0.001;url=http://localhost:8080/sinosoft/admin/admin!login.action">
<title>管理登录</title>
<meta name="Author" content="SINOSOFT Team" />
<meta name="Copyright" content="SINOSOFT" />
<link rel="icon" href="favicon.ico" type="image/x-icon" />
<#include "/WEB-INF/template/common/include.ftl">
<link href="${shopStaticPath}/template/admin/css/login.css" rel="stylesheet" type="text/css" />
...
<body class="login">
	<div class="body">
		<div class="loginBox">
			...
			<div class="boxMiddle">
				<form id="loginForm" class="form" action="${base}/admin/loginVerify" method="post">
					<div class="loginLogo">
				    	<img src="${shopStaticPath}/template/admin/images/login_logo.gif" />
				    </div>
		            <table class="loginTable">
		                ...
		                <tr>
		                    ...
		                    <td>
		                    	...
		                    	<div class="captchaImage">
		                   			<img id="captchaImage" src="${shopStaticPath}/captcha.jpg" alt="换一张" />
		                   		</div>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    ...
		                    <td>
		                        ...
		                        <input type="button" class="helpButton ignoreForm" value="帮 助" onclick="window.open('http://www.sinosoft.com.cn')" hidefocus="true" />
		                    </td>
		                </tr>
		            </table>
		        </form>
		...
		<div class="footer">
			<a href="${base}/">前台首页</a>|
			<a href="http://www.sinosoft.com.cn">官方网站</a>|
			<a href="http://www.sinosoft.com.cn">官方论坛</a>|
			<a href="http://www.sinosoft.com.cn">关于我们</a>|
			<a href="http://www.sinosoft.com.cn">联系我们</a>
		</div>
	</div>
</body>
</html>