...
function checkIdcard(myId){
	...
	var myId;
	var idcard="aray";
	var applicantTypeValue = document.getElementById("applicantTypeId").value;
	var recognizeeTypeValue = document.getElementById("recognizeeTypeId").value;
	if((myId=="applicantId")&&(applicantTypeValue=="身份证"))
	{
		idcard = document.getElementById(myId).value;
	}if((myId=="recognizeeId")&&(recognizeeTypeValue=="身份证"))
	{
		idcard = document.getElementById(myId).value;
	}
	if(idcard != "aray"){
...
<body>
    ...
    <div class="headwrap">
		<div class="head">
			<div class="logo"><a href="indexProduct.html"><img src="${base}/template/shop/sz/images/logo.gif" /></a></div>
			<div class="navarea">
				<div class="navbgleft"></div>
					<ul class="nav">
						<li class="link01on"><span></span></li>
						<li class="link02"><span><a href="${base}/shop/article!list.action?id=8a368087328b9e5f01328be4064d0005"></a></span></li>
						<li class="link03"><span><a href="${base}/shop/article!list.action?id=8a368087328b9e5f01328be458c30006"></a></span></li>
					</ul>
	 ...
	 <div class="wrap">
		<div class="wrapa">
    		<div class="bread"><span>首页</span><span>></span><span>产品中心</span>> <span>填写投保信息</span></div>
			
<!---=========增加填写保单信息的功能======------>
	<div class="pd01part02">
            <div class="tabbox"> 
                <div class="buytit"><span class="ico01">填写投保信息</span></div> 
                <div class="tabcont"> 
                    <div class="tabc">
                        <h3>投保人信息</h3>
                        <form id="orderInfoForm" name="orderInfoForm" action="order!szinfosave.action?orderItemId=${orderItem.id}&productId=${product.id}&orderId=${orderId}" method="post">
						<@s.token />
						<table width="856" cellspacing="0" cellpadding="0" class="table02">
						<tbody>
  							<tr>
    							<th width="300" align="right" valign="top"><span class="red">* </span>投保人姓名：</th>
    							<td width="554"><input type="text" name="applicantName" value="" style="width:200px;" class="formText {required: true, messages: {required: '请填写投保人姓名！'}}" /></td>
  							</tr>
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>投保人地区：</th>
    							<td>
												<input type="text" name="applicantArea" class="areaSelect hidden {required: true, messages: {required: '请选择地区！'}, messagePosition: '#areaMessagePosition'}" />
												<span id="areaMessagePosition"></span>
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>投保人证件类型：</th>
    							<td>
												<select id="applicantTypeId" name="applicantIdentityType" class="formText {required: true, messages: {required: '请选择投保人证件类型！'}}" >
							...
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>投保人证件号码：</th>
    							<td>
												<input id="applicantId"   type="text" name="applicantIdentityId" style="width:200px;" onBlur="checkIdcard(this.id)" class="formText {required: true, messages: {required: '请填写投保人证件号码！'}}" />
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>投保人证件性别：</th>
    							<td>
  							...
  							<tr>
											...
											<td>
												...
												<input type="text" readonly="readonly" name="applicantBirthday" onfocus="setday(this)"  class="formText {required: true, messages: {required: '请填写投保人出生日期！'}} />
												<label class="requireField">*</label>
											</td>
										</tr>
							<tr>
    							<th align="right" valign="top">投保人手机号码：</th>
    							<td>
												<input type="text" name="applicantTel"   value="" class="formText {mobile: true, messages: {mobile: '手机号码格式错误！'}}" />
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top">投保人电子邮箱：</th>
    							<td>
												<input type="text" name="applicantMail"   value="" class="formText {required: true, email: true}" />
											</td>
  							</tr>
						</tbody>
						</table>
						...
						<tbody>
  							<tr>
    							<th width="300" align="right" valign="top"><span class="red">* </span>被保人姓名：</th>
    							<td width="554"><input type="text" name="recognizeeName"   value="" class="formText {required: true, messages: {required: '请填写被保人姓名！'}}" />
   							    </td>
  							</tr>
  							
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>被保人职业：</th>
    							<td>
											<select name="occupation1" id="s1">
											<option></option></select> 
											<select name="occupation2" id="s2">
											<option></option></select>
											<select name="occupation3" id="s3">
											<option></option></select>
											<SCRIPT language="javascript"> setup() </SCRIPT> 
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>被保人地区：</th>
    							<td>
												<input type="text" name="recognizeeArea" class="areaSelect hidden {required: true, messages: {required: '请选择地区！'}, messagePosition: '#areaMessagePosition'}" />
												<span id="areaMessagePosition"></span>
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>被保人证件类型：</th>
    							<td><select id="recognizeeTypeId" name="recognizeeIdentityType" class="formText {required: true, messages: {required: '请填写被保人证件类型！'}}" >
									              <option value="身份证" >身份证</option>
									              <option value="军官证" >军官证</option>
									              <option value="护照" >护照</option>
									            </select>	</td>
							...
							<tr>
    							<th align="right" valign="top"><span class="red">* </span>被保人证件号码：</th>
    							<td>
												<input id="recognizeeId" type="text" name="recognizeeIdentityId"   onBlur="checkIdcard(this.id)" class="formText {required: true, messages: {required: '请填写被保人证件号码！'}}" />
											</td>
  							</tr>
							<tr>
    							<th align="right" valign="top">被保人证件性别：</th>
    							<td>  <input type="radio" name="recognizeeSex" value="男"  checked>男
  							...
  							<tr>
											...
											<td>
												<input type="text" readonly="readonly" name="recognizeeBirthday" onfocus="setday(this)"  class="formText {required: true, messages: {required: '请填写被保人出生日期！'}} readonly/>
												<label class="requireField">*</label>
											</td>
										</tr>
							<tr>
    							<th align="right" valign="top">被保人手机号码：</th>
    							<td><input type="text" name="recognizeeTel" value=""   class="formText {mobile: true, messages: {mobile: '手机号码格式错误！'}}" /></td>
  							</tr>
							<tr>
    							<th align="right" valign="top">被保人电子邮箱：</th>
    							<td><input type="text" name="recognizeeMail" value=""   class="formText {required: true, email: true}" /></td>
  							</tr>
						</tbody>
						</table>
						<!--
						<div class="btnbuyarea"><a href="javascript:submitForm();" ><img src="${base}/template/shop/sz/images/btn04.gif" class="formButton" width="80" height="29" align="absmiddle" /></a>
						-->
						<div class="btnbuyarea">
						<input type="submit" class="formButton" value="提交" /></div>
                    </form>
                    </div>
                </div> 
			</div>
