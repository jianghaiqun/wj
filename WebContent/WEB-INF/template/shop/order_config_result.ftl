...
<div class="PayStatus_2" align="center">&nbsp;</div>
	...
	<div class="w900">
		...
		<input type="hidden" name="KID" id="orderSn" value="${KID}" >
		...
		<#if (canPreviewOperatorFlag != "0") >
			...
			<div class="button c" style="text-align: center;">
				<div class=btn-more>
				    ...
				    <input class="btn300" value="重新填写" type="button" onclick="location.href='${base}/shop/order_config!buyNowUpdate.action?orderId=${order.id}&productId=${productId}'"/>
				</div>
			</div>
		</#if>
		</form>
