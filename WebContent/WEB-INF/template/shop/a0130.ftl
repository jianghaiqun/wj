...
<table id="__01" width="600"  border="0"  align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td  colspan="10" style="padding-top:10px;height:80px;"><b style="font-size:14px;">${MemberRealName}</b> <br>
			<p style="color:#222222; font-size:12px;">您的账号<a href="${MemCenterUrl}" style="cursor: auto;font-size:12px; color:#222222;">${MemberEmail}</a>于${StandardDate} 消耗<b style="color:#fd8824;  font-size:12px;">${UsedIntegral}</b>积分。<a href="${QueryPointUrl}" style="color:#fd8824; text-decoration: underline;  font-size:12px;">点此查看</a>&nbsp;剩余积分。</p></td>
	</tr>
