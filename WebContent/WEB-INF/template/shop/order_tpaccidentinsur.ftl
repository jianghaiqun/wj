  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <p>
        <span>职业:</span>
             <select name="informationInsureds1.occupation1" id="s1" onblur="getChildrenOPT(this.value,'s2','s3');" style="width:125px;_width:180px;">
             	<option value="-1">--请选择--</option>
             	<#list opts as list>
             		<option value="${list.get('id')}" <#if (informationInsureds1.occupation1==list.get('id'))>selected="selected"</#if>>${list.get("name")}</option>	
        		</#list>
             </select> 
             <select name="informationInsureds1.occupation2" id="s2" onblur="getChildrenOPT(this.value,'s3');" style="width:125px;_width:200px;">
             		<option value="-1">--请选择--</option>
             	<#list opts2 as list>
