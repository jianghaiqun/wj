...
verify="电子邮箱|NOTNULL&EMAIL" />
		   ...
		   <#else>
				<label class="app_mobile" for="applicantMail">
		    		...
		    		<span class="span_t">*地区：</span>
		            <select name="sdinformationAppnt.applicantArea1" id="applicantArea1" onchange="getChildrenArea(this.value,'applicantArea2',-1,this);" style="width:125px;" verify="地区|OccuFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
...
<option value="-1">--请选择--</option>
		             ...
		             <select name="sdinformationAppnt.applicantArea3" id="applicantArea3" style="width:125px;"  verify="地区|AreaFormat" onblur="verifyElement('地区|AreaFormat',this.value,this.id)">
		             		<option value="-1">--请选择--</option>
		             </select>
		             <label class="requireField"></label>
