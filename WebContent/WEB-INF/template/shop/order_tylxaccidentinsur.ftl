  ...
  <div class="line_a">
     ...
     <div class="form">
       <p>
        ...
        <p>
        <span>航班号:</span> 
        <input type="text" id="flightNo" maxlength=200 name="informationInsureds1.flightNo" value="${(informationInsureds1.flightNo)!}" class="required"/>
        <label class="requireField">*</label>
    </p>
    	<p>
	        <span>起飞日期:</span> 
	        <input type="text" id="flightTime1" maxlength=200 name="informationInsureds1.flightTime" value="${(informationInsureds1.flightTime)!}" onclick="WdatePicker({skin:'whyGreen',minDate:'%y-%M-{%d}'});" class="required flyTime"/>
	        <label class="requireField">*</label>
	    </p>
	    <p>
	        <span>起飞时间:</span> 
	        <select name="hour"  id="hour" style="width:50px;" class="required">
			 ...
			 <select name="minute"  id="minute" style="width:50px;" class="required">
				<option value="00">00</option>
				<option value="01">01</option>
				<option value="02">02</option>
				<option value="03">03</option>
	    ...
	    <p>
           <span></span>
           <font color="#808080">提醒您！当日航班起飞时间应大于当前系统时间10分钟。</font>
       </p>
	    <p>
	        <span>起飞地点:</span> 
	        <input type="text" id="flightLocation" maxlength=200 name="informationInsureds1.flightLocation" value="${(informationInsureds1.flightLocation)!}" class="required"/>
	        <label class="requireField">*</label>
	    </p>
