...
<body>
<input type="hidden" id="products" name="products" value="<%=request.getParameter("products")%>" />
				...
				<table width="100%" border="0" height="100%" cellspacing="0" cellpadding="6" class="blockTable" style="table-layout: fixed;">
					<tr>
						<td style="padding-top: 0px; padding-left: 6px; padding-right: 6px; padding-bottom: 8px;">
							<z:datagrid id="dg3" method="com.sinosoft.cms.document.PromotionManage.dg1DataBindAllProduct"  autoFill="true" scroll="true" lazy="false" multiSelect="false">
