...
DataList.init = function(ele){
	...
	ele.getParam = function(name){return DataList.getParam(ele,name);}
	ele.setParam = function(name,value){return DataList.setParam(ele,name,value);}
	ele.loadData = function(func){DataList.loadData(ele,func);}
}
...
DataList.loadData = function(ele,func){
	ele = $(ele);
	var id  = ele.id;
	Server.sendRequest("com.sinosoft.framework.controls.DataListPage.doWork",ele.Params,function(response){
