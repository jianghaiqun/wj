...
Progress.getInfo = function(taskID){
	...
	Server.sendRequest("com.sinosoft.framework.messages.LongTimeTaskPage.getInfo",dc,function(response){
...
Progress.stop = function(taskID){
	var dc = new DataCollection();
	dc.add("TaskID",taskID);
	Server.sendRequest("com.sinosoft.framework.messages.LongTimeTaskPage.stop",dc,function(response){
		function isStopComplete(){
			Server.sendRequest("com.sinosoft.framework.messages.LongTimeTaskPage.stop",dc,function(response2){
