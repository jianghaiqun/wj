...
Tree.loadData = function(ele,func){
	...
	Server.sendRequest("com.sinosoft.framework.controls.TreePage.doWork",ele.Params,function(response){
...
Tree.lazyLoad = function(ele,func){
	...
	Server.sendRequest("com.sinosoft.framework.controls.TreePage.doWork",tree.Params,function(response){
