...
Console._debugWindowError=false;
...
Console.log = function(){
	if(!Console._DEBUGMODE)return false;
...
Console.switchDebugMode=function(status){
	if(status===undefined){
		Console._DEBUGMODE=!Console._DEBUGMODE;
	}else{
		Console._DEBUGMODE=status;
	}
	if(Console._DEBUGMODE){
...
if(window.console){
	...
	if(Console._DEBUGMODE&&Console._debugWindowError){
