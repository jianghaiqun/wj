...
DataGrid.getSelectedValueByColumns = function(ele, column) {
	...
	function sear() {
		...
		DataGrid.setParam("dg2", "realName", $V("realName"));
...
<table width="100%" border='0' cellpadding='10' cellspacing='0'>
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				发&nbsp;放&nbsp;人&nbsp;：&nbsp;&nbsp;<input id="provideUser2other" name="provideUser2other" value="" style="width:350px" readonly="readonly" disabled="disabled"></input>
				<input id="provideUser2" name="provideUser2" value="" style="width:350px" readonly="readonly" disabled="disabled" type="hidden"></input>
			</tr>
			<tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="6"
					...
					<tr>
						...
						<z:datagrid id="dg2" method="com.wangjin.activity.ActivityInfo.dg1DataBindProvideUser"  autoFill="true" scroll="true" lazy="false" multiSelect="true">
...
<script type="text/javascript">
		<%
			String provideUserother = request.getParameter("provideUserother");
			String provideUser = request.getParameter("provideUser");
		%>
		var provideuser='<%=provideUser%>';
		var provideArray=provideuser.split(",");
		for(var i=0;i<provideArray.length;i++){
			DataGrid.select($("dg2"),provideArray[i]);
		}
		jQuery("#provideUser2other").val('<%=provideUserother%>');
		jQuery("#provideUser2").val('<%=provideUser%>');
</script>
</html>