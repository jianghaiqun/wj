...
function checkUser(){
	...
	Server.sendRequest("com.sinosoft.member.Register.checkUser",dc,function(response){
	...
	if(checkUser()&&checkPassWord()&&checkConfirmPassword()&&checkEmail()&&checkVerifyCode()&&checkUserFlag){
		if($("Agree").checked==true){
			if($V("SiteID")!=""&&$V("SiteID")!="null"){
				...
				Server.sendRequest("com.sinosoft.member.Register.register",dc,function(response){
					if(response.Status!=1){
...
<z:init method="com.sinosoft.member.Register.init">
      ...
      <div class="forumbox"> <span class="fr">带 <span style=" font-family:'宋体'; color:#F60">*</span> 标示为必填项</span>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="forumTable">
          ...
          <tr>
            ...
            <td width="200"><span style=" font-family:'宋体'; color:#F60">*</span>
          ...
          <tr>
            ...
            <td><span style=" font-family:'宋体'; color:#F60">*</span>
              ...
              <img src="../AuthCode.jsp" alt="点击刷新验证码" name="yzm" height="20" align="middle" id="yzm" class="yanheng" style="cursor:pointer;" onClick="yzm.src='../AuthCode.jsp?'+new Date().getTime()" /></td>
        ...
        <div style="text-align:center;">　<a href="#;">点此阅读《服务条款》</a>　　　 <span style=" font-family:'宋体'; color:#F60">*</span>
          <input type="checkbox" name="Agree" id="Agree" checked="checked" />
          &nbsp;我已看过并同意《服务条款》<br />
          <br />
          <button type="button" onClick="doReg();" name="tiajiao" value="true" class="btn">提交</button>
          &nbsp;
          <button type="reset" name="reset" value="false" class="btn">重 置</button>
        </div>
      </div>
    </div>
  </form>
