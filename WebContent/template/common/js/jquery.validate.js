	...
	prototype: {
		...
		check: function( element ) {
			...
			for( method in rules ) {
				...
				try {
					if (jQuery.validator.methods[method] != null) {
...
function showErrors(){     
        ...
        for ( var i = 0; this.errorList[i]; i++ ) {      
            var error = this.errorList[i];      
            this.settings.highlight && this.settings.highlight.call( this, error.element, error.message,this.settings.errorClass, this.settings.validClass );      
...
//              +   '</div> ');      
                ...
                // 带图片的圆角div在所有浏览器兼容      
                errdiv = $('<div>'       
                        + '<img src="/wj/template/common/images/reg3.gif" mce_src="/wj/template/common/images/reg3.gif" mce_src="/wj/template/common/images/reg3.gif" mce_src="/wj/template/common/images/reg3.gif" mce_src="/wj/template/common/images/reg3.gif" width="6" height="24" align="absmiddle" class="fl" />'     
                ...
                .addClass(this.settings.errorClass);      
//              errdiv.css({left : jQuery.getLeft(error.element) + 'px',top : jQuery.getTop(error.element) + 'px'}); // 显示在控件的下面      
                errdiv.appendTo($('body'));      
            }      
            if(errimg.length == 0){ // 没有img则创建      
                errimg = $('<img alt="错误" src="/wj/template/common/images/reg3.gif" mce_src=/wj/template/common/images/reg3.gif">')      
