...
function statStaff(){
	...
	DataGrid.setParam("dg4","startDate",$V("startDate"));
	DataGrid.setParam("dg4","endDate",$V("endDate"));
	document.getElementById("allDate").value = '0';
	DataGrid.setParam("dg4","allDate","0");
	DataGrid.setParam("dg4",Constant.PageIndex,0);
	DataGrid.setParam("dg4","contant",$NV("contant"));
	DataGrid.loadData("dg4");
}
function statAll(){
	DataGrid.setParam("dg4","startDate","");
	DataGrid.setParam("dg4","endDate","");
	document.getElementById("allDate").value = '1';
	DataGrid.setParam("dg4","allDate","1");
	DataGrid.setParam("dg4",Constant.PageIndex,0);
	DataGrid.loadData("dg4");
}
...
function showMemberDetail(type){
    ...
    var arr = DataGrid.getSelectedValue("dg4");
	if(type&&type!=""){
		arr = new Array();
		arr[0] = type;
		arr[1] = startDate;
		...
		<table width="20" border="0" cellspacing="0" cellpadding="6"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg4" method="com.wangjin.infoseeker.KXBTotalInfo.dg4DataBind" lazy="true">
