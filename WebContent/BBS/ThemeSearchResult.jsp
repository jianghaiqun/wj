...
<div id="menu" class="forumbox"><span class="fl"><a id="forumlist" href="Index.jsp?SiteID=${SiteID}">${BBSName}</a> &raquo; 搜索 </span> <span class="fr"> ${Priv}</span></div>
<div id="foruminfo">
</div>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<z:datalist id="list1" method="com.sinosoft.bbs.ThemeSearch.dg1DataBind" page="true" size="12">
		<tr>
			<td>[原创]</td>
