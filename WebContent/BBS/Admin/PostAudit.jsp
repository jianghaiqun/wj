...
<script type="text/javascript">
	function exeAudit() {
		...
		if(ids!=""){
			dc.add("ids",ids);
			Server.sendRequest("com.sinosoft.bbs.admin.PostAudit.exeAudit",dc,function(response){
...
<body>
	...
	<div style="padding:5px;">
		<z:datalist id="list1" method="com.sinosoft.bbs.admin.PostAudit.getUnauditedPost" page="true" size="12">
		<div class="forumbox">
