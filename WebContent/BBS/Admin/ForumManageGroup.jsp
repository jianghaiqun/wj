...
function add(){
	...
	function addSave(){
		...
		Server.sendRequest("com.sinosoft.bbs.amdin.ForumUserGroup.addSystemGroup",dc,function(response){
	...
	function manageEditSave(){
		...
		dc1.addAll(dc2);
		Server.sendRequest("com.sinosoft.bbs.admin.ForumManageGroupOption.editSave",dc1,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					$D.close();
					DataList.loadData("list1");
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<z:datalist id="list1" method="com.sinosoft.bbs.admin.ForumManageGroup.getListManageGroup" page="false">
		<tr nowrap="nowrap">
