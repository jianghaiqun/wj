...
<script type="text/javascript">
	function exeAudit() {
		...
		if(ids!=""){
			dc.add("ids",ids);
			Server.sendRequest("com.sinosoft.bbs.admin.PostAudit.exeApplyDel",dc,function(response){
...
<body>
	...
	<tr><td>
	<z:init method="com.sinosoft.bbs.admin.PostAudit.init">
		请选择：
	...
	<div style="padding:5px;">
		<z:datalist id="list1" method="com.sinosoft.bbs.admin.PostAudit.getApplyDelPost" page="true" size="12">
		<div class="forumbox">
