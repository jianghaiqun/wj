...
function eidtColor(){
		...
		Server.sendRequest("com.sinosoft.bbs.admin.ForumUserGroup.editSystemGroup",dc,function(response){
			Dialog.alert(response.Message);
			if(response.Status==1){
				DataList.loadData('list1');
			}
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<z:datalist id="list1" method="com.sinosoft.bbs.admin.ForumUserGroup.getListSystemGroup" page="false">
		<tr nowrap="nowrap">
