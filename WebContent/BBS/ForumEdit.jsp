...
<script type="text/javascript">
	...
	function searchForum() {
		...
		Server.sendRequest("com.sinosoft.bbs.MasterPanel.changeForum",dc,function(response){
	...
	function editInfoSave() {
		...
		Server.sendRequest("com.sinosoft.bbs.MasterPanel.editForumSave",dc,function(response){
...
<input type="hidden" id="SiteID" value="${SiteID}">
  <tr valign="top">
    ...
    <td width="20">&nbsp;</td>
    <td><z:init method="com.sinosoft.bbs.MasterPanel.forumEditInit">
