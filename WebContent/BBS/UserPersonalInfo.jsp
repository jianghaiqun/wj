...
<z:init method="com.sinosoft.bbs.UserPersonalInfo.init">
<div class="wrap">
		<div id="menu" class="forumbox"> <span class="fl"> <b> <a id="viewpro">查看用户${UserName}个人信息 </a> </b></span> <span class="fr">${Priv}</span> </div><div id="nav"><a href="Index.jsp?SiteID=${SiteID}">${BBSName}</a>  &raquo; 查看用户个人信息</div>
		<br>
