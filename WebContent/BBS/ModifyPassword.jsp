...
<script type="text/javascript">
	function PassWordSave() {
		...
		Server.sendRequest("com.sinosoft.bbs.ControlPanel.modifyPassword",dc,function(response){
...
<z:init method="com.sinosoft.bbs.ControlPanel.init">
        ...
        <div id="nav"><a href="Index.jsp?SiteID=${SiteID}">${BBSName}</a>  &raquo; 控制面板</div>
		<br>
