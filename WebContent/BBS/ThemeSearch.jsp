...
function doSearch(){
	...
	$("form1").action = "ThemeSearchResult.jsp?SiteID="+$V("SiteID");
	$("form1").submit();
}
...
<z:init method="com.sinosoft.bbs.ThemeSearch.init">
<div class="wrap">
	<input id="SiteID"  type="hidden" value="${SiteID}">
${redirect}
<div id="menu" class="forumbox"><span class="fl"><a href="Index.jsp?SiteID=${SiteID}">${BBSName}</a> &raquo; 搜索 </span> <span class="fr">${Priv}</span></div>
...
<form method="post" id="form1" action="ThemeSearchResult.jsp">
