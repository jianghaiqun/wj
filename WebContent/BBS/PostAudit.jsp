...
<script type="text/javascript">
	function exeAudit() {
		...
		Server.sendRequest("com.sinosoft.bbs.PostAudit.exeAudit",dc,function(response){
...
<input type="hidden" id="SiteID" value="${SiteID}">
  <tr valign="top">
    ...
    <td width="20">&nbsp;</td>
    <td>		<td><z:init method="com.sinosoft.bbs.MasterPanel.searchUserInit">
			...
			<table id="table1" width="100%" border="0" cellspacing="0"
				...
				<tr>
					<td><z:init method="com.sinosoft.bbs.PostAudit.init">
		请选择：
		<z:select id="TypeOptions" style="width:100px;"
				...
				<tr>
					...
					<div style="padding:5px;"><z:datalist id="list1"
						method="com.sinosoft.bbs.PostAudit.getUnauditedPost" page="true"
						size="12">
						<div class="forumbox">
