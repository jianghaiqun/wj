...
<table width="100%" border='0' cellpadding='10' cellspacing='0'>
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				保险公司：&nbsp;&nbsp;<input id="insuranceCompany2other" name="insuranceCompany2other" value="" style="width:350px" readonly="readonly" disabled="disabled"></input>
				<input id="insuranceCompany2" name="insuranceCompany2" value="" style="width:350px" readonly="readonly" disabled="disabled" type="hidden"></input>
			</tr>
			<tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="6"
					...
					<tr>
						...
						<z:datagrid id="dg2" method="com.wangjin.coupon.CouponInfo.dg1DataBindInsuranceCompany"  autoFill="true" scroll="true" lazy="false" multiSelect="true">
...
<script type="text/javascript">
		<%
			String insuranceCompanyother = request.getParameter("insuranceCompanyother");
			String insuranceCompany = request.getParameter("insuranceCompany");
		%>
		var insuranceCompany='<%=insuranceCompany%>';
		var insuranceCompanyArray=insuranceCompany.split(",");
		for(var i=0;i<insuranceCompanyArray.length;i++){
			DataGrid.select($("dg2"),insuranceCompanyArray[i]);
		}
		jQuery("#insuranceCompany2other").val('<%=insuranceCompanyother%>');
		jQuery("#insuranceCompany2").val('<%=insuranceCompany%>');
</script>
</html>