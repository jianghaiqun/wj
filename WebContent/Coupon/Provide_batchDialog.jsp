...
<script type="text/javascript">
	...
	function afterUpload(fileUrl){
		    ...
		    Server.sendRequest("com.wangjin.coupon.CouponInfo.asyncUploadExcel",dc,function(response){
				var taskID = response.get("TaskID");
				var p = new Progress(taskID, "正在导入优惠券批量发放信息...");
				p.show();
		    });
...
<div id=mid>
<form  action="ProvideBatchUploadSave.jsp" method="post" name="fm" enctype="multipart/form-data" target="targetFrame"> <br>
	<input name="upload" id="upload" type="file" value='' size='20' >
	<input onClick="getFileUrl();" type='button' value='上传' name="Import" id="Import">
	<a href="../DataService/ADTemplate/CouponProvide.xls">优惠券批量发放信息导入模板下载</a>
</form>
