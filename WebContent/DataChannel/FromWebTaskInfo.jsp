	...
	if(parent.Parent.EditFlag){
		...
		for(k in map){
			...
			if(!k.startWith("FilterBlock")&&!k.startWith("RefCode")&&!k.startWith("Script")&&!k.startWith("Template")&&k!="Type"&&k!="Status"){
				...
				if(k=="CatalogID"&&v){
					Server.getOneValue("com.sinosoft.datachannel.FromWeb.getCatalogName",v,function(dc){
...
<table width="820" align="center" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			...
			<tr>
			  <td height="24" align="right">任务状态：</td>
			...
			<tr>
				<td height="24" align="right">内容页最大采集数：</td>
			...
			<tr>
			  <td height="24" align="right">列表页最大采集数：</td>
