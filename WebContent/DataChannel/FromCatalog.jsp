...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.datachannel.FromCatalog.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确定要删除该任务吗？",function(){
		Server.sendRequest("com.sinosoft.datachannel.FromCatalog.del",dc,function(response){
...
function execute(restartFlag){
	...
	Dialog.confirm("确定要执行该任务吗？",function(){
		...
		Server.sendRequest("com.sinosoft.datachannel.FromCatalog.execute",dc,function(response){
			if(response.Status==1){
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
			...
			<tr>
				...
				<z:datagrid id="dg1" method="com.sinosoft.datachannel.FromCatalog.dg1DataBind" page="false">
