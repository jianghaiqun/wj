...
function changeMethod(){
  ...
  if(deployMethod=="FTP"||deployMethod=="SFTP"){
   $E.show("trHost");
	 $E.show("trPort");
	 $E.show("trUserName");
	 $E.show("trPassword");
...
<label for="httpMethod">HTTP</label--> 
		<input type="radio" name="Method" value="FTP" id="ftpMethod" onclick="changeMethod()"> <label for="ftpMethod">FTP</label>
		<input type="radio" name="Method" value="SFTP" id="sftpMethod" onclick="changeMethod()"> <label for="sftpMethod">SFTP</label></td>
	</tr>
	<tr>
