...
function del(){
	...
	Dialog.confirm("确定要删除该日志项吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.sinosoft.cms.datachannel.DeployLog.del",dc,function(response){
...
function delAll(){
	...
	Dialog.confirm("确定要清除日志吗？",function(){
		var dc = new DataCollection();	
		Server.sendRequest("com.sinosoft.cms.datachannel.DeployLog.delAll",dc,function(response){
			if(response.Status==0){
				Dialog.alert(response.Message);
			}else{
				Dialog.alert("删除成功");
...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
	...
	<tr>
		<td>
		<z:datagrid id="dg1" method="com.sinosoft.cms.datachannel.DeployLog.dg1DataBind" size="14">
