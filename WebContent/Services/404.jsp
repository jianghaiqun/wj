...
<%
	...
	String ext = com.sinosoft.framework.utility.ServletUtil.getUrlExtension(uri);
	if (!uri.endsWith("/")&&!"jsp".equalsIgnoreCase(ext) && !"shtml".equalsIgnoreCase(ext) && !"html".equalsIgnoreCase(ext)
