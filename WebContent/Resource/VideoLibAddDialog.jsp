...
<table width="100%" cellpadding="2" cellspacing="0">
	<tr>
		<td width="601" height="10"></td>
		<td></td>
	</tr>
	<tr>
		<td align="right">父节点：</td>
		<td width="606"><z:select id="ParentID" listWidth="200"
			listHeight="300" listURL="Resource/VideoLibSelectList.jsp"></z:select>
		</td>
	</tr>
	<tr>
		<td align="right">视频分类名称：</td>
		<td><input name="Name" type="text" class="input1" id="Name"
			value="" verify="视频分类名称|NotNull" /></td>
	</tr>
    <tr>
