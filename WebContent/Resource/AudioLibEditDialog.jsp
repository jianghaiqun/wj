...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.sinosoft.cms.resource.AudioLib.getPicSrc",dc,function(response){
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<z:init method="com.sinosoft.cms.resource.AudioLib.initDialog">
	<form id="form2">
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td colspan="2"><input name="Name" type="text" class="input1"
				id="Name" value="${Name}" verify="音频分类名称|NotNull" /></td>
		</tr>
		<tr>
