...
function del(){
	var arr = DataGrid.getSelectedValue("dg1");
	Dialog.confirm("这些附件可能与文章有关联，你确认要删除吗？",function(){
		var dc = new DataCollection();
		dc.add("IDs",arr.join());
		Server.sendRequest("com.sinosoft.cms.resource.AttachmentLib.del",dc,function(response){
		...
		<table width="100%" cellpadding="2" cellspacing="0" id="tbSearch">
			<tr>
				...
				<td width="19%"><input name="Info" id="Info" type="text"
					value=""></td>
				<td width="7%"><input type="button" name="Submit" value="查询"
					onClick="doSearch()"></td>
				<td width="7%"><input type="button"  value="删除"
					onClick="del()"  ></td>
			</tr>
		</table>
		</td>
