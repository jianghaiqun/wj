...
function onFlashReturnBack(){
	var arr = DataGrid.getSelectedValue("dg1");
	if(!arr||arr.length==0){
		Dialog.alert("请先选择要返回的Flash！");
		return;
	}
	window.parent.Parent.onFlashUploadCompleted(arr.join());
...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td style="padding:0px 5px;"><z:datagrid id="dg1"
			method="com.sinosoft.cms.resource.AttachmentLib.dg1DataBindFlashBrowse"
			size="10">
			<table class="dataTable" cellspacing="0" cellpadding="2" width="100%">
				<tr ztype="head" class="dataTableHead">
					...
					<td width="20%"><b>Flash名称</b></td>
					<td width="30%"><b>Flash描述</b></td>
					<td width="7%"><b>Flash大小</b></td>
					<td width="8%"><b>Flash格式</b></td>
