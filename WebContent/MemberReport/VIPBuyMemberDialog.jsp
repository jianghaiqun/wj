...
<z:init method="com.sinosoft.cms.memberreport.VIPBuyReport.initDialog">
<script>
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.VIPBuyReport.dg1DataBind_Mdialog" size="20" lazy="true">
