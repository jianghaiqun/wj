...
function showOrderDetail(channelsn, productType){
	...
	diag.Width = 1300;
	diag.Height = 580;
	diag.Title = "回购 订单列表查看";
	
	diag.URL = "MemberReport/BackOrderDialog.jsp?channelsn="+channelsn+"&productType="+productType+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
...
function showRiskTypeDetail(channelsn, productType){
	...
	diag.Height = 580;
	diag.Title = "回购保单信息列表";
	diag.URL = "MemberReport/BackRiskTypeDialog.jsp?channelsn="+channelsn+"&productType="+productType+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
...
<body>
	<table width="100%" border="0" cellspacing="6" cellpadding="0"
		...
		<tr valign="top">
			...
			<tr>
				<td>
				<z:init method="com.sinosoft.cms.memberreport.BackProductTypeReport.init">
				<table>
					<tr>	
							<td>统计时间：</td>
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.BackProductTypeReport.dg1DataBind" lazy="true">
