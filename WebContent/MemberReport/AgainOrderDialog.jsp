...
<z:init method="com.sinosoft.cms.memberreport.AgainProductTypeReport.initDialog">
<script>
...
function doSearch(){
	...
	DataGrid.setParam("dg1", "productType", '${productType}');
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.AgainProductTypeReport.dg1DataBind_Odialog" size="20" lazy="true">
						<table width="100%" style="" cellpadding="2" cellspacing="0" class="dataTable" >
							...
							<tr  style="background-color:#F9FBFC">
								...
								<td style="text-align:center;" title="${receiveDate}">${receiveDate}</td>
