...
function showMemberDetail(type){
	...
	diag.URL = "MemberReport/BuyAgainMemberDialog.jsp?type="+type+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
...
function showOrderDetail(type){
	...
	diag.URL = "MemberReport/BuyAgainOrderDialog.jsp?type="+type+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
...
function showRiskTypeDetail(type){
	...
	diag.URL = "MemberReport/BuyAgainRiskTypeDialog.jsp?type="+type+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
...
function showSourceDetail(type){
	...
	diag.URL = "MemberReport/BuyAgainSourceDialog.jsp?type="+type+"&startDate="+startDate+"&endDate="+endDate+"&contant="+contant;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
	...
	<table width="100%" border="0" cellspacing="6" cellpadding="0"
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				class="blockTable">
				<tr>
					<td valign="middle" class="blockTd"><img src="../Icons/icon018a6.gif" />会员复购统计</td>
				</tr>
			<tr>
				<td>
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.BuyAgainReport.dg1DataBind" lazy="true">
