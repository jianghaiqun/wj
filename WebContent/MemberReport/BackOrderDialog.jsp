...
<z:init method="com.sinosoft.cms.memberreport.BackProductTypeReport.initDialog">
<script>
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.BackProductTypeReport.dg1DataBind_Odialog" size="20" lazy="true">
