...
function showMemberDetail(productid){
	...
	diag.Height = 550; 
	diag.Title = "回购信息列表查看";
	diag.URL = "MemberReport/BackTop20MemberDialog.jsp?&startDate="+startDate+"&endDate="+endDate+"&contant="+contant+"&productid="+productid;
...
function showOrderDetail(productid){
	...
	diag.Height = 550;
	diag.Title = "回购信息列表查看";
	diag.URL = "MemberReport/BackTop20OrderDialog.jsp?startDate="+startDate+"&endDate="+endDate+"&contant="+contant+"&productid="+productid;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
...
function showRiskTypeDetail(productid){
	...
	diag.Height = 550;
	diag.Title = "回购信息列表查看";
	diag.URL = "MemberReport/BackTop20RiskTypeDialog.jsp?startDate="+startDate+"&endDate="+endDate+"&contant="+contant+"&productid="+productid;
	diag.onLoad = function() {
		$DW.init();
	};
	diag.ShowMessageRow = true;
	...
	<table width="100%" border="0" cellspacing="6" cellpadding="0"
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				class="blockTable">
				<tr>
					<td valign="middle" class="blockTd"><img src="../Icons/icon018a6.gif" />会员回购Top20</td>
				</tr>
			<tr>
				<td>
				<z:init method="com.sinosoft.cms.memberreport.BackTop20Report.init">
				<table>
					<tr>	
							<td>统计时间：</td>
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.BackTop20Report.dg1DataBind" lazy="true">
