...
<z:init method="com.sinosoft.cms.memberreport.BackTop20Report.initDialog">
<script>
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.BackTop20Report.dg1DataBind_Odialog" size="20" lazy="true">
