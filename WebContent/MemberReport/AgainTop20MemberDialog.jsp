		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.memberreport.AgainTop20Report.dg1DataBind_Mdialog" size="20" lazy="true">
						<table width="100%" style="" cellpadding="2" cellspacing="0" class="dataTable" >
							<tr ztype="head" class="dataTableHead">
								<td width="4%" ztype="RowNo"><strong>序号</strong></td>
								<td width="18%" style="text-align:center;"><b>会员手机号/邮箱</b></td>
