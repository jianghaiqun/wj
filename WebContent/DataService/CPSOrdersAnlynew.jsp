...
function doSearch(){  
	...
	if(s.indexOf('b2b') != -1){
		Server.sendRequest("com.wangjin.cms.orders.CPSQueryOrders.ordersAnlySumNew",dc,function(data){
...
function getAll() {
	...
	var dr = drs[0];
	if (drs[0] != "" && drs[0] != null) {
		document.getElementById("sumincome").innerHTML =dr.get("ssumincome");
		document.getElementById("sumextractaccount").innerHTML =dr.get("ssumextractaccount");
		document.getElementById("sumtotalcost").innerHTML =dr.get("ssumtotalcost");
		document.getElementById("sumprofit").innerHTML =dr.get("ssumprofit");
		document.getElementById("sumproductprice").innerHTML =dr.get("ssumproductprice");
		document.getElementById("sumoldprice").innerHTML =dr.get("ssumoldprice");
		document.getElementById("sumnowprice").innerHTML =dr.get("ssumnowprice");
	} 
}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3" class="blockTable">
				...
				<input type="hidden" id="mediamanager" name="mediamanager" value="${mediamanager}"/>
					 <table  cellspacing="0" cellpadding="3" width="60%">
						...
						<tr>
							<td>媒介经理：</td>
							<td> <input name="IntermediaryMember" type="text" id="IntermediaryMember" value="${sumincome1}" style="width:100px" />
		                	<td>统计时间 从：</td>
		                	<td> <input name="startDate" type="text" id="startDate" value="${yesterday}" style="width:100px" ztype="date"></td>
							<td>至：</td>
							<td><input name="endDate" type="text" id="endDate" value="${yesterday}"style="width:100px" ztype="date">
							</td>
							<td colspan="8" nowrap>
				...
				<td style="padding: 0px;">
				 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="blockTable" style="table-layout: fixed;" >
				  <tr>
					...
					<z:datagrid id="dg1" method="com.wangjin.cms.orders.CPSQueryOrders.ordersAnlyNew" size="20" scroll="true">
