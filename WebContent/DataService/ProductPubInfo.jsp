...
function doSearch(){
	...
	DataGrid.setParam("dg1","hasInfo",$V("hasInfo"));
	DataGrid.loadData("dg1");
}

function setPubInfo(productID,productName){
	...
	diag.Height = 300;
	diag.Title = "设置公告";
	var url = "DataService/PubInfoSetDialog.jsp?productID="+arr[0]+"&productName="+productName;
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.PublicInform.dg1DataBind" size="20" scroll="true">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr onDblClick="setPubInfo('${ProductID}','${ProductName}');" style="background-color:#F9FBFC">
								<td width="3%">&nbsp;</td>
								<td >&nbsp;</td>
								<td >${ProductID}</td>
								<td >${ProductName}</td>
								<td >${HasInfo}</td>
								<td ><a style="cursor: hand;" onClick="setPubInfo('${ProductID}','${ProductName}');">设置公告</a></td>
							</tr>
							<tr ztype="pagebar">
