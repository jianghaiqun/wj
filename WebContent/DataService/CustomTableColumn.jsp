	...
	if(lengths){
		for(var i=0;i<lengths.length;i++){
			if(!isInt(lengths[i])&&(types[i]==1||types[i]==10)){
				Dialog.alert("长度必须是整数,"+lengths[i]+"不是正确的整数");
				return false;
			}
		}
	}
...
<z:init method="com.sinosoft.cms.dataservice.CustomTable.initColumn">
<z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.CustomTable.columnDataBind" page="false">
