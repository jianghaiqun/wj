...
function onUploadCompleted(returnValue,errorMessage,FilePath){
	switch ( returnValue )
	{
		...
		case 1 :	// 
			...
			Server.sendRequest("com.sinosoft.cms.dataservice.InitiateRefundManage.improtTBCouponInfo",dc,function(response){
				//$("divMsg").hide();
...
<table width="100%" align="center" cellpadding="2" cellspacing="0">
	<tr>
			...
			<table id="Videotable0" width="100%" cellpadding="2"
				...
				<tr>
					<td colspan='2' align="center" ><a href="../template/modelRate/couponimport.xls" target="_blank">模版下载<a></td>
				</tr>
			</table>
			</fieldset>
			</td>
