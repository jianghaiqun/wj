...
function viewVIPLog() {
	...
	diag.Height = 400;
	diag.Title = "会员VIP记录";
	diag.URL = "DataService/MemberVIPLogDialog.jsp?memberId="+arr[0];
	diag.ShowMessageRow = true;
	diag.MessageTitle = "会员VIP记录";
	diag.show(); 
	diag.OKButton.hide();
}
		...
		<tr valign="top">
			...
			<tr>
				...
				<tr>
                    ...
                    <z:tbutton onClick="viewVIPLog()"><img src="../Icons/icon021a4.gif" />查看VIP记录</z:tbutton> 
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.Member.dg2DataBind" size="20" lazy="true">
						<table width="100%" style="" cellpadding="2" cellspacing="0" class="dataTable">
							<tr ztype="head" class="dataTableHead">
								...
								<td width="170"><b>M(累计金额)(含部分撤单保费)</b></td>
								...
								<td width="100"><b>累计实际支付金额</b></td>
								<td width="100"><b>累计实际购买次数</b></td>
