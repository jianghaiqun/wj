...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.cms.dataservice.Vote.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确定要删除该调查吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.sinosoft.cms.dataservice.Vote.del",dc,function(response){
				Dialog.alert(response.Message,function(){
					if(response.Status==1){
...
function handStop(){
	...
	Dialog.confirm("确定要终止该投票吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.sinosoft.cms.dataservice.Vote.handStop",dc,function(response){
				Dialog.alert(response.Message,function(){
					if(response.Status==1){
						DataGrid.loadData("dg1");
					}
...
function editSave(){
    ...
    dc.add("Prop4", $DW.$NV("Prop4")); 
	Server.sendRequest("com.sinosoft.cms.dataservice.Vote.edit",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				$D.close();
				if(currentTreeItem){
		...
		<tr valign="top">
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><z:tree id="tree1"
					...
					method="com.sinosoft.cms.dataservice.Vote.treeDataBind" level="2"
					lazy="true">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				<tr>
					<td valign="middle" class="blockTd"><img
						src="../Icons/icon032a1.gif" />调查投票列表<input type="hidden" id="RelaCatalogID" name="RelaCatalogID" value="0"/></td>
				</tr>
				<tr>
					...
					<z:tbutton onClick="preview()"><img src="../Icons/icon032a15.gif" />预览</z:tbutton>
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.Vote.dg1DataBind" size="15">
						<table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
							<tr ztype="head" class="dataTableHead">
								...
								<td width="9%"><b>投票人数</b></td>
								<td width="7%"><b>限制IP</b></td>
