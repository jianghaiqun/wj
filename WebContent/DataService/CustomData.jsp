...
function save(){
	...
	Server.sendRequest("com.sinosoft.cms.dataservice.CustomTable.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.sinosoft.cms.dataservice.CustomTable.del",dc,function(response){
				Dialog.alert(response.Message,function(){
					DataGrid.loadData('dg1');
				});
			});
...
function saveForm(){
	...
	Server.sendRequest("com.sinosoft.cms.dataservice.Form.save",dc,function(response){
...
function reInit(){
	var dc = new DataCollection();
	dc.add("ID",$DW.$V("ID"));
	Server.sendRequest("com.sinosoft.cms.dataservice.Form.reInit",dc,function(response){
	...
	<table width="100%" border="0" cellspacing="6" cellpadding="0" style="border-collapse: separate; border-spacing: 6px;">
      <tr valign="top">
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            ...
            <tr>
              <td style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:0px;"><z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.CustomTable.dg1DataBind" page="false">
