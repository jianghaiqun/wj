...
function insure(productID){
	...
	diag.Height = 450;
	diag.Title = "信息导入";
	var url = "DataService/OrderAutoInsureUpLoad.jsp?productID="+arr[0];
	diag.URL = encodeURI(url);
	diag.ShowMessageRow = true;
	diag.MessageTitle = "信息导入页面 ";
	diag.show();
	diag.OKButton.hide();
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.OrderAutoInsure.dg1DataBind" size="20" scroll="true">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr onDblClick="insure('${ProductID}');" style="background-color:#F9FBFC">
								<td width="3%">&nbsp;</td>
								<td >&nbsp;</td>
								<td >${SupplierName}</td>
								<td >${ProductName}</td>
								<td >${ProductID}</td>
								<td ><a style="cursor: hand;" onClick="insure('${ProductID}');">投保</a></td>
							</tr>
							<tr ztype="pagebar">
