...
<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <z:tree id="tree1" style="height:410px" method="com.sinosoft.cms.dataservice.OuterDocument.bbstreeDataBind">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.OuterDocument.bbsDataBind" size="12">
