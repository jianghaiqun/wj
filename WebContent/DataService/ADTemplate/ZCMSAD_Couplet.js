...
function showADContent() {
  ...
  if (this.ADType == "image") {
	  for(var i=0;i<AD.Count;i++){
		  ...
		  y = this.PaddingTop;
		  str += "<div id='ZCMSAD_"+this.PosID+"_"+i+"' style='left:"+x+"px;top:"+y+"px;width:"+this.Width+"px; height:"+this.Height+"px; position: absolute;z-index:888888;'>";
		  str += "<a href='"+AD.Images[i].imgADLinkUrl+"' onClick='adClick(\""+this.ADID+"\",\""+AD.Images[i].imgADLinkUrl+"\")' target='"+((AD.imgADLinkTarget == "Old") ? "_self" : "_blank") + "'>";
	  	  ...
	  	  str += "</a>";
		  str += "<div style='text-align:"+align+"'><a href='#;' onclick='javascript:document.getElementById(\"ZCMSAD_"+this.PosID+"_"+i+"\").style.display=\"none\"'>关闭</a></div>";
		  str += "</div>";
  		  document.write(str);
