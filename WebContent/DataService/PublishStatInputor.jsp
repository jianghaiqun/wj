...
<z:init method="com.sinosoft.cms.dataservice.PublishStaff.initInputor">
<html>
<head>
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg11" method="com.sinosoft.cms.dataservice.PublishStaff.dg11DataBind" page="false">
						<table width="100%" cellpadding="2" cellspacing="0"
							class="dataTable">
							<tr ztype="head" class="dataTableHead">
								<td width="5%" ztype="RowNo"><b>序号</b></td>
								<td width="7%">栏目ID</td>
								<td width="25%"  ztype="tree" level="treelevel" >栏目名称</td>
