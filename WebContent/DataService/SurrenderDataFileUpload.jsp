...
<%@page import="com.sinosoft.cms.dataservice.SurrenderDataUpLoad"%>
	...
	while (iter.hasNext()) {
		...
		if (!item.isFormField()) {
			...
			if (!fileName.toLowerCase().endsWith(".xls")) {
				...
				SurrenderDataUpLoad tActiviCodeUpLoad = new SurrenderDataUpLoad();
				try {
					FlagStr = tActiviCodeUpLoad.upLoadSave(uploadPath, request.getRemoteHost());
			...
			out.println("<script>Dialog.closeEx();Dialog.alert('"
					+ Content + "');parent.DataGrid.loadData('dg1');</script>");
		}
	}
%>