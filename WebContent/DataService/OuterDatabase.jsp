...
function connTest(){
	...
	Server.sendRequest("com.sinosoft.cms.dataservice.OuterDatabase.connTest",dc,function(rdc){
		Dialog.closeEx();
...
function Save(){
	...
	var dc = $DW.Form.getData("F1");
	Server.sendRequest("com.sinosoft.cms.dataservice.OuterDatabase.save",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.sinosoft.cms.dataservice.OuterDatabase.del",dc,function(response){
				Dialog.alert(response.Message,function(){
					DataGrid.loadData('dg1');
				});
			});
...
<table width="100%" border="0" cellpadding="6" cellspacing="0">
    ...
    <tr>
      <td>
        <z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.OuterDatabase.dg1DataBind" page="false">
