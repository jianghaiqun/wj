...
function edit(id,rid,orderSn,recognizeeSn){
	...
	diag.Height = 500;
	diag.Title = "订单信息修改";
	diag.URL = "DataService/PolicyNoOfOrderEditDialog.jsp?id="+id+"&rid="+rid+"&orderSn="+orderSn+"&recognizeeSn="+recognizeeSn;
				...
				<z:init method="com.wangjin.cms.orders.QueryOrders.init">
					 <table  cellspacing="0" cellpadding="3">
						...
						<tr>
							...
							<td>手机号：</td>
							<td> <input name="shipMobile" type="text" id="shipMobile" value="" style="width:100px"></td>
							<td>投保人证件号：</td>
							<td> <input name="applicantId" type="text" id="applicantId" value="" style="width:100px" /></td>
						 <td>被保人姓名：</td>
					...
					<z:datagrid id="dg1" method="com.wangjin.cms.orders.QueryOrders.orderInquery" size="20" scroll="true" lazy="true">
						<table width="100%" cellpadding="2" cellspacing="0"
							...
							<tr ztype="head" class="dataTableHead">
								...
								<td width="120" style="text-align:center;"><b>创建时间</b></td>
								<td width="120" style="text-align:center;"><b>修改时间</b></td>
							</tr>
							<tr  onDblClick="edit('${id}','${rid}','${OrderSn}','${recognizeeSn}')" style="background-color:#F9FBFC">
								<td width="3%">&nbsp;</td>
								<td style="text-align:center;">&nbsp;</td>
								<td><a  style="cursor: hand;" onClick="showOrderDetail('${orderSn}')">${orderSn}</a></td>
								<td >${tbTradeSeriNo}</td>
								<td >${policyNo}</td>
								<td >${ProductName}</td>
								<td >${planName}</td>
