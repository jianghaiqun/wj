...
<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        <tr>
          <td valign="middle" class="blockTd"><img src="../Icons/icon018a1.gif" />频道列表</td>
        </tr>
        <tr>
          <td style="padding:6px;"> 	
		  <z:tree id="tree1" style="height:410px" method="com.sinosoft.cms.dataservice.OuterDocument.cmsTreeDataBind">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        <tr>
          <td colspan="2" valign="middle" class="blockTd"><img src="../Icons/icon018a1.gif" />文章列表</td>
        </tr>
        <tr>
        ...
        <tr>
		  ...
		  <z:datagrid id="dg1" method="com.sinosoft.cms.dataservice.OuterDocument.cmsDataBind" size="12">
              <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
                ...
                <tr style1="background-color:#FFFFFF" style2="background-color:#F9FBFC" >
                  <td >&nbsp;</td>
                  <td>&nbsp;</td>
                  <td title="作者：${author} 发表时间：${addtime}"><a href='${link}' target="_blank">${title}</a></td>
