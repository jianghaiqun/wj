...
function del(){
	...
	Dialog.confirm("确定要删除选中的会员吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.sinosoft.cms.dataservice.ApplyAdmin.del",dc,function(){
...
<body>
<z:init method="com.sinosoft.cms.dataservice.ApplyAdmin.initSearch">
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.dataservice.ApplyAdmin.dg1DataBind" size="15">
