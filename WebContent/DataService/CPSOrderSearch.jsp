...
function statStaff(){
	...
	Server.sendRequest("com.wangjin.cms.orders.CPSQueryOrders.orderCount",
			dc, function() {
				...
				<td style="padding: 0px 5px;">
				 <table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable" style="table-layout: fixed;" >
				  <tr>
					...
					<z:datagrid id="dg1" method="com.wangjin.cms.orders.CPSQueryOrders.orderInquery" size="20" scroll="true" lazy="true">
