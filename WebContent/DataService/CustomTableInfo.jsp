...
<body>
<z:init method="com.sinosoft.cms.dataservice.CustomTable.init">
<form id="F1">
...
<table width="500" align="center" cellpadding="2" cellspacing="0" style="display:none" id="TableLink">
    <tr>
      ...
      <td width="77%">
	  <z:select id="DatabaseID" method="com.sinosoft.cms.dataservice.OuterDatabase.getDatabases" onChange="loadTables();" style="width:225px" verify="NotNull"  condition="$NV('Type')=='Link'" defaultblank="true"></z:select>
	  <z:tbutton onClick="conn()"><img src="../Icons/icon006a10.gif" width="20" height="20" />新建外部连接</z:tbutton>
	  </td>
    </tr>
    <tr>
