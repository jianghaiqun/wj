...
function Save(){
	...
	Server.sendRequest("com.sinosoft.platform.CustomColumn.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除吗？",function(){
		var dc = new DataCollection();
			dc.add("IDs",arr.join());
			Server.sendRequest("com.sinosoft.platform.CustomColumn.del",dc,function(response){
				if(response.Status==1){
...
<z:datagrid id="dg1" method="com.sinosoft.platform.CustomColumn.dg1DataBind" size="15">
