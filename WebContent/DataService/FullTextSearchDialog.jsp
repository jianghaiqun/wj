  ...
  <table width="100%" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="2" align="left" >	  	
        ...
        &nbsp;&nbsp;
        <input type="radio" name="Type" id="TypeRadio" value="Audio" onClick="onTypeChange()">
    ...
    <tr>
      ...
      <td width="60%">
	  <z:tree id="tree1" style="height:320px;width:300px" method="com.sinosoft.cms.dataservice.FullText.treeDataBind" level="2" lazy="true" expand="true">
