...
<dl>
	<z:simplelist method="com.sinosoft.cms.dataservice.Vote.getVoteSubjects">
		<dt id="${ID}">${_RowNo}.${Subject}</dt>
		<z:simplelist method="com.sinosoft.cms.dataservice.Vote.getVoteItems">
			<dd>
				${html}
			</dd>
		</z:simplelist>
...
<dl>
<%
if ("N".equals(vote.getProp4())) {// 是否现实查看按钮
%>
