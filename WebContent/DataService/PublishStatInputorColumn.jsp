...
<z:init method="com.sinosoft.cms.dataservice.PublishStaff.initInputorColumn">
<html>
<head>
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg12" method="com.sinosoft.cms.dataservice.PublishStaff.dg12DataBind" size="14">
