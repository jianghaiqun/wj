...
Page.onLoad(function(){
        ...
        DataList.setParam("dg1","commentTile",$V("commentTile"));
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				...
				<tr>
                    ...
                    &nbsp;<font color="#999999">选择栏目</font>
                     <z:select id="SelectCatalogID" style="width:120px;" onChange="setCatalogID();" listWidth="200" listHeight="300" listURL="DataService/CommentCatalogSelector.jsp?Type=1&evalFlag=1"></z:select>
                    ...
                    &nbsp;<font color="#999999">评论搜索</font>
	                <input type="text" id="commentTile" onChange="setCommentTitle();">
                    <input type="hidden" id="CatalogID" name="CatalogID" value=""/>
                    </td>
				</tr>
				<tr>   
					<td style="padding:0px 5px;">
					<z:datalist id="dg1" method="com.sinosoft.cms.dataservice.Comment.EvalComDataBind" size="15">
