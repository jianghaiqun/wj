...
<script>
var currentTab = "Module";
function onTabChange(tab){
	currentTab = tab;
	var url;
	url = Server.ContextPath+"Module/"+currentTab+".jsp";
...
<table width="100%" border="0" cellspacing="6" cellpadding="0"
	...
	<tr valign="top">
		<td><z:tab>
			<z:childtab id="Module" onClick="onTabChange('Module')"
				src="about:blank" selected="true">
				<img src="../Icons/icon002a1.gif" />
				<b>元素管理</b>
			</z:childtab>
			<z:childtab id="ModuleManage" onClick="onTabChange('ModuleManage')"
				src="about:blank">
