	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>广告点击量排行:</strong>
				<z:select id="PositionID" style="width:200px" listWidth="300" listHeight="350" defaultblank="true" method="com.sinosoft.cms.stat.report.TopReport.getADPositionList">
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.TopReport.dgADDataBind"
