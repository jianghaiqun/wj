...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.sinosoft.cms.stat.report.CatalogReport.getChartData");
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
		  ...
		  %> ：</td>
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.CatalogReport.dg1DataBind"
					autoFill="false">
