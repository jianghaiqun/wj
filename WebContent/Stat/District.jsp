...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.sinosoft.cms.stat.report.DistrictReport.getChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>地区分布:</strong> &nbsp; <z:select
					id="Type">
					<span value="C">全球分布</span>
					<span value="P" selected="true">国内分布</span>
				</z:select> &nbsp;从 <input name="text" type="text" id="StartDate"
					style="width:90px; " ztype='date'> 至 <input name="text2"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.DistrictReport.dg1DataBind"
