...
Page.onLoad(function(){
	...
	var chart = new Chart("Pie3D","Chart1",680,300,"com.sinosoft.cms.stat.report.ClientReport.getChartData");
	chart.addParam("Type","FlashVersion");
	chart.show("divChart");
});
</script>
</head>
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>Flash Player版本:</strong></div>
				</td>
			</tr>
			<tr>
				<td style="padding:0;">
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.ClientReport.dgFlashVersionDataBind"
