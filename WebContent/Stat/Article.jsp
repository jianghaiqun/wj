	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>文章点击量排行:</strong> &nbsp; <z:select
					id="CatalogID" style="width:200px" listWidth="300" listHeight="350"
					listURL="Site/CatalogSelectList.jsp">
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.TopReport.dgArticleDataBind"
					...
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr>
							...
							<td><a href="../Document/Preview.jsp?ArticleID=${ID}"
