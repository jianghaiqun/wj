...
Page.onLoad(function(){
	...
	chart.addParam("Type","JavaEnabled");
	chart.show("divChart");
});
</script>
</head>
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>是否支持Applet:</strong></div>
				</td>
			</tr>
			<tr>
				<td style="padding:0;">
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.ClientReport.dgJavaEnabledDataBind"
