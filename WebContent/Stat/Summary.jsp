...
Page.onLoad(function(){
	...
	var chart = new Chart("Line2D","Chart1",680,250,"com.sinosoft.cms.stat.report.SummaryReport.getChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:init method="com.sinosoft.cms.stat.report.SummaryReport.init">
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.SummaryReport.dg1DataBind"
