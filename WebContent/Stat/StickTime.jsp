...
Page.onLoad(function(){
	...
	chart = new Chart("Line2D","Chart1",680,250,"com.sinosoft.cms.stat.report.LoyaltyReport.getStickTimeChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.LoyaltyReport.dgStickTimeDataBind"
