...
<z:init method="com.sinosoft.cms.stat.report.TrendReport.init">
<html>
<head>
...
Page.onLoad(function(){
	...
	chart = new Chart("Line2D","Chart1",680,250,"com.sinosoft.cms.stat.report.TrendReport.getChartData");
	loadData();
});
