...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",690,300,"com.sinosoft.cms.stat.report.SourceReport.getHostChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>被访主机分析:</strong> &nbsp;从 <input
			...
			<tr>
				...
				<div id="divChart" style="width:690px;height:300px"></div>
				</td>
			</tr>
			<tr>
				<td
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.SourceReport.dgHostDataBind"
