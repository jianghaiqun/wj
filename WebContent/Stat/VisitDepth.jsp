...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.sinosoft.cms.stat.report.LoyaltyReport.getVisitDepthChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>访问深度:</strong> &nbsp;从 <input
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.LoyaltyReport.dgVisitDepthDataBind"
