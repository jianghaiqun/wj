...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.sinosoft.cms.stat.report.SourceReport.getKeywordChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>访问来源-关键字:</strong> &nbsp;从 <input
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.stat.report.SourceReport.dgKeywordDataBind"
