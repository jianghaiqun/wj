...
<z:init method="com.sinosoft.platform.Marking.initDialog">
<form id="form2">
	<table width="1900" align="left" cellpadding="2" cellspacing="0">
		<tr>
			<td align="left">着陆地址</td>
			<td height="30" width='50'><input id="LandingPage" name="LandingPage" type="text"
				value="${LandingPage}" class="input1" size=36 /></td>
			<td align="left">投放地址：</td>
			<td height="30" width='50'><input id="SendAddress " name="SendAddress " type="text"
				value="${SendAddress}"  class="input1" size=36/></td>
		    <td>上载页面：	<input name='WaterMarkImage' id='WaterMarkImage' type='file' value='' size='20'></td> 
		</tr>
		<tr>
			<td align="left">渠道公司名：</td>
			<td height="30"><input id="CompanyName" name="Company" type="text" value="${CompanyName}"  class="input1" size=36 /></td>     
			<td align="left">备注：</td>
			<td height="30"><input id="Remark" name="Remarks" type="text"
				value="${Remark}"  class="input1" size=36 /></td>
		</tr>
		<tr>
