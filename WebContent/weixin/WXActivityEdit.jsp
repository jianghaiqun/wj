...
<script type="text/javascript">
	...
	function initGrid() {
		...
		DataGrid.setParam("dg2", "activityId", $V("activityId"));
			...
			<table width="780" cellpadding="2" cellspacing="0" align="center">
				...
				<tr>
					...
					<td height="25" id="productDescribeTd"><input
						name="productDescribe" type="text" id="productDescribe"
						value="${productDescribe}" style="width: 150px"></td>
				</tr>
				<tr>
					<td align="right">活动描述：</td>
					<td><textarea id="description" name="description"
							value="${description}" style="width: 400px">${description}</textarea></td>
				</tr>

				<tr>
					<td align="right">活动开始时间：</td>
					<td><input name=standardDateStart type="text"
						id="standardDateStart" value="${standardDateStart}"
						style="width: 150px" class="inputText" ztype="date"
						verify="开始日期|NotNull"> <input name="standardTimeStart"
						type="text" id="standardTimeStart" value="${standardTimeStart}"
						style="width: 120px" class="inputText" ztype="time"
						verify="开始时间|NotNull"></td>
				</tr>

				<tr>
					<td align="right">活动截止时间：</td>
					<td><input name="standardDateEnd" type="text"
						id="standardDateEnd" value="${standardDateEnd}"
						style="width: 150px" class="inputText" ztype="date"
						verify="结束日期|NotNull"> <input name="standardTimeEnd"
						type="text" id="standardTimeEnd" value="${standardTimeEnd}"
						style="width: 120px" class="inputText" ztype="time"
				...
				<tr>
					...
					<td height="25" id="gamePeriodTd"><input name="gamePeriod" type="text"
						id="gamePeriod" value="${gamePeriod}" style="width: 150px"></td>
				</tr>

				<tr>
					<td align="right">活动规则：</td>
					<td><textarea id="ruleText" name="ruleText"
							value="${ruleText}" style="width: 400px" verify="活动数据|NotNull">${ruleText}</textarea></td>
				</tr>
			</table>
		</form>
	</z:init>
