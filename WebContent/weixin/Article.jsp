...
<z:init method="com.sinosoft.cms.document.WxActive.init">
	<html>
	<head>
...
.themleft {
	background: url(../Document/Images/themtitleft.gif) no-repeat left top;
}

.themright {
	background: url(../Document/Images/themtitright.gif) no-repeat right top;
	cursor: pointer;
}

.thembg {
	background: #FFFFFF url(../Document/Images/themtitbg.gif) repeat-x left top;
...
#otherbtn a,#otherbtn a:visited {
	...
	background: url(../Document/Images/btbg.gif) no-repeat center center;
}
...
#otherbtn a:hover {
	background: url(../Document/Images/btbgo.gif) no-repeat center center;
}

.tbSwitch {
	height: 26px;
	position: absolute;
	background: url("../Document/Images/paggingbar.gif");
}
...
function save(){
	...
	dc.add("activeID",activeID);
	if(activeID!=null && activeID!=""){
		dc.add("Method","update");
	}else{
		dc.add("Method","save");
	}
	saveArticle("save",dc);
...
function saveArticle(saveMethod,dc){
	//if(confirm("请确认文章中没有涉密信息！")){
	Dialog.wait("正在处理...");
	Server.sendRequest("com.sinosoft.cms.document.WxActive."+saveMethod,dc,function(response){
	  Dialog.closeEx();
...
function exe(args){
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<div><z:tbutton onClick="save()">
				<img src="../Icons/icon018a4.gif" />保存</z:tbutton></div>
			</td>
		</tr>
	</table>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="220" rowspan="2" valign="top">
								<table width="100%" border="0" cellspacing="4"
									class="cellspacing" cellpadding="0" style="display: none">
									<tr>
										<td>
											<table width="100%" border="0" cellpadding="0"
												...
												<tr>
													<td class="themright"
														onClick="displayAdvance('id_AdvanceTd2','id_AdvanceImg2','../Document/Images/thembitopen.gif','../Document/Images/thembitclose.gif');">
														<table width="100%" border="0" cellspacing="0"
															...
															<tr>
																...
																<td width="20">
																	<img src="../Document/Images/thembitclose.gif" name="id_img2"
									...
									<tr>
										<td>
											<table width="100%" border="0" cellpadding="0"
												...
												<tr>
													<td class="themright"
														onClick="displayAdvance('id_AdvanceTd3','id_AdvanceImg3','../Document/Images/thembitopen.gif','../Document/Images/thembitclose.gif');">
														<table width="100%" border="0" cellspacing="0"
															cellpadding="0">
															<tr>
																<td width="5">
																...
																<td width="20">
																	<img src="../Document/Images/thembitclose.gif" width="13"
												...
												<tr>
													<td align="center" valign="middle">
														<a href="#;" onClick="addRelaArticle()"><img
																src="../Document/Images/icon2.gif" width="9" height="9">相关文章</a>
													</td>
													<td align="center" valign="middle">
														<a href="#;" onClick="addRecArticle()"><img
																src="../Document/Images/icon4.gif" width="9" height="9">推荐文章</a>
													</td>
												</tr>
											</table>
										</td>
						...
						<tr>
												...
												<table width="100%" cellpadding="2" cellspacing="0">
													<tr>
														...
														<td colspan="3" align="left">
															<input name="Title" type="text" class="input1" id="Title" value="${Title}" verify="标题|NotNull"
																style="width:430px"/>
														</td>
													</tr>
													...
													<tr id="trShortTitle" style="display: none">
														...
														<td colspan="3" align="left">
															<input name="ShortTitle" type="text" class="input1"
																style="background:url(../Document/Images/rule.gif) repeat-x left bottom; width:300px;${ShortTitleStyle}"
													...
													<tr id="trSubTitle" style="display: none">
														...
														<td colspan="3" align="left">
															<input name="SubTitle" type="text" class="input1"
																style="background: url(../Document/Images/rule.gif) repeat-x left bottom; width: 300px;"
													...
													<tr >
														<td align="center" >
													     ...
													     <td colspan="3" align="left">
															<textarea name="Summery" id="Summery" verify="摘要|NotNull" rows="5" cols="50">${Summery}</textarea>
														</td>
													</tr>
							...
							<td width="6" rowspan="3" align="right" bgcolor="#F6F9FD"
								...
								<img src="../Document/Images/right_close.gif" width="6" height="60"
									style="cursor: pointer; display: inline;" title="输入其它信息"
									onClick="displayAdvance('id_AdvanceTd',this,'../Document/Images/left_close.gif','../Document/Images/right_close.gif');">
							</td>
						</tr>
					</table>
				</form>
