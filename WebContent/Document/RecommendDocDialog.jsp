...
function getDocList(){
  ...
  if(oldArticleIDs != ""){
	...
	DataGrid.setParam("dg1","RecommendArticle",$V("ArticleIDs"));
...
<input type="hidden" id="ArticleIDs"
	value="<%=request.getParameter("RecommendArticle")%>">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td valign="middle" class="blockTd"><img
					src="../Icons/icon018a1.gif" />推荐文档列表</td>
			</tr>
			<tr>
			...
			<tr>
				<td
					style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;"><z:datagrid
					id="dg1"
					method="com.sinosoft.cms.document.Article.recommendDg1DataBind"
					size="10">
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr ztype="head" class="dataTableHead">
							...
							<td width="73%" drag="true"><b>标题</b></td>
