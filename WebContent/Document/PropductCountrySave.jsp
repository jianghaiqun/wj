...
<%@page import="com.sinosoft.framework.utility.PropductCountryUpLoad"%>
	...
	while (iter.hasNext()) {
		...
		if (!item.isFormField()) {
			...
			if (!fileName.toLowerCase().endsWith(".xls")) {
				...
				PropductCountryUpLoad tActiviCodeUpLoad = new PropductCountryUpLoad();
				try {
