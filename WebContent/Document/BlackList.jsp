...
<script type="text/javascript">
	...
	function query() {
		...
		DataGrid.setParam("dg1", "InsIDNo", $V("InsIDNo"));
	...
	function add() {
		...
		diag.Height = 300;
		diag.Title = "黑名单-新增";
		diag.URL = "Document/BlackListAdd.jsp";
	...
	function addSave() {
		...
		if ($DW.Verify.hasError()) {
			...
			Server.sendRequest("com.sinosoft.cms.document.BlackListManage.saveBlackListManage",
					dc, function() {
						Dialog.endWait();
	...
	function editor() {
		...
		diag.Height = 300;
		diag.Title = "黑名单-编辑";
		diag.URL = "Document/BlackListEditor.jsp?ID=" + dr.get("ID");
	...
	function editSave(){
		...
		Server.sendRequest("com.sinosoft.cms.document.BlackListManage.update",dc,function(){
			var response = Server.getResponse();
	...
	function del() {
		...
		Dialog.confirm("确认要删除？", function() {
			Server.sendRequest("com.sinosoft.cms.document.BlackListManage.delete", dc, function(
					response) {
				Dialog.alert(response.Message, function() {
					if (response.Status == 1) {
						DataGrid.loadData('dg1');
	...
	function addBatch() {
		...
		diag.ShowMessageRow = true;
		diag.URL = "Document/BlackListBatch.jsp";
	...
	<table width="100%" border='0' cellpadding='10' cellspacing='0'>
		<tr>
			<td valign="top">
						...
						<table>
							<tr>
								<td height="35" align="right" bordercolor="#eeeeee"
									class="tdgrey1">姓名：</td>
								<td><input value="" type="text" id="RecognizeeName" name="RecognizeeName"
									ztype="String" class="inputText" size="20" />
									</td>
									<td height="35" align="right" bordercolor="#eeeeee"
									class="tdgrey1">证件号：</td>
								<td><input value="" type="text" id="InsIDNo" name="InsIDNo"
									ztype="String" class="inputText" size="20" />
									</td>
				...
				</table> <z:tButtonPurview>${_Document_BlackList_Button}</z:tButtonPurview>
			</td>
		</tr>
		<tr>
			<td style="padding-top: 0px; padding-left: 6px; padding-right: 6px; padding-bottom: 8px;">
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.document.BlackListManage.queryBlackList" size="20"
					scroll="true">
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr ztype="head" class="dataTableHead">
							...
							<td width="15%"><strong>被保人姓名</strong>
							</td>
