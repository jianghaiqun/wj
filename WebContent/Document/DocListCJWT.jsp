...
function FAQ(){
	...
	diag.Height = 350;
	diag.Title = "常见问题";
	diag.URL = "Document/DocListDialogCJWT.jsp";
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><z:tree id="tree1"
					...
					method="com.sinosoft.cms.document.ArticleListCJWT.treeDataBind" level="2"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float: left"><z:tbutton
					...
					<img src="../Icons/icon003a2.gif" width="20" height="20" />设置常见问题</z:tbutton></div>
