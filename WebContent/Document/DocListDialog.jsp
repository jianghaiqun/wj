...
<table width="100%" border="0" cellspacing="4" cellpadding="0">
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td valign="middle" class="blockTd"><img
					src="../Icons/icon018a1.gif" />栏目列表</td>
			</tr>
			<tr>
				<td style="padding:6px;">
					<z:tree id="tree1" style="height:380px" method="com.sinosoft.cms.document.ArticleList.treeDataBind" level="2" lazy="true" resizeable="true">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6"
			class="blockTable">
			<tr>
				<td align="right" style="padding:8px 10px;"><input
					name="Keyword" type="text" id="Keyword"> <input
					type="button" name="Submit" value="查询" onClick="search()"></td>
			</tr>
			<tr>
				<td
					style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
				<z:datagrid id="dg1"
					method="com.sinosoft.cms.document.ArticleList.dialogDg1DataBind"
					size="15">
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr ztype="head" class="dataTableHead">
							...
							<td width="87%" sortField="title"><b>标题</b></td>
						</tr>
						...
						<tr ztype="pagebar">
							<td colspan="9" align="left">${SimplePageBar}</td>
						</tr>
					</table>
				</z:datagrid></td>
			</tr>
