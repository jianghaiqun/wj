...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.cms.document.Notes.save",dc,function(response){
...
function del(id){
	...
	dc.add("ID",id);
	Server.sendRequest("com.sinosoft.cms.document.Notes.del",dc,function(response){
...
<z:init method="com.sinosoft.cms.document.Notes.init">
