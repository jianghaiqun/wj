						...
						<table>
							<tr>
								<td height="35" align="right" bordercolor="#eeeeee"
									class="tdgrey1">姓名：</td>
								<td>
									<input value="" type="text" id="RecognizeeName" name="RecognizeeName" class="inputText" size="20" verify="名称|NotNull"/>
								</td>
							</tr>
							<tr>
								<td height="35" align="right" bordercolor="#eeeeee"
							...
							<tr>
								...
								<td>
									<input type="text" id="InsIDNo" name="InsIDNo" class="inputText" size="20" verify="证件号|NotNull"/>
								</td>
							</tr>
							<tr>
								<td height="35" align="right" bordercolor="#eeeeee"
