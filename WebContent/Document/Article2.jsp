		...
		<tr>
			...
			<div><z:tbutton onClick="note()">
				...
				<%
				 ...
				 %>
				<a href="../Test/ArticleTest.jsp?SiteID=${SiteID}&ArticleID=<%=aid %>&CatalogID=${CatalogID}">
				<img src="../Icons/icon403a3.gif" width="20" height="20" />分发
				</a>
													...
													<td align="center" valign="top" class="thembg"
														...
														<table width="95%" border="0" cellpadding="0"
															...
															<%
															    ...
															    boolean isPriv = Priv.getPriv(Priv.ARTICLE,CatalogUtil.getInnerCode(ctalogID),Priv.ARTICLE_AUDIT);
															    //out.print(isPriv);
															    if(isPriv){
															    %>
															    <tr align="left">
