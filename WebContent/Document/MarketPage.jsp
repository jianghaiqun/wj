...
function add(flag){
	...
	window.open("YXHDedit.jsp?ArticleID="+aID+"&CatalogId="+catalogId);
}
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><z:tree id="tree1"
					...
					method="com.sinosoft.cms.dataservice.ProductListYX.treeDataBind" level="2"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float: left"><z:tbutton
					...
					id="BtnFAQId" priv="article_browse" onClick="add('1')">
					<img src="../Icons/icon003a2.gif" width="20" height="20" />添加</z:tbutton><z:tbutton
					id="BtnFAQId" priv="article_browse" onClick="add('2')">
					<img src="../Icons/icon003a2.gif" width="20" height="20" />编辑</z:tbutton></div>
