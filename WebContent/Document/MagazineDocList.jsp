	...
	<tr valign="top">
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><z:tree id="tree1"
					...
					method="com.sinosoft.cms.site.Magazine.treeDataBind" level="3"
					lazy="true">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1" method="com.sinosoft.cms.document.ArticleList.magazineListDataBind" size="15">
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr onDblClick="edit(${ID});">
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td style="${TitleStyle}">${Title} 
							
							<span style="color:yellow;">${article.prop1}</span>
							<%if("Y".equals("${article.prop1}")){
							%>
							[作废]
							<%
							} %>
