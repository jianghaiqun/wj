...
function save(){
	...
	Server.sendRequest("com.sinosoft.platform.Schedule.save",dc,function(response){
...
function execute(){
	...
	dc.add("ID",dr.get("ID"));
	Server.sendRequest("com.sinosoft.platform.Schedule.execute",dc,function(response){
		Dialog.alert(response.Message);
	});
}
...
function del(){
	...
	Dialog.confirm("确定要删除该配置项吗？",function(){
		var dc = new DataCollection();	
		dc.add("IDs",arr.join());
		Server.sendRequest("com.sinosoft.platform.Schedule.del",dc,function(response){
...
<z:init method="com.sinosoft.platform.Schedule.init">
	<body>
      ...
      <tr valign="top">
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            ...
            <tr>
			  ...
			  <z:datagrid id="dg1" method="com.sinosoft.platform.Schedule.dg1DataBind" size="15">
