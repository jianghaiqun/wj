...
<z:init method="com.sinosoft.platform.UserList.initEditDialog">
<form id="form2">
    ...
    <legend><label>基本信息</label></legend>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><input name="UserSign"  type="text" value="${UserSign}" id="UserSign"  /></td>
        </tr>
        <tr id ="tr_Password2">
          <td height="30" align="right" >密码：</td>
          <td><input name="NewPassword" type="password" id="NewPassword"  value="${Password}" onBlur="passVerify('NewPassword')" verify="NotNull"/></td>
        </tr>
        <div id="error"></div>
        <tr id ="tr_ConfirmPassword2">
          <td height="30" align="right" >重复密码：</td>
          <td><input name="NewConfirmPassword" type="password" id="NewConfirmPassword"  value="${Password}" verify="NotNull"/></td>
        </tr>
        <tr>
	  ...
	  <fieldset>
		<legend><label>所属角色</label></legend>
		  <table width="100%" border="0" cellpadding="2" cellspacing="0">
			<tr>
			<td>
	    <z:tree id="tree1" style="width:230px;height:300px" method="com.sinosoft.platform.UserList.initEditRoleTree">
	      <p cid='${RoleCode}' >
