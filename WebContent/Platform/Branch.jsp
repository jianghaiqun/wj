...
function del(){
	...
	Dialog.confirm("注意：这是级联删除，下级组织机构会一起删除，您确认要删除吗？",function(){
		Server.sendRequest("com.sinosoft.platform.Branch.del",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg1');
				}				
			...
			<tr>
				<td style="padding:0 8px 4px;"><z:tbutton onClick="addBranch()">
					...
					<z:tbutton onClick="up()">
						<img src="../Icons/icon042a9.gif" width="20" height="20"/>返回</z:tbutton>		
						</td>
			</tr>
			<tr>
				<td
					style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
				<z:datagrid id="dg1" method="com.sinosoft.platform.Branch.dg1DataBind"
					page="false">
