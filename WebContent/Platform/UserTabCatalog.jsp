...
function save(){
	...
	Server.sendRequest("com.sinosoft.platform.UserTabCatalog.dg1Edit",dc,function(response){
...
<tr>
<z:init method="com.sinosoft.platform.UserTabCatalog.init">
...
<z:datagrid id="dg1" method="com.sinosoft.platform.UserTabCatalog.dg1DataBind" page="false" autoFill="false">
			  <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
				<tr ztype="head" class="dataTableHead">
				  <td  width="4%" ztype="RowNo">序号</td>
				  <td width="20%" ztype="tree" level="TreeLevel"><b>栏目名称</b></td>
				  <%for(int i=0;i<map.size();i++){%>
