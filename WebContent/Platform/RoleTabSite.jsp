...
function save(){
	...
	Server.sendRequest("com.sinosoft.platform.RoleTabSite.dg1Edit",dc,function(response){
...
<z:datagrid id="dg1" method="com.sinosoft.platform.RoleTabSite.dg1DataBind" size="14">
