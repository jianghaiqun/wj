...
<z:init method="com.sinosoft.platform.UserList.init">
<form id="form2">
    ...
    <legend><label>基本信息</label></legend>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr id ="tr_Password2" style="display:none">
          ...
          <td><input name="Password" type="password" value='${NewPassword}' id="Password" verify="NotNull" /></td>
        </tr>
        <tr id ="tr_ConfirmPassword2" style="display:none">
          <td height="30" align="right" >重复密码：</td>
          <td><input name="ConfirmPassword" type="password" value='${NewPassword}' id="ConfirmPassword" verify="NotNull" /></td>
        </tr>
        <tr>
