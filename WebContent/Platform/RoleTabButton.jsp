...
function init(){
	...
	Server.sendRequest("com.sinosoft.platform.RoleTabButton.getCheckedMenu",dc,function(response){
...
function save(){
	...
	var cols=[];
	cols.push(["ID","1"]);
	cols.push(["<%=Priv.BUTTON_BROWSE%>","1"]);
	var values =[];
	...
	Server.sendRequest("com.sinosoft.platform.RoleTabButton.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <z:init method="com.sinosoft.platform.RoleTabButton.init">
    <td style="padding:4px 0px;"><z:tbutton onClick="save()"><img src="../Icons/icon018a4.gif"/>保存</z:tbutton>
      ...
      <span style="line-height:24px;">&nbsp;&nbsp;&nbsp;<label><input type="checkbox" id="AllSelect" onClick="clickAllSelect();"/>全选&nbsp;</label></span>
  	</td>
  	</z:init>
  </tr>
  <tr >   
        <td style="padding:0px 5px;">
			<z:datagrid id="dg1" method="com.sinosoft.platform.RoleTabButton.dg1DataBind">
			  <table width="100%" cellpadding="2" cellspacing="0"  class="dataTable">
				<tr ztype="head" class="dataTableHead">
				  <td  width="6%" ztype="RowNo">序号</td>
				  <td width="90%" ztype="tree"  field="ID" level="treelevel">菜单名称</td>
			    </tr>
				<tr>
				  <td >&nbsp;</td>
