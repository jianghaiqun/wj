...
<z:init method="com.sinosoft.platform.Channel.init">
	<html>
	<head>
		...
		<tr>
			...
			<table width="400" height="197" align="center" cellpadding="2"
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td width="260"><input name="Code" verify="名称|NotNull"
				...
				<tr>
					...
					<td width="260"><input name="OrderFlag"
						type="text" value="" style="width:100px" class="input1" id="OrderFlag"
						size=15 /></td>
				</tr>
				<tr>
