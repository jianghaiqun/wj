...
function save(){
	DataGrid.save("dg2","com.sinosoft.platform.District.dg1Edit",function(){
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.platform.District.add",dc,function(response){
...
function del(){
	...
	dc.add("IDs",arr.join());
	Server.sendRequest("com.sinosoft.platform.District.del",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				DataGrid.loadData("dg2");
			}
...
<body>
<z:init method="com.sinosoft.platform.District.init">
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="8" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg2" method="com.sinosoft.platform.District.dg1BindDistrictList" page="false">
