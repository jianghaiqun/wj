...
function init(){
	...
	Server.sendRequest("com.sinosoft.platform.UserTabMenu.getCheckedMenu",dc,function(response){
...
function save(){
	...
	Server.sendRequest("com.sinosoft.platform.UserTabMenu.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <z:init method="com.sinosoft.platform.UserTabMenu.init">
...
<z:datagrid id="dg1" method="com.sinosoft.platform.UserTabMenu.dg1DataBind">
