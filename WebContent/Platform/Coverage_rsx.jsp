...
function add(){
	...
	diag.Height = 200;
	diag.Title = "新建渠道";
	diag.URL = "Platform/CoverageDialog.jsp?Type=coverage_rsx";
    ...
    <tr valign="top">
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
          ...
          <tr>   <td style="padding:0px 5px;">
			<z:datagrid id="dg1" method="com.sinosoft.platform.Coverage.dg1DataBind_rsx" page="false">
              <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
                <tr ztype="head" class="dataTableHead">
                  <td width="3%" ztype="RowNo" drag="true"><img src="../Framework/Images/icon_drag.gif" width="16" height="16"></td>
                  <td width="3%" ztype="selector" field="id">&nbsp;</td>
                  <td width="50%"  ztype="tree" level="treelevel"><b>名称</b></td>
