...
<body>
  ...
  <tr>
    ...
    <div ><%=request.getParameter("warn") %></div>
    <%} %>
      <tr>
      ...
      <tr >
        <td align="right">
         新密码：</td>
        <td align="left"><input name="Password" type="password" class="input1" id="Password" onBlur="passVerify('Password')" verify="NotNull" /></td>
      </tr>
      <div id="error"></div>
      <tr >
        <td align="right">
