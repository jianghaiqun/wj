...
function update(){
	...
	diag.Height = 150;
	diag.Title = "文案修改";
	diag.URL = "Platform/GapGuaranteeCopywriting2Edit.jsp?codeValue="+dr.get("codeValue");
...
function updateThis(){
	...
	Server.sendRequest("com.sinosoft.platform.GapGuarantee.update2",dc,function(response){
...
function add(){
	...
	diag.Height = 150;
	diag.Title = "新建文案";
	diag.URL = "Platform/GapGuaranteeCopywriting2Edit.jsp";
	diag.onLoad = function(){
		$DW.$("CodeType").value="${CodeType}";
		$DW.$("CodeType").disabled=true;
		$DW.$("CodeValue").focus();
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.platform.GapGuarantee.add2",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				$D.close();
				DataGrid.loadData('dg1');
...
function del(){
	...
	Dialog.confirm("您确认要删除吗？",function(){
		Server.sendRequest("com.sinosoft.platform.GapGuarantee.del2",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg1');
				}		
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg1"
						method="com.sinosoft.platform.GapGuarantee.dg2HomePage2">
						<table width="100%" cellpadding="2" cellspacing="0"
							class="dataTable" afterdraFg="afterRowDragEnd">
							<tr ztype="head" class="dataTableHead">
								...
								<td width="15%"><strong>保险测评结果标题文案</strong></td>
							</tr>
