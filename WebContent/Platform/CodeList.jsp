...
<z:init method="com.sinosoft.platform.Code.initList">
...
function save(){
	DataGrid.save("dg1","com.sinosoft.platform.Code.dg1Edit",function(){DataGrid.loadData('dg1');});
}
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.platform.Code.add",dc,function(response){
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
				...
				<tr>
					...
					<z:datagrid id="dg1"
						method="com.sinosoft.platform.Code.dg1BindCodeList">
