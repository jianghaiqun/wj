...
function onTypeChange(){//id参数仅供修改时初始化使用
	if($V("TypeCode")!=""){
		...
		Server.sendRequest("com.sinosoft.platform.Schedule.getUsableTask",dc,function(response){
			$("SourceID").clear();
			...
			if(window.SourceID||window.SourceID===0){
...
<form id="form2"><z:init
	method="com.sinosoft.platform.Schedule.init">
	<table width="100%" height="100%" border="0">
		<tr>
			<td>
			<table width="590" align="center" cellpadding="2" cellspacing="0">
				<tr>
					<td width="168" height="10" class="tdgrey2">
						<input name="hidden2" type="hidden" id="ID" value="">
					</td>
