...
function save(){
	...
	Server.sendRequest("com.sinosoft.platform.UserTabSite.dg1Edit",dc,function(response){
...
<z:datagrid id="dg1" method="com.sinosoft.platform.UserTabSite.dg1DataBind" size="10">
