...
function getTagCloud(){
	...
	var data = {Title:"", operate:"TagCloud" ,method:"save"};
	$.getJSON('http://localhost:8080/wj/shop.jsp?now='+now, data, function(json){//now表示每次点击都会发送新的请求
		createTagCloud(json.test);
	});                          
}
