...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.sinosoft.cms.site.Link.getPicSrc",dc,function(response){
...
<z:init method="com.sinosoft.cms.site.Link.initDialog">
	...
	<table width="100%" cellpadding="2" cellspacing="0" id="checktable">
		...
		<tr>
			...
			<td><input name="URL" type="text" class="input1" id="URL"
				value="${URL}" verify="NotNull" style="width:200px" /></td>
		</tr>
		<tr>
			<td align="right">链接注释：</td>
			<td><textarea name="URL" type="text" class="input1" id="Prop3"
				value="${Prop3}"  style="width:200px" ></textarea></td>
		</tr>
		...
		<tr>
			...
			<td width="73%"><input name="Prop4" type="text" class="input1"
				id=Prop4 value="${Prop4}"
				style="width:200px" /></td>
		</tr>
	</table>
	</form>
