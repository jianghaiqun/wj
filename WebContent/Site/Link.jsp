...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.cms.site.Link.add",dc,function(response){
...
function editSave(){
	...
	Server.sendRequest("com.sinosoft.cms.site.Link.edit",dc,function(response){
...
function save(){
	DataGrid.save("dg2","com.sinosoft.cms.site.Link.save",function(){DataGrid.loadData('dg2');});
}
...
function del(){
	...
	Dialog.confirm("您确认要删除吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.sinosoft.cms.site.Link.del",dc,function(response){
			Dialog.alert(response.Message,function(){
				if(response.Status==1){
					DataGrid.loadData('dg2');
				}
...
function afterRowDragEnd(type,targetDr,sourceDr,rowIndex,oldIndex){
	...
	Server.sendRequest("com.sinosoft.cms.site.Link.sortColumn",dc,function(response){
		Dialog.alert(response.Message,function(){
			if(response.Status==1){
				DataGrid.loadData("dg2");
			}
...
%>
	<table width="100%" border="0" cellspacing="0" cellpadding="6">
		<tr>
			...
			<z:tbutton onClick="$('dg2').edit();"><img src="../Icons/icon028a16.gif" />修改</z:tbutton> 
		...
		<tr>
			...
			<z:datagrid id="dg2" method="com.sinosoft.cms.site.Link.dg1DataBind">
				<table width="100%" cellpadding="2" cellspacing="0"
					...
					<tr ztype="head" class="dataTableHead">
						...
						<td width="20%"><strong>链接地址</strong></td>
						<td width="20%"><strong>链接注释</strong></td>
						<td width="16%"><strong>链接图片</strong></td>
						<td width="14%"><strong>链接图片描述</strong></td>
					</tr>
					...
					<%} else { %>
					<tr ztype="head" class="dataTableHead">
						<td width="7%" ztype="RowNo" drag="true"><img
							src="../Framework/Images/icon_drag.gif" width="16" height="16"></td>
						<td width="7%" ztype="selector" field="id">&nbsp;</td>
						<td width="11%"><strong>链接分类</strong></td>
						<td width="20%"><strong>链接名称</strong></td>
						<td width="20%"><strong>链接地址</strong></td>
						<td width="15%"><strong>链接排序序列</strong></td>
						<td width="20%"><strong>链接注释</strong></td>
					</tr>
					<tr >
						<td width="7%">&nbsp;</td>
					...
					<tr ztype="edit">
						...
						<td><input type="text" class="input1" id="Name"
							value="${Name}" style="width:150px"></td>
						<td><input type="text" class="input1" id="URL" value="${URL}"
							...
							style="width:230px"></td>
						<td><input type="text" class="input1" id="Prop3" value="${Prop3}"
