...
function save(){
	DataGrid.save("dg1","com.sinosoft.cms.site.BadWord.dg1Edit",function(){
...
function addSave(){
	...
	Server.sendRequest("com.sinosoft.cms.site.BadWord.add",dc,function(response){
...
Dialog.confirm("您确认要删除吗？",function(){
	...
	dc.add("IDs",arr.join());
	Server.sendRequest("com.sinosoft.cms.site.BadWord.del",dc,function(response){
...
<body>
<z:init method="com.sinosoft.cms.site.BadWord.init">
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="6"
				...
				<tr>
					...
					<z:datagrid id="dg1"
						method="com.sinosoft.cms.site.BadWord.dg1DataBind" size="13">
