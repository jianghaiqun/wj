...
<script type="text/javascript">
	...
	function afterUpload(fileUrl){
		   ...
		   var dc = new DataCollection();	
		    ...
		    Server.sendRequest("com.sinosoft.cms.site.CatalogExtend.uploadExcel",dc,function(response){
		    	Dialog.closeEx();
...
<form  action="ImportCustomFieldUploadSave.jsp" method="post" name="fm" enctype="multipart/form-data" target="targetFrame"> <br>
	...
	<a href="../DataService/ADTemplate/Import_extendField.xls">扩展属性信息导入模板下载</a>
