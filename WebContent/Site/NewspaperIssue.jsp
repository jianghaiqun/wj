...
function del(){
	...
	Dialog.confirm("确认删除选中的期号吗？",function(){
			...
			Server.sendRequest("com.sinosoft.cms.site.NewspaperIssue.del",dc,function(response){
				if(response.Status==0){
...
function editSave(){
  ...
  if($DW.Verify.hasError()){
	...
	Server.sendRequest("com.sinosoft.cms.site.NewspaperIssue.edit",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
function generate(){
	...
	Server.sendRequest("com.sinosoft.cms.site.NewspaperIssue.generate",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
<body>
<z:init method="com.sinosoft.cms.site.NewspaperIssue.init">
	...
	<input name="NewspaperID" type="hidden" id="NewspaperID"
		...
		method="com.sinosoft.cms.site.NewspaperIssue.dg1DataBind" size="14">
