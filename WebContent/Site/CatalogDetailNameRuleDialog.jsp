	...
	<table width="97%"  cellpadding="4" cellspacing="0" style="margin:10px auto;">
		...
		<tr>
			<td colspan="2">
				...
				<tr>
					<td align="left"><input type="radio" name="rule" id="rule_5" value="/${catalogpath}/${catalog.catalogsign}${document.sourcesign}${user.usersign}${document.contentsign}${firstpublishdate}${everydayno}.shtml" checked="checked" onclick="change(this)"/></td>	
					<td height="30" align="left">/栏目标记-质量标记-录入标记-内容标记-发布时间-当日编号.shtml生成：/${catalogpath}/${catalog.catalogsign}${document.sourcesign}${user.usersign}${document.contentsign}${firstpublishdate}${everydayno}.shtml</td>
				</tr>
				 <tr valign="top">
					<td align="left"><input on type="radio" name="rule" id="rule_1" value="/${catalogpath}/${document.id}.shtml"  onclick="change(this)"/></td>
				...
				<tr>
					<td align="left"><input type="radio" name="rule" id="rule_4" value="/${year}/${month}/${day}/${document.id}.shtml" onclick="change(this)"/></td>	
