...
function addSave(){
  ...
  if($DW.Verify.hasError()){
	...
	Server.sendRequest("com.sinosoft.cms.site.NewspaperPage.add",dc,function(response){
...
function del(){
	...
	Dialog.confirm("确认删除选中的期号吗？",function(){
			...
			Server.sendRequest("com.sinosoft.cms.site.NewspaperPage.del",dc,function(response){
				if(response.Status==0){
...
function editSave(){
  ...
  if($DW.Verify.hasError()){
	...
	Server.sendRequest("com.sinosoft.cms.site.NewspaperPage.edit",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
function generate(){
	...
	Server.sendRequest("com.sinosoft.cms.site.NewspaperPage.generate",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
<body>
<z:init method="com.sinosoft.cms.site.NewspaperPage.init">
	...
	<z:datagrid id="dg1"
		method="com.sinosoft.cms.site.NewspaperPage.dg1DataBind" size="14">
