...
function save(){
	...
	DataGrid.save("dg1","com.sinosoft.cms.site.Catalog.dg1Edit",function(){window.location.reload();});
}
...
function addMagSave(){
	...
	Server.sendRequest("com.sinosoft.cms.site.Magazine.add",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
function editMagSave(){
	...
	Server.sendRequest("com.sinosoft.cms.site.Magazine.edit",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
...
function addIssueSave(){
  ...
  if($DW.Verify.hasError()){
	...
	Server.sendRequest("com.sinosoft.cms.site.MagazineIssue.add",dc,function(response){
		if(response.Status==0){
			Dialog.alert(response.Message);
		}else{
			Dialog.alert("新建成功",function(){
		...
		<table width="180" border="0" cellspacing="0" cellpadding="6"
			...
			<tr>
				<td style="padding:6px;" class="blockTd"><z:tree id="tree1"
					...
					method="com.sinosoft.cms.site.Magazine.treeDataBind" level="2"
					lazy="true">
