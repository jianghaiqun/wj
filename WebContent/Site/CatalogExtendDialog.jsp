...
<z:init method="com.sinosoft.cms.site.CatalogExtend.initDialog">
	<form id="form2">
	<table width="100%" height="100" border="0" align="center"
      ...
      ${InputType}
		...
		<tr id="tr_input">
			...
			<td><textarea id="TextValue" name="TextValue" cols="30"
				rows="5" verify="属性内容|NotNull">${TextValue}</textarea></td>
		</tr>
		<tr id="tr_imageInput">
			<td align="right">属性内容：</td>
			<td align="left"><input name="ImagePath" value="${ImagePath}"
				type="hidden" id="ImagePath" size=8 /> <img src="${ImageFile}"
				name="Pic" width="120" height="90" id="Pic"> <input
