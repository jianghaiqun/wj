...
function editStock() {
	...
	diag.Height = 100;
	diag.Title = "编辑库存";
	diag.URL = "PointsMall/StockDialog.jsp?ID=" + dr.get("ID");
							...
							<td valign="top">
								...
								<table>
									<tr>
										...
										<td height="35" align="right" bordercolor="#eeeeee" class="tdgrey1">过期开始时间：</td>
										<td><input name=StartDate" id="StartDate" value="" type="text" size="14" ztype="Date" /></td>
										<td height="35" align="right" bordercolor="#eeeeee" class="tdgrey1">过期结束时间：</td>
											...
											<z:datagrid id="dg3" method="com.wangjin.pointsMall.GiftManage.dg1DataBindRecords" size="10" autoFill="true" scroll="true" lazy="false" multiSelect="false">
												<table width="930" cellpadding="2" cellspacing="0" class="dataTable" afterdrag="afterRowDragEnd" style="table-layout: fixed" fixedHeight="120px">
													<tr ztype="head" class="dataTableHead">
														...
														<td width="220px;"><strong>密码</strong></td>
														...
														<td width="200px;"><strong>运营商</strong></td>
													...
													<tr onDblClick="editStock(${id});" style="background-color: #F9FBFC">
														...
														<td onmouseover="showMessage(this)">${PassWord}</td>
														...
														<td onmouseover="showMessage(this)">${Operator}</td>
