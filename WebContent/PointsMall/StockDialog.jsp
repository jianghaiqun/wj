			    			...
			    			<fieldset >
								 <table>
								         <tr>
								          ...
								          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								          <td height="35" align="right" bordercolor="#eeeeee" class="tdgrey1">密码：</td>
										  <td ><input value="${PassWord}" type="text" id="PassWord" name="PassWord" ztype="String"  class="inputText"  size="25"   maxlength=50 verify="密码|NotNull"></td>
										</tr>
							     </table>
							     <table>
								          <tr>
