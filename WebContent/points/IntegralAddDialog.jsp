...
<z:init method="com.sinosoft.points.IntegralSystem.initAddIntegral">
	<html>
	<head>
	...
	function changePointNum(){
		var type=jQuery("#PointsGive").val();
		if (type == '04') {
		...
		<tr>
			...
			<table width="580" height="197" align="center" cellpadding="2" cellspacing="0" border="0">
				...
				<tr height="30">
					...
					<td>
						<z:select id="Status" style="width:100px;" verify="状态|NotNull" code="Enable"></z:select>
					</td>
					<td align="right" id="PointsNumTd">积分数：</td>
					<td><input name="PointsNum" type="text" class="input1" id="PointsNum"
						value="" size="10" verify="积分数|Int&&NotNull"/></td>
				</tr>
				<tr height="30">
					<td align="right">开始时间：</td>
					<td><input name="StartDate" type="text"  style="width:100px;" id="StartDate" value=""  ztype="date"/></td>
					<td align="right">截止时间：</td>
					<td><input name="EndDate" type="text"  style="width:100px;" id="EndDate" value=""    ztype="date"/></td>
				</tr>
				<tr height="30">
					<td align="right">文案描述：</td>
					<td colspan="3"><input name="PointDes" type="text" class="input1" id="PointDes"
						value="" size="60" verify="文案描述|Length<50&&NotNull"/></td>
				</tr>
				<tr>
