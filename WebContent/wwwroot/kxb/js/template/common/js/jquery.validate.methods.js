...
}, jQuery.validator.format("两项必须填写一项!"));
...
}, jQuery.validator.format("通讯地址必须超过6个汉字!"));
//投保人年龄必须大于18周岁
jQuery.validator.addMethod("applicantBirthday", function(value, element) {
...
}, jQuery.validator.format("投保人年龄必须大于18周岁!"));
...
}, jQuery.validator.format("请输入以 {0} 开头的字符串!"));
...
jQuery.validator.addMethod("creditcardtypes", function(value, element, param) {
	...
	jQuery.validator.addMethod("selectTest", function(value, element) {
		if (value != "-1" && value != "") {
			return true;
		} else {
			return false;
