			...
			.extend(
					$.validator,
					{
						...
						prototype : {
							...
							hideErrors : function() {
								var message = "<strong class=\"msg-box n-right n-default\" ><strong class=\"msg-wrap n-ok\" role=\"alert\"><strong class=\"n-icon\"></strong><strong class=\"n-msg\"></strong></strong></strong>";
								this.addWrapper(this.toHide).html(message);
							},
							valid : function() {
								return this.size() == 0;
							},
							...
							showLabel : function(element, message) {
								// 文字错误提示添加新样式
								message = "<strong class=\"msg-box n-right n-default\" ><strong class=\"msg-wrap n-error\" role=\"alert\"><strong class=\"n-icon\"></strong><strong class=\"n-msg\">" + message + "</strong></strong></strong>";
