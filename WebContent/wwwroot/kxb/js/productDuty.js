jQuery(document).ready(function(){ 
		...
		success: function(data) {
			var obj = eval(data);
			 ...
			 document.getElementById("discountPrice_").innerHTML=obj.retCountPrem;
			 jQuery("#countPrice").attr("value",obj.retCountPrem);
			 }
			 document.getElementById("priceTotle").innerHTML=obj.retTotlePrem;
			 document.getElementById("priceTotle_").innerHTML=obj.retTotlePrem;
			 jQuery("#price").attr("value",obj.retTotlePrem);
			}
		});
		}) 
