...
//					    jQuery(this).show();
//					});
//					jQuery("#suggest1").hover(function(){
//					    jQuery(this).show();
//					});
				if (options.onSelect) {
...
jQuery.ajax({
	...
	success: function(data) {
		...
		var traveladdress = data.tradeaddress;
		jQuery("#m-hotCity").html(traveladdress);
	}
});
jQuery("#suggest").hover(function(){
    jQuery("#que_lv_sf").show();
...
jQuery("#g-screen-ctiy").suggest(citys,{hot_list:commoncitys,dataContainer:'#arrcity_3word1', attachObject:'#suggest1'});	


jQuery("#travelAddress").focus( function(){
	var input_txt = jQuery("#travelAddress").val();
		if(input_txt==""){
			jQuery(".m-city-hot").show();
		}else{ 
			jQuery(".m-city-hot").hide();
		}	
})
...
jQuery("#travelAddress").keyup(function(){
		jQuery(".m-city-hot").hide();
})
jQuery("#m-hotCity > p > em").click(function(){
		jQuery("#travelAddress").val(jQuery(this).text());
		jQuery(".m-city-hot").hide();

})

jQuery('.que_nav_zk').hover(function () {
}, function () {
    jQuery('#suggest').hide()
});
