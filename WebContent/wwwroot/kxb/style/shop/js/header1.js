					...
					success: function(data) {
						...
						jQuery.each(data, function(index, object) {
							if (index == 0) {
								...
								cartItemListHtml = '<li><a class="leftArea" href="' + sinosoft.jsPath + '/template/shop/js/' + sinosoft.base + object.htmlFilePath + '" title="' + object.name + '">' + object.name.substring(0, 12) + '</a><span class="rightArea"><strong>' + object.price + ' × ' + object.quantity + '</strong></span></li>' + cartItemListHtml;
							}
