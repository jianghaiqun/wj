...
//	loginWindowHtml +='<form id="loginWindowForm" action="../../../../../template/shop/js/'+sinosoft.base+'/shop/member!ajaxLogin.action" method="post">';
//	
...
//	loginWindowHtml += '<div>忘记密码？<span class="orangelink"><a href="../../../../../template/shop/js/'+sinosoft.base+'/shop/member!passwordRecover.action">重新找回</a></span></div>';
//	loginWindowHtml += '</div>';
//	
//	
//	
...
//	loginWindowHtml += '<form id="registerWindowForm" name="fm" action="../../../../../template/shop/js/'+sinosoft.base+'/shop/member!ajaxRegister.action" method="post" onsubmit="return validateForm();">';
//	
//	// 注册手机号或者邮箱
...
//    loginWindowHtml += ' </div>';
//    loginWindowHtml += "<form id='registerGAForm' name='registerGAForm' action='../../../../../template/shop/js/"+sinosoft.base+"/shop/member!registerGA.action' method='post'>";
