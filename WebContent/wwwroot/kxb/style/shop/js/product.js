...
//			date :date1
		...
		for (var i in productHistoryArray) {
			productHistoryListHtml += '<li><a href="' + sinosoft.jsPath + '/template/shop/js/' + productHistoryArray[i].htmlFilePath + '">' + productHistoryArray[i].name + '</a></li>';
		}
		for (var i in productHistoryArray) {
...
// 商品浏览记录列表
	...
	var productHistoryListHtml = "";
	for (var i in productHistoryArray) {
		productHistoryListHtml += '<li><span class="icon"> </span><a href="' + sinosoft.jsPath + '/template/shop/js/' + productHistoryArray[i].htmlFilePath + '">' + productHistoryArray[i].name + '</a></li>';
	}
